...
//       if (camera.three.type === "PerspectiveCamera") {
//         const cameraThree = camera.three as THREE.PerspectiveCamera;
...
//   };
//   return BUI.html`
//     <bim-table @cellcreated=${onCellCreated} ${BUI.ref(onTableCreated)} headers-hidden>
