...
## [3.5.0](https://github.com/ThatOpen/engine_ui-components/compare/v3.4.0...v3.5.0) (2026-09-25)
...
* add CSS variable for horizontal alignment in input components ([8b75484](https://github.com/ThatOpen/engine_ui-components/commit/8b75484ca479e5202d8bc32027cd0342143d032a))
* add flex-grow property to paragraph in Label component for better layout control ([1a1b3d4](https://github.com/ThatOpen/engine_ui-components/commit/1a1b3d493f0f8e452c58f32938738d5650f72234))
* add suppress and unsuppress functionality for Tooltip component ([ccd5fa2](https://github.com/ThatOpen/engine_ui-components/commit/ccd5fa222917854c3320c7be0155ca158eaebe9e))
...
* enhance input label styling for better alignment in Dropdown component ([b97f369](https://github.com/ThatOpen/engine_ui-components/commit/b97f369c4469f122540236b07e0d1e7c2fc86921))
* improve menu positioning and tooltip handling in Button component ([f2056bc](https://github.com/ThatOpen/engine_ui-components/commit/f2056bcf8680210ccad1e3125e963c42c27a16ae))
...
* **SheetBoard:** stop double-applying devicePixelRatio to the scissor and viewport ([bce513e](https://github.com/ThatOpen/engine_ui-components/commit/bce513e83d1a03d05f162cec8b932260a647db11))
...
* update text alignment in NumberInput component to use CSS variable for better customization ([68fc296](https://github.com/ThatOpen/engine_ui-components/commit/68fc296625373621ace696d98cee24f0d82de398))
* update text alignment in TextInput component to use CSS variable for better customization ([e4f0efd](https://github.com/ThatOpen/engine_ui-components/commit/e4f0efdbba4edce9fdbe9632543c761817fd123f))
