var Un=Object.defineProperty;var Yn=(i,t,e)=>t in i?Un(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var rt=(i,t,e)=>(Yn(i,typeof t!="symbol"?t+"":t,e),e);import{D as Pe,h as E,i as C,k as p,n as u,Q as Nt,r as It}from"./state-QpXUsnxS.js";const Et=Math.min,G=Math.max,re=Math.round,ot=i=>({x:i,y:i}),Gn={left:"right",right:"left",bottom:"top",top:"bottom"},Xn={start:"end",end:"start"};function Si(i,t,e){return G(i,Et(t,e))}function Ut(i,t){return typeof i=="function"?i(t):i}function X(i){return i.split("-")[0]}function ge(i){return i.split("-")[1]}function Ji(i){return i==="x"?"y":"x"}function Zi(i){return i==="y"?"height":"width"}function yt(i){return["top","bottom"].includes(X(i))?"y":"x"}function tn(i){return Ji(yt(i))}function Kn(i,t,e){e===void 0&&(e=!1);const s=ge(i),n=tn(i),r=Zi(n);let o=n==="x"?s===(e?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(o=oe(o)),[o,oe(o)]}function Jn(i){const t=oe(i);return[Ie(i),t,Ie(t)]}function Ie(i){return i.replace(/start|end/g,t=>Xn[t])}function Zn(i,t,e){const s=["left","right"],n=["right","left"],r=["top","bottom"],o=["bottom","top"];switch(i){case"top":case"bottom":return e?t?n:s:t?s:n;case"left":case"right":return t?r:o;default:return[]}}function ts(i,t,e,s){const n=ge(i);let r=Zn(X(i),e==="start",s);return n&&(r=r.map(o=>o+"-"+n),t&&(r=r.concat(r.map(Ie)))),r}function oe(i){return i.replace(/left|right|bottom|top/g,t=>Gn[t])}function es(i){return{top:0,right:0,bottom:0,left:0,...i}}function en(i){return typeof i!="number"?es(i):{top:i,right:i,bottom:i,left:i}}function St(i){const{x:t,y:e,width:s,height:n}=i;return{width:s,height:n,top:e,left:t,right:t+s,bottom:e+n,x:t,y:e}}function ki(i,t,e){let{reference:s,floating:n}=i;const r=yt(t),o=tn(t),l=Zi(o),a=X(t),c=r==="y",d=s.x+s.width/2-n.width/2,h=s.y+s.height/2-n.height/2,f=s[l]/2-n[l]/2;let m;switch(a){case"top":m={x:d,y:s.y-n.height};break;case"bottom":m={x:d,y:s.y+s.height};break;case"right":m={x:s.x+s.width,y:h};break;case"left":m={x:s.x-n.width,y:h};break;default:m={x:s.x,y:s.y}}switch(ge(t)){case"start":m[o]-=f*(e&&c?-1:1);break;case"end":m[o]+=f*(e&&c?-1:1);break}return m}const is=async(i,t,e)=>{const{placement:s="bottom",strategy:n="absolute",middleware:r=[],platform:o}=e,l=r.filter(Boolean),a=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:i,floating:t,strategy:n}),{x:d,y:h}=ki(c,s,a),f=s,m={},b=0;for(let v=0;v<l.length;v++){const{name:g,fn:S}=l[v],{x:$,y:_,data:w,reset:O}=await S({x:d,y:h,initialPlacement:s,placement:f,strategy:n,middlewareData:m,rects:c,platform:o,elements:{reference:i,floating:t}});d=$??d,h=_??h,m={...m,[g]:{...m[g],...w}},O&&b<=50&&(b++,typeof O=="object"&&(O.placement&&(f=O.placement),O.rects&&(c=O.rects===!0?await o.getElementRects({reference:i,floating:t,strategy:n}):O.rects),{x:d,y:h}=ki(c,f,a)),v=-1)}return{x:d,y:h,placement:f,strategy:n,middlewareData:m}};async function nn(i,t){var e;t===void 0&&(t={});const{x:s,y:n,platform:r,rects:o,elements:l,strategy:a}=i,{boundary:c="clippingAncestors",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:f=!1,padding:m=0}=Ut(t,i),b=en(m),g=l[f?h==="floating"?"reference":"floating":h],S=St(await r.getClippingRect({element:(e=await(r.isElement==null?void 0:r.isElement(g)))==null||e?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(l.floating)),boundary:c,rootBoundary:d,strategy:a})),$=h==="floating"?{x:s,y:n,width:o.floating.width,height:o.floating.height}:o.reference,_=await(r.getOffsetParent==null?void 0:r.getOffsetParent(l.floating)),w=await(r.isElement==null?void 0:r.isElement(_))?await(r.getScale==null?void 0:r.getScale(_))||{x:1,y:1}:{x:1,y:1},O=St(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:$,offsetParent:_,strategy:a}):$);return{top:(S.top-O.top+b.top)/w.y,bottom:(O.bottom-S.bottom+b.bottom)/w.y,left:(S.left-O.left+b.left)/w.x,right:(O.right-S.right+b.right)/w.x}}const ns=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(t){var e,s;const{placement:n,middlewareData:r,rects:o,initialPlacement:l,platform:a,elements:c}=t,{mainAxis:d=!0,crossAxis:h=!0,fallbackPlacements:f,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:v=!0,...g}=Ut(i,t);if((e=r.arrow)!=null&&e.alignmentOffset)return{};const S=X(n),$=yt(l),_=X(l)===l,w=await(a.isRTL==null?void 0:a.isRTL(c.floating)),O=f||(_||!v?[oe(l)]:Jn(l)),x=b!=="none";!f&&x&&O.push(...ts(l,v,b,w));const P=[l,...O],F=await nn(t,g),N=[];let k=((s=r.flip)==null?void 0:s.overflows)||[];if(d&&N.push(F[S]),h){const W=Kn(n,o,w);N.push(F[W[0]],F[W[1]])}if(k=[...k,{placement:n,overflows:N}],!N.every(W=>W<=0)){var _t,Bt;const W=(((_t=r.flip)==null?void 0:_t.index)||0)+1,Ct=P[W];if(Ct)return{data:{index:W,overflows:k},reset:{placement:Ct}};let it=(Bt=k.filter(nt=>nt.overflows[0]<=0).sort((nt,Q)=>nt.overflows[1]-Q.overflows[1])[0])==null?void 0:Bt.placement;if(!it)switch(m){case"bestFit":{var wt;const nt=(wt=k.filter(Q=>{if(x){const st=yt(Q.placement);return st===$||st==="y"}return!0}).map(Q=>[Q.placement,Q.overflows.filter(st=>st>0).reduce((st,Qn)=>st+Qn,0)]).sort((Q,st)=>Q[1]-st[1])[0])==null?void 0:wt[0];nt&&(it=nt);break}case"initialPlacement":it=l;break}if(n!==it)return{reset:{placement:it}}}return{}}}};function sn(i){const t=Et(...i.map(r=>r.left)),e=Et(...i.map(r=>r.top)),s=G(...i.map(r=>r.right)),n=G(...i.map(r=>r.bottom));return{x:t,y:e,width:s-t,height:n-e}}function ss(i){const t=i.slice().sort((n,r)=>n.y-r.y),e=[];let s=null;for(let n=0;n<t.length;n++){const r=t[n];!s||r.y-s.y>s.height/2?e.push([r]):e[e.length-1].push(r),s=r}return e.map(n=>St(sn(n)))}const rs=function(i){return i===void 0&&(i={}),{name:"inline",options:i,async fn(t){const{placement:e,elements:s,rects:n,platform:r,strategy:o}=t,{padding:l=2,x:a,y:c}=Ut(i,t),d=Array.from(await(r.getClientRects==null?void 0:r.getClientRects(s.reference))||[]),h=ss(d),f=St(sn(d)),m=en(l);function b(){if(h.length===2&&h[0].left>h[1].right&&a!=null&&c!=null)return h.find(g=>a>g.left-m.left&&a<g.right+m.right&&c>g.top-m.top&&c<g.bottom+m.bottom)||f;if(h.length>=2){if(yt(e)==="y"){const k=h[0],_t=h[h.length-1],Bt=X(e)==="top",wt=k.top,W=_t.bottom,Ct=Bt?k.left:_t.left,it=Bt?k.right:_t.right,nt=it-Ct,Q=W-wt;return{top:wt,bottom:W,left:Ct,right:it,width:nt,height:Q,x:Ct,y:wt}}const g=X(e)==="left",S=G(...h.map(k=>k.right)),$=Et(...h.map(k=>k.left)),_=h.filter(k=>g?k.left===$:k.right===S),w=_[0].top,O=_[_.length-1].bottom,x=$,P=S,F=P-x,N=O-w;return{top:w,bottom:O,left:x,right:P,width:F,height:N,x,y:w}}return f}const v=await r.getElementRects({reference:{getBoundingClientRect:b},floating:s.floating,strategy:o});return n.reference.x!==v.reference.x||n.reference.y!==v.reference.y||n.reference.width!==v.reference.width||n.reference.height!==v.reference.height?{reset:{rects:v}}:{}}}};async function os(i,t){const{placement:e,platform:s,elements:n}=i,r=await(s.isRTL==null?void 0:s.isRTL(n.floating)),o=X(e),l=ge(e),a=yt(e)==="y",c=["left","top"].includes(o)?-1:1,d=r&&a?-1:1,h=Ut(t,i);let{mainAxis:f,crossAxis:m,alignmentAxis:b}=typeof h=="number"?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...h};return l&&typeof b=="number"&&(m=l==="end"?b*-1:b),a?{x:m*d,y:f*c}:{x:f*c,y:m*d}}const rn=function(i){return{name:"offset",options:i,async fn(t){var e,s;const{x:n,y:r,placement:o,middlewareData:l}=t,a=await os(t,i);return o===((e=l.offset)==null?void 0:e.placement)&&(s=l.arrow)!=null&&s.alignmentOffset?{}:{x:n+a.x,y:r+a.y,data:{...a,placement:o}}}}},ls=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(t){const{x:e,y:s,placement:n}=t,{mainAxis:r=!0,crossAxis:o=!1,limiter:l={fn:g=>{let{x:S,y:$}=g;return{x:S,y:$}}},...a}=Ut(i,t),c={x:e,y:s},d=await nn(t,a),h=yt(X(n)),f=Ji(h);let m=c[f],b=c[h];if(r){const g=f==="y"?"top":"left",S=f==="y"?"bottom":"right",$=m+d[g],_=m-d[S];m=Si($,m,_)}if(o){const g=h==="y"?"top":"left",S=h==="y"?"bottom":"right",$=b+d[g],_=b-d[S];b=Si($,b,_)}const v=l.fn({...t,[f]:m,[h]:b});return{...v,data:{x:v.x-e,y:v.y-s}}}}};function lt(i){return on(i)?(i.nodeName||"").toLowerCase():"#document"}function B(i){var t;return(i==null||(t=i.ownerDocument)==null?void 0:t.defaultView)||window}function pt(i){var t;return(t=(on(i)?i.ownerDocument:i.document)||window.document)==null?void 0:t.documentElement}function on(i){return i instanceof Node||i instanceof B(i).Node}function U(i){return i instanceof Element||i instanceof B(i).Element}function Y(i){return i instanceof HTMLElement||i instanceof B(i).HTMLElement}function Oi(i){return typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof B(i).ShadowRoot}function Yt(i){const{overflow:t,overflowX:e,overflowY:s,display:n}=R(i);return/auto|scroll|overlay|hidden|clip/.test(t+s+e)&&!["inline","contents"].includes(n)}function as(i){return["table","td","th"].includes(lt(i))}function cs(i){return[":popover-open",":modal"].some(t=>{try{return i.matches(t)}catch{return!1}})}function Qe(i){const t=Ue(),e=U(i)?R(i):i;return e.transform!=="none"||e.perspective!=="none"||(e.containerType?e.containerType!=="normal":!1)||!t&&(e.backdropFilter?e.backdropFilter!=="none":!1)||!t&&(e.filter?e.filter!=="none":!1)||["transform","perspective","filter"].some(s=>(e.willChange||"").includes(s))||["paint","layout","strict","content"].some(s=>(e.contain||"").includes(s))}function us(i){let t=kt(i);for(;Y(t)&&!ve(t);){if(Qe(t))return t;if(cs(t))return null;t=kt(t)}return null}function Ue(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function ve(i){return["html","body","#document"].includes(lt(i))}function R(i){return B(i).getComputedStyle(i)}function ye(i){return U(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function kt(i){if(lt(i)==="html")return i;const t=i.assignedSlot||i.parentNode||Oi(i)&&i.host||pt(i);return Oi(t)?t.host:t}function ln(i){const t=kt(i);return ve(t)?i.ownerDocument?i.ownerDocument.body:i.body:Y(t)&&Yt(t)?t:ln(t)}function Le(i,t,e){var s;t===void 0&&(t=[]),e===void 0&&(e=!0);const n=ln(i),r=n===((s=i.ownerDocument)==null?void 0:s.body),o=B(n);if(r){const l=ds(o);return t.concat(o,o.visualViewport||[],Yt(n)?n:[],l&&e?Le(l):[])}return t.concat(n,Le(n,[],e))}function ds(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function an(i){const t=R(i);let e=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const n=Y(i),r=n?i.offsetWidth:e,o=n?i.offsetHeight:s,l=re(e)!==r||re(s)!==o;return l&&(e=r,s=o),{width:e,height:s,$:l}}function cn(i){return U(i)?i:i.contextElement}function $t(i){const t=cn(i);if(!Y(t))return ot(1);const e=t.getBoundingClientRect(),{width:s,height:n,$:r}=an(t);let o=(r?re(e.width):e.width)/s,l=(r?re(e.height):e.height)/n;return(!o||!Number.isFinite(o))&&(o=1),(!l||!Number.isFinite(l))&&(l=1),{x:o,y:l}}const hs=ot(0);function un(i){const t=B(i);return!Ue()||!t.visualViewport?hs:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function fs(i,t,e){return t===void 0&&(t=!1),!e||t&&e!==B(i)?!1:t}function Ht(i,t,e,s){t===void 0&&(t=!1),e===void 0&&(e=!1);const n=i.getBoundingClientRect(),r=cn(i);let o=ot(1);t&&(s?U(s)&&(o=$t(s)):o=$t(i));const l=fs(r,e,s)?un(r):ot(0);let a=(n.left+l.x)/o.x,c=(n.top+l.y)/o.y,d=n.width/o.x,h=n.height/o.y;if(r){const f=B(r),m=s&&U(s)?B(s):s;let b=f,v=b.frameElement;for(;v&&s&&m!==b;){const g=$t(v),S=v.getBoundingClientRect(),$=R(v),_=S.left+(v.clientLeft+parseFloat($.paddingLeft))*g.x,w=S.top+(v.clientTop+parseFloat($.paddingTop))*g.y;a*=g.x,c*=g.y,d*=g.x,h*=g.y,a+=_,c+=w,b=B(v),v=b.frameElement}}return St({width:d,height:h,x:a,y:c})}const ps=[":popover-open",":modal"];function dn(i){return ps.some(t=>{try{return i.matches(t)}catch{return!1}})}function ms(i){let{elements:t,rect:e,offsetParent:s,strategy:n}=i;const r=n==="fixed",o=pt(s),l=t?dn(t.floating):!1;if(s===o||l&&r)return e;let a={scrollLeft:0,scrollTop:0},c=ot(1);const d=ot(0),h=Y(s);if((h||!h&&!r)&&((lt(s)!=="body"||Yt(o))&&(a=ye(s)),Y(s))){const f=Ht(s);c=$t(s),d.x=f.x+s.clientLeft,d.y=f.y+s.clientTop}return{width:e.width*c.x,height:e.height*c.y,x:e.x*c.x-a.scrollLeft*c.x+d.x,y:e.y*c.y-a.scrollTop*c.y+d.y}}function bs(i){return Array.from(i.getClientRects())}function hn(i){return Ht(pt(i)).left+ye(i).scrollLeft}function gs(i){const t=pt(i),e=ye(i),s=i.ownerDocument.body,n=G(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),r=G(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let o=-e.scrollLeft+hn(i);const l=-e.scrollTop;return R(s).direction==="rtl"&&(o+=G(t.clientWidth,s.clientWidth)-n),{width:n,height:r,x:o,y:l}}function vs(i,t){const e=B(i),s=pt(i),n=e.visualViewport;let r=s.clientWidth,o=s.clientHeight,l=0,a=0;if(n){r=n.width,o=n.height;const c=Ue();(!c||c&&t==="fixed")&&(l=n.offsetLeft,a=n.offsetTop)}return{width:r,height:o,x:l,y:a}}function ys(i,t){const e=Ht(i,!0,t==="fixed"),s=e.top+i.clientTop,n=e.left+i.clientLeft,r=Y(i)?$t(i):ot(1),o=i.clientWidth*r.x,l=i.clientHeight*r.y,a=n*r.x,c=s*r.y;return{width:o,height:l,x:a,y:c}}function Ai(i,t,e){let s;if(t==="viewport")s=vs(i,e);else if(t==="document")s=gs(pt(i));else if(U(t))s=ys(t,e);else{const n=un(i);s={...t,x:t.x-n.x,y:t.y-n.y}}return St(s)}function fn(i,t){const e=kt(i);return e===t||!U(e)||ve(e)?!1:R(e).position==="fixed"||fn(e,t)}function xs(i,t){const e=t.get(i);if(e)return e;let s=Le(i,[],!1).filter(l=>U(l)&&lt(l)!=="body"),n=null;const r=R(i).position==="fixed";let o=r?kt(i):i;for(;U(o)&&!ve(o);){const l=R(o),a=Qe(o);!a&&l.position==="fixed"&&(n=null),(r?!a&&!n:!a&&l.position==="static"&&!!n&&["absolute","fixed"].includes(n.position)||Yt(o)&&!a&&fn(i,o))?s=s.filter(d=>d!==o):n=l,o=kt(o)}return t.set(i,s),s}function _s(i){let{element:t,boundary:e,rootBoundary:s,strategy:n}=i;const o=[...e==="clippingAncestors"?xs(t,this._c):[].concat(e),s],l=o[0],a=o.reduce((c,d)=>{const h=Ai(t,d,n);return c.top=G(h.top,c.top),c.right=Et(h.right,c.right),c.bottom=Et(h.bottom,c.bottom),c.left=G(h.left,c.left),c},Ai(t,l,n));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}}function ws(i){const{width:t,height:e}=an(i);return{width:t,height:e}}function Cs(i,t,e){const s=Y(t),n=pt(t),r=e==="fixed",o=Ht(i,!0,r,t);let l={scrollLeft:0,scrollTop:0};const a=ot(0);if(s||!s&&!r)if((lt(t)!=="body"||Yt(n))&&(l=ye(t)),s){const h=Ht(t,!0,r,t);a.x=h.x+t.clientLeft,a.y=h.y+t.clientTop}else n&&(a.x=hn(n));const c=o.left+l.scrollLeft-a.x,d=o.top+l.scrollTop-a.y;return{x:c,y:d,width:o.width,height:o.height}}function Ti(i,t){return!Y(i)||R(i).position==="fixed"?null:t?t(i):i.offsetParent}function pn(i,t){const e=B(i);if(!Y(i)||dn(i))return e;let s=Ti(i,t);for(;s&&as(s)&&R(s).position==="static";)s=Ti(s,t);return s&&(lt(s)==="html"||lt(s)==="body"&&R(s).position==="static"&&!Qe(s))?e:s||us(i)||e}const $s=async function(i){const t=this.getOffsetParent||pn,e=this.getDimensions;return{reference:Cs(i.reference,await t(i.floating),i.strategy),floating:{x:0,y:0,...await e(i.floating)}}};function Es(i){return R(i).direction==="rtl"}const Ss={convertOffsetParentRelativeRectToViewportRelativeRect:ms,getDocumentElement:pt,getClippingRect:_s,getOffsetParent:pn,getElementRects:$s,getClientRects:bs,getDimensions:ws,getScale:$t,isElement:U,isRTL:Es},mn=ls,bn=ns,gn=rs,vn=(i,t,e)=>{const s=new Map,n={platform:Ss,...e},r={...n.platform,_c:s};return is(i,t,{...n,platform:r})};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ks=i=>i.strings===void 0;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Os={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},As=i=>(...t)=>({_$litDirective$:i,values:t});class Ts{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this.t=t,this._$AM=e,this.i=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mt=(i,t)=>{var s;const e=i._$AN;if(e===void 0)return!1;for(const n of e)(s=n._$AO)==null||s.call(n,t,!1),Mt(n,t);return!0},le=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while((e==null?void 0:e.size)===0)},yn=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),Ls(t)}};function Ps(i){this._$AN!==void 0?(le(this),this._$AM=i,yn(this)):this._$AM=i}function Is(i,t=!1,e=0){const s=this._$AH,n=this._$AN;if(n!==void 0&&n.size!==0)if(t)if(Array.isArray(s))for(let r=e;r<s.length;r++)Mt(s[r],!1),le(s[r]);else s!=null&&(Mt(s,!1),le(s));else Mt(this,i)}const Ls=i=>{i.type==Os.CHILD&&(i._$AP??(i._$AP=Is),i._$AQ??(i._$AQ=Ps))};class zs extends Ts{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),yn(this),this.isConnected=t._$AU}_$AO(t,e=!0){var s,n;t!==this.isConnected&&(this.isConnected=t,t?(s=this.reconnected)==null||s.call(this):(n=this.disconnected)==null||n.call(this)),e&&(Mt(this,t),le(this))}setValue(t){if(ks(this.t))this.t._$AI(t,this);else{const e=[...this.t._$AH];e[this.i]=t,this.t._$AI(e,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ot=()=>new js;class js{}const Se=new WeakMap,At=As(class extends zs{render(i){return Pe}update(i,[t]){var s;const e=t!==this.Y;return e&&this.Y!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.Y=t,this.ht=(s=i.options)==null?void 0:s.host,this.rt(this.ct=i.element)),Pe}rt(i){if(this.isConnected||(i=void 0),typeof this.Y=="function"){const t=this.ht??globalThis;let e=Se.get(t);e===void 0&&(e=new WeakMap,Se.set(t,e)),e.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),e.set(this.Y,i),i!==void 0&&this.Y.call(this.ht,i)}else this.Y.value=i}get lt(){var i,t;return typeof this.Y=="function"?(i=Se.get(this.ht??globalThis))==null?void 0:i.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});/**
* (c) Iconify
*
 ...
 */const Ki=i=>i??Pe;var Co=Object.defineProperty,$o=Object.getOwnPropertyDescriptor,et=(i,t,e,s)=>{for(var n=s>1?void 0:s?$o(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Co(t,e,n),n};const _i=class _i extends E{constructor(){super(...arguments),this._inputTypes=["date","datetime-local","email","month","password","search","tel","text","time","url","week","area"],this.value="",this.vertical=!1,this._type="text",this.onValueChange=new Event("input")}set type(t){this._inputTypes.includes(t)&&(this._type=t)}get type(){return this._type}get query(){return qe(this.value)}onInputChange(t){t.stopPropagation();const e=t.target;clearTimeout(this._debounceTimeoutID),this._debounceTimeoutID=setTimeout(()=>{this.value=e.value,this.dispatchEvent(this.onValueChange)},this.debounce)}focus(){setTimeout(()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()})}render(){return p`
  ...
  `;let me=Ei;Io([u({type:String,reflect:!0})],me.prototype,"name");export{Hn as C,At as K,Ve as M,As as e,Ts as i,Os as t};
