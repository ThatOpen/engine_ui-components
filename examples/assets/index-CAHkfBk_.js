import{N as F,f as u,J as k,e as R,F as T,V as S,d as A,h as V,B as j,u as E}from"./index-DAd_Xb3m.js";import"./lit-html-BUQgm8fs.js";const N=(n,s)=>{const t=s[n],e=(t==null?void 0:t.name)??n,i=e.trim().split(/\s+/);let o,r;return i[0]&&i[0][0]&&(o=i[0][0].toUpperCase(),i[0][1]&&(r=i[0][1].toUpperCase())),i[1]&&i[1][0]&&(r=i[1][0].toUpperCase()),u`
  ...
  `},ne=(n,s)=>{const{components:t,topic:e}=n;s.noIndentation=!0,s.headersHidden=!0,s.hiddenColumns=["Guid"],s.columns=["Title",{name:"Actions",width:"auto"}];const i={selectComponents:!0,colorizeComponent:!0,resetColors:!0,updateCamera:!0,delete:!0,unlink:!!e,...n.actions},o=t.get(A);s.dataTransform={Actions:(r,c)=>{const{Guid:l}=c;if(!(l&&typeof l=="string"))return r;const a=o.list.get(l);if(!a)return r;const d=async({target:C})=>{C.loading=!0,await a.go(),C.loading=!1};let m;i.selectComponents&&(m=u`
        ...
        `);let w;i.delete&&(w=u`
          <bim-button label="Delete" @click=${()=>{o.list.delete(a.guid),V.removeMenus()}}></bim-button>
  ...
  `},ce=(n,s)=>{const{topic:t,styles:e}=n,i={delete:!0,...n.actions};s.headersHidden=!0,s.hiddenColumns=["guid","author"],s.dataTransform={Comment:(o,r)=>{const{guid:c}=r;if(typeof c!="string")return o;const l=t.comments.get(c);if(!l)return o;const a=()=>{t.comments.delete(c)};let d;if(i.delete){const m=`btn-${E.newRandomId()}`;d=u`
          <div>
            <style>
              #${m} {
      ...
      `}}},de=(n,s=!0)=>{const t=S.create(H,n),[e,i]=t;if(ce(n,e),s){const{topic:o}=n,r=()=>i();o.comments.onItemSet.add(r),o.comments.onItemUpdated.add(r),o.comments.onItemDeleted.add(r),o.comments.onCleared.add(r)}return t},me=Object.freeze(Object.defineProperty({__proto__:null,commentsList:de,commentsListTemplate:H},Symbol.toStringTag,{value:"Module"})),ge={...K,...Z,...oe,...se,...re,...me};export{N as a,M as b,de as c,_ as d,ge as e,le as t,ie as v};
