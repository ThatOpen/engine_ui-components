import"./lit-html-CgQwCkHV.js";import{B as z,T as C,h as S,J as Q,f as o,c as be,U as I,X as M,M as Z,V as ee,C as ue,W as fe,S as ye,a as ge,O as $e,G as we,F as ve,I as he}from"./index-CDIUJH9Y.js";import"./index-oRQxncg0.js";import{c as Te,d as D,a as U,b as V,t as ke,v as xe,e as Se}from"./index-D3M56kln.js";import{e as Y}from"./ref-B0YVjWyu.js";const Ie={dueDate:e=>{if(typeof e=="string"&&e.trim()!=="")return new Date(e)},status:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},type:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},priority:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},stage:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},assignedTo:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},labels:e=>{if(Array.isArray(e))return new Set(e)}},te=e=>{const{components:l,topic:t,value:i,onCancel:n,onSubmit:s,styles:r}=e,m=s??(()=>{}),d=l.get(z),v=(i==null?void 0:i.title)??(t==null?void 0:t.title)??C.default.title,p=(i==null?void 0:i.status)??(t==null?void 0:t.status)??C.default.status,b=(i==null?void 0:i.type)??(t==null?void 0:t.type)??C.default.type,a=(i==null?void 0:i.priority)??(t==null?void 0:t.priority)??C.default.priority,y=(i==null?void 0:i.assignedTo)??(t==null?void 0:t.assignedTo)??C.default.assignedTo,u=(i==null?void 0:i.labels)??(t==null?void 0:t.labels)??C.default.labels,g=(i==null?void 0:i.stage)??(t==null?void 0:t.stage)??C.default.stage,k=(i==null?void 0:i.description)??(t==null?void 0:t.description)??C.default.description,$=t!=null&&t.dueDate?t.dueDate.toISOString().split("T")[0]:null,f=new Set([...d.config.statuses]);p&&f.add(p);const h=new Set([...d.config.types]);b&&h.add(b);const w=new Set([...d.config.priorities]);a&&w.add(a);const j=new Set([...d.config.users]);y&&j.add(y);const G=new Set([...d.config.labels]);if(u)for(const c of u)G.add(c);const J=new Set([...d.config.stages]);g&&J.add(g);const X=Y(),me=async()=>{const{value:c}=X;if(!c)return;const x=be(c,Ie);if(t)t.set(x),await m(t);else{const B=d.create(x);await m(B)}},H=Y(),de=c=>{const{value:x}=H;if(!x)return;const B=c.target;x.disabled=B.value.trim()===""},N=`btn-${S.newRandomId()}`,E=`btn-${S.newRandomId()}`;return o`
    <div ${Q(X)} style="display: flex; flex-direction: column; gap: 0.75rem;">
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-dropdown vertical label="Assignee" name="assignedTo">
          ${[...j].map(c=>{const x=r!=null&&r.users?r.users[c]:null,B=x?x.name:c,pe=x==null?void 0:x.picture;return o`<bim-option label=${B} value=${c} .img=${pe} .checked=${y===c}></bim-option>`})}
        </bim-dropdown>
      </div>
      <div style="display: flex; gap: 0.375rem">
        <bim-text-input vertical type="date" label="Due Date" name="dueDate" .value=${$}></bim-text-input> 
        <bim-dropdown vertical label="Stage" name="stage">
          ${[...J].map(c=>o`<bim-option label=${c} .checked=${g===c}></bim-option>`)}
        </bim-dropdown>
      </div>
      ...
      <div style="justify-content: right; display: flex; gap: 0.375rem">
        ...
        <bim-button id=${N} style="flex: 0" @click=${me} ${Q(H)} label=${t?"Update Topic":"Add Topic"} icon=${t?"tabler:refresh":"mi:add"}></bim-button>
      </div>
    </div>
  ...
  `),W=document.createElement("bim-grid");W.layouts={main:{template:`
    ...
    /24rem 1fr
    `,elements:{bcfPanel:Ne,viewport:q,customTopicPanel:Xe}}};W.layout="main";document.body.append(W);
