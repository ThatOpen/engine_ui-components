...
`,Tt={scrollbar:Wc,globalStyles:qc},dr=class k{static set config(t){this._config={...k._config,...t}}static get config(){return k._config}static addGlobalStyles(){let t=document.querySelector("style[id='bim-ui']");if(t)return;t=document.createElement("style"),t.id="bim-ui",t.textContent=Tt.globalStyles.cssText;const i=document.head.firstChild;i?document.head.insertBefore(t,i):document.head.append(t)}static defineCustomElement(t,i){customElements.get(t)||customElements.define(t,i)}static registerComponents(){k.init()}static init(){k.addGlobalStyles(),k.defineCustomElement("bim-button",Zc),k.defineCustomElement("bim-checkbox",ge),k.defineCustomElement("bim-color-input",Gt),k.defineCustomElement("bim-context-menu",An),k.defineCustomElement("bim-dropdown",vt),k.defineCustomElement("bim-grid",Wn),k.defineCustomElement("bim-icon",rd),k.defineCustomElement("bim-input",oi),k.defineCustomElement("bim-label",ye),k.defineCustomElement("bim-number-input",Z),k.defineCustomElement("bim-option",F),k.defineCustomElement("bim-panel",Yt),k.defineCustomElement("bim-panel-section",_e),k.defineCustomElement("bim-selector",$e),k.defineCustomElement("bim-table",st),k.defineCustomElement("bim-tabs",Jt),k.defineCustomElement("bim-tab",et),k.defineCustomElement("bim-table-cell",Ar),k.defineCustomElement("bim-table-children",Sr),k.defineCustomElement("bim-table-group",Tr),k.defineCustomElement("bim-table-row",Xt),k.defineCustomElement("bim-text-input",rt),k.defineCustomElement("bim-toolbar",Zi),k.defineCustomElement("bim-toolbar-group",Ji),k.defineCustomElement("bim-toolbar-section",Ce),k.defineCustomElement("bim-viewport",Fr)}static newRandomId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";let i="";for(let n=0;n<10;n++){const o=Math.floor(Math.random()*t.length);i+=t.charAt(o)}return i}};dr._config={sectionLabelOnVerticalToolbar:!1};let Q=dr;class U extends T{constructor(){super(...arguments),this._lazyLoadObserver=null,this._visibleElements=[],this.ELEMENTS_BEFORE_OBSERVER=20,this.useObserver=!1,this.elements=new Set,this.observe=t=>{if(!this.useObserver)return;for(const n of t)this.elements.add(n);const i=t.slice(this.ELEMENTS_BEFORE_OBSERVER);for(const n of i)n.remove();this.observeLastElement()}}set visibleElements(t){this._visibleElements=this.useObserver?t:[],this.requestUpdate()}get visibleElements(){return this._visibleElements}getLazyObserver(){if(!this.useObserver)return null;if(this._lazyLoadObserver)return this._lazyLoadObserver;const t=new IntersectionObserver(i=>{const n=i[0];if(!n.isIntersecting)return;const o=n.target;t.unobserve(o);const s=this.ELEMENTS_BEFORE_OBSERVER+this.visibleElements.length,r=[...this.elements][s];r&&(this.visibleElements=[...this.visibleElements,r],t.observe(r))},{threshold:.5});return t}observeLastElement(){const t=this.getLazyObserver();if(!t)return;const i=this.ELEMENTS_BEFORE_OBSERVER+this.visibleElements.length-1,n=[...this.elements][i];n&&t.observe(n)}resetVisibleElements(){const t=this.getLazyObserver();if(t){for(const i of this.elements)t.unobserve(i);this.visibleElements=[],this.observeLastElement()}}static create(t,i){const n=document.createDocumentFragment();if(t.length===0)return ce(t(),n),n.firstElementChild;if(!i)throw new Error("UIComponent: Initial state is required for statefull components.");let o=i;const s=t,r=a=>(o={...o,...a},ce(s(o,r),n),o);r(i);const l=()=>o;return[n.firstElementChild,r,l]}}const We=(e,t={},i=!0)=>{let n={};for(const o of e.children){const s=o,r=s.getAttribute("name")||s.getAttribute("label"),l=t[r];if(r){if("value"in s&&typeof s.value<"u"&&s.value!==null){const a=s.value;if(typeof a=="object"&&!Array.isArray(a)&&Object.keys(a).length===0)continue;n[r]=l?l(s.value):s.value}else if(i){const a=We(s,t);if(Object.keys(a).length===0)continue;n[r]=l?l(a):a}}else i&&(n={...n,...We(s,t)})}return n},Gi=e=>e==="true"||e==="false"?e==="true":e&&!isNaN(Number(e))&&e.trim()!==""?Number(e):e,Gc=[">=","<=","=",">","<","?","/","#"];function Bo(e){const t=Gc.find(r=>e.split(r).length===2),i=e.split(t).map(r=>r.trim()),[n,o]=i,s=o.startsWith("'")&&o.endsWith("'")?o.replace(/'/g,""):Gi(o);return{key:n,condition:t,value:s}}const Cn=e=>{try{const t=[],i=e.split(/&(?![^()]*\))/).map(n=>n.trim());for(const n of i){const o=!n.startsWith("(")&&!n.endsWith(")"),s=n.startsWith("(")&&n.endsWith(")");if(o){const r=Bo(n);t.push(r)}if(s){const r={operator:"&",queries:n.replace(/^(\()|(\))$/g,"").split("&").map(l=>l.trim()).map((l,a)=>{const d=Bo(l);return a>0&&(d.operator="&"),d})};t.push(r)}}return t}catch{return null}},Uo=(e,t,i)=>{let n=!1;switch(t){case"=":n=e===i;break;case"?":n=String(e).includes(String(i));break;case"<":(typeof e=="number"||typeof i=="number")&&(n=e<i);break;case"<=":(typeof e=="number"||typeof i=="number")&&(n=e<=i);break;case">":(typeof e=="number"||typeof i=="number")&&(n=e>i);break;case">=":(typeof e=="number"||typeof i=="number")&&(n=e>=i);break;case"/":n=String(e).startsWith(String(i));break}return n};var Yc=Object.defineProperty,Xc=Object.getOwnPropertyDescriptor,ur=(e,t,i,n)=>{for(var o=Xc(t,i),s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&Yc(t,i,o),o},D;const Vn=(D=class extends T{constructor(){super(...arguments),this._previousContainer=null,this._visible=!1}get placement(){return this._placement}set placement(e){this._placement=e,this.updatePosition()}static removeMenus(){for(const e of D.menus)e instanceof D&&(e.visible=!1);D.dialog.close(),D.dialog.remove()}get visible(){return this._visible}set visible(e){var t;this._visible=e,e?(D.dialog.parentElement||document.body.append(D.dialog),this._previousContainer=this.parentElement,D.dialog.style.top=`${window.scrollY||document.documentElement.scrollTop}px`,D.dialog.append(this),D.dialog.showModal(),this.updatePosition(),this.dispatchEvent(new Event("visible"))):((t=this._previousContainer)==null||t.append(this),this._previousContainer=null,this.dispatchEvent(new Event("hidden")))}async updatePosition(){if(!(this.visible&&this._previousContainer))return;const e=this.placement??"right",t=await Ns(this._previousContainer,this,{placement:e,middleware:[ys(10),Is(),Os(),Ts({padding:5})]}),{x:i,y:n}=t;this.style.left=`${i}px`,this.style.top=`${n}px`}connectedCallback(){super.connectedCallback(),D.menus.push(this)}render(){return m` <slot></slot> `}},D.styles=[Tt.scrollbar,I`
  ...
  `;let Gt=pr;ve([g({type:String,reflect:!0})],Gt.prototype,"name");ve([g({type:String,reflect:!0})],Gt.prototype,"label");ve([g({type:String,reflect:!0})],Gt.prototype,"icon");ve([g({type:Boolean,reflect:!0})],Gt.prototype,"vertical");ve([g({type:Number,reflect:!0})],Gt.prototype,"opacity");ve([g({type:String,reflect:!0})],Gt.prototype,"color");var ed=Object.defineProperty,id=Object.getOwnPropertyDescriptor,Ot=(e,t,i,n)=>{for(var o=n>1?void 0:n?id(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ed(t,i,o),o};const mr=class extends T{constructor(){super(...arguments),this.checked=!1,this.checkbox=!1,this.noMark=!1,this.vertical=!1}get value(){return this._value!==void 0?this._value:this.label?Gi(this.label):this.label}set value(e){this._value=e}render(){return m`
  ...
  `;let F=mr;Ot([g({type:String,reflect:!0})],F.prototype,"img",2);Ot([g({type:String,reflect:!0})],F.prototype,"label",2);Ot([g({type:String,reflect:!0})],F.prototype,"icon",2);Ot([g({type:Boolean,reflect:!0})],F.prototype,"checked",2);Ot([g({type:Boolean,reflect:!0})],F.prototype,"checkbox",2);Ot([g({type:Boolean,attribute:"no-mark",reflect:!0})],F.prototype,"noMark",2);Ot([g({converter:{fromAttribute(e){return e&&Gi(e)}}})],F.prototype,"value",1);Ot([g({type:Boolean,reflect:!0})],F.prototype,"vertical",2);var nd=Object.defineProperty,od=Object.getOwnPropertyDescriptor,It=(e,t,i,n)=>{for(var o=n>1?void 0:n?od(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&nd(t,i,o),o};const br=class extends U{constructor(){super(),this.multiple=!1,this.required=!1,this.vertical=!1,this._visible=!1,this._value=new Set,this.onValueChange=new Event("change"),this._contextMenu=de(),this.onOptionClick=e=>{const t=e.target,i=this._value.has(t);if(!this.multiple&&!this.required&&!i)this._value=new Set([t]);else if(!this.multiple&&!this.required&&i)this._value=new Set([]);else if(!this.multiple&&this.required&&!i)this._value=new Set([t]);else if(this.multiple&&!this.required&&!i)this._value=new Set([...this._value,t]);else if(this.multiple&&!this.required&&i){const n=[...this._value].filter(o=>o!==t);this._value=new Set(n)}else if(this.multiple&&this.required&&!i)this._value=new Set([...this._value,t]);else if(this.multiple&&this.required&&i){const n=[...this._value].filter(s=>s!==t),o=new Set(n);o.size!==0&&(this._value=o)}this.updateOptionsState(),this.dispatchEvent(this.onValueChange)},this.useObserver=!0}set visible(e){if(e){const{value:t}=this._contextMenu;if(!t)return;for(const i of this.elements)t.append(i);this._visible=!0}else{for(const t of this.elements)this.append(t);this._visible=!1,this.resetVisibleElements()}}get visible(){return this._visible}set value(e){if(this.required&&Object.keys(e).length===0)return;const t=new Set;for(const i of e){const n=this.findOption(i);if(n&&(t.add(n),!this.multiple&&Object.keys(e).length===1))break}this._value=t,this.updateOptionsState(),this.dispatchEvent(this.onValueChange)}get value(){return[...this._value].filter(e=>e instanceof F&&e.checked).map(e=>e.value)}get _options(){const e=new Set([...this.elements]);for(const t of this.children)t instanceof F&&e.add(t);return[...e]}onSlotChange(e){const t=e.target.assignedElements();this.observe(t);const i=new Set;for(const n of this.elements){if(!(n instanceof F)){n.remove();continue}n.checked&&i.add(n),n.removeEventListener("click",this.onOptionClick),n.addEventListener("click",this.onOptionClick)}this._value=i}updateOptionsState(){for(const e of this._options)e instanceof F&&(e.checked=this._value.has(e))}findOption(e){return this._options.find(t=>t instanceof F?t.label===e||t.value===e:!1)}render(){let e,t,i;if(this._value.size===0)e="Select an option...";else if(this._value.size===1){const n=[...this._value][0];e=(n==null?void 0:n.label)||(n==null?void 0:n.value),t=n==null?void 0:n.img,i=n==null?void 0:n.icon}else e=`Multiple (${this._value.size})`;return m`
    ...
    `];let vt=br;It([g({type:String,reflect:!0})],vt.prototype,"name",2);It([g({type:String,reflect:!0})],vt.prototype,"icon",2);It([g({type:String,reflect:!0})],vt.prototype,"label",2);It([g({type:Boolean,reflect:!0})],vt.prototype,"multiple",2);It([g({type:Boolean,reflect:!0})],vt.prototype,"required",2);It([g({type:Boolean,reflect:!0})],vt.prototype,"vertical",2);It([g({type:Boolean,reflect:!0})],vt.prototype,"visible",1);It([fe()],vt.prototype,"_value",2);var sd=Object.defineProperty,fr=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&sd(t,i,o),o};const gr=class extends T{constructor(){super(...arguments),this.floating=!1,this.layouts={}}getUniqueAreasFromTemplate(e){const t=e.split(`
`).map(i=>i.trim()).map(i=>i.split('"')[1]).filter(i=>i!==void 0).flatMap(i=>i.split(/\s+/));return[...new Set(t)].filter(i=>i!=="")}firstUpdated(){this._onLayoutChange=new Event("layoutchange")}render(){if(this.layout){if(this.layouts[this.layout]){this.innerHTML="";const e=this.layouts[this.layout],t=this.getUniqueAreasFromTemplate(e.template).map(i=>{const n=e.elements[i];return n&&(n.style.gridArea=i),n}).filter(i=>!!i);this.style.gridTemplate=e.template,this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange),this.append(...t)}}else this.innerHTML="",this.style.gridTemplate="",this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange);return m`<slot></slot>`}};gr.styles=I`
  ...
  `;let oi=vr;Yi([g({type:String,reflect:!0})],oi.prototype,"name");Yi([g({type:String,reflect:!0})],oi.prototype,"label");Yi([g({type:String,reflect:!0})],oi.prototype,"icon");Yi([g({type:Boolean,reflect:!0})],oi.prototype,"vertical");var ld=Object.defineProperty,si=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&ld(t,i,o),o};const yr=class extends T{constructor(){super(...arguments),this.labelHidden=!1,this.iconHidden=!1,this.vertical=!1}get value(){return this.textContent?Gi(this.textContent):this.textContent}render(){return m`
  ...
  `;let Z=_r;ot([g({type:String,reflect:!0})],Z.prototype,"name",2);ot([g({type:String,reflect:!0})],Z.prototype,"icon",2);ot([g({type:String,reflect:!0})],Z.prototype,"label",2);ot([g({type:String,reflect:!0})],Z.prototype,"pref",2);ot([g({type:Number,reflect:!0})],Z.prototype,"min",2);ot([g({type:Number,reflect:!0})],Z.prototype,"value",1);ot([g({type:Number,reflect:!0})],Z.prototype,"step",2);ot([g({type:Number,reflect:!0})],Z.prototype,"sensitivity",2);ot([g({type:Number,reflect:!0})],Z.prototype,"max",2);ot([g({type:String,reflect:!0})],Z.prototype,"suffix",2);ot([g({type:Boolean,reflect:!0})],Z.prototype,"vertical",2);ot([g({type:Boolean,reflect:!0})],Z.prototype,"slider",2);var ud=Object.defineProperty,hd=Object.getOwnPropertyDescriptor,ri=(e,t,i,n)=>{for(var o=n>1?void 0:n?hd(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&ud(t,i,o),o};const $r=class extends T{constructor(){super(...arguments),this.onValueChange=new Event("change"),this._hidden=!1,this.headerHidden=!1,this.valueTransform={},this.activationButton=document.createElement("bim-button")}set hidden(e){this._hidden=e,this.activationButton.active=!e,this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}get value(){return We(this,this.valueTransform)}set value(e){const t=[...this.children];for(const i in e){const n=t.find(s=>{const r=s;return r.name===i||r.label===i});if(!n)continue;const o=n;o.value=e[i]}}connectedCallback(){super.connectedCallback(),this.activationButton.active=!this.hidden,this.activationButton.onclick=()=>this.hidden=!this.hidden}disconnectedCallback(){super.disconnectedCallback(),this.activationButton.remove()}collapseSections(){const e=this.querySelectorAll("bim-panel-section");for(const t of e)t.collapsed=!0}expandSections(){const e=this.querySelectorAll("bim-panel-section");for(const t of e)t.collapsed=!1}render(){return this.activationButton.icon=this.icon,this.activationButton.label=this.label||this.name,this.activationButton.tooltipTitle=this.label||this.name,m`
    ...
    `];let Yt=$r;ri([g({type:String,reflect:!0})],Yt.prototype,"icon",2);ri([g({type:String,reflect:!0})],Yt.prototype,"name",2);ri([g({type:String,reflect:!0})],Yt.prototype,"label",2);ri([g({type:Boolean,reflect:!0})],Yt.prototype,"hidden",1);ri([g({type:Boolean,attribute:"header-hidden",reflect:!0})],Yt.prototype,"headerHidden",2);var pd=Object.defineProperty,ai=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&pd(t,i,o),o};const wr=class extends T{constructor(){super(...arguments),this.onValueChange=new Event("change"),this.valueTransform={}}get value(){const e=this.parentElement;let t;return e instanceof Yt&&(t=e.valueTransform),Object.values(this.valueTransform).length!==0&&(t=this.valueTransform),We(this,t)}set value(e){const t=[...this.children];for(const i in e){const n=t.find(s=>{const r=s;return r.name===i||r.label===i});if(!n)continue;const o=n;o.value=e[i]}}onHeaderClick(){this.fixed||(this.collapsed=!this.collapsed)}render(){const e=this.label||this.icon||this.name||this.fixed,t=m`<svg
      xmlns="http://www.w3.org/2000/svg"
      height="1.125rem"
      viewBox="0 0 24 24"
      width="1.125rem"
  ...
  `;let $e=xr;li([g({type:String,reflect:!0})],$e.prototype,"name");li([g({type:String,reflect:!0})],$e.prototype,"icon");li([g({type:String,reflect:!0})],$e.prototype,"label");li([g({type:Boolean,reflect:!0})],$e.prototype,"vertical");li([fe()],$e.prototype,"_value");const bd=()=>m`
    <style>
      div {
        display: flex;
        gap: 0.375rem;
  ...
  `;let Sr=Er;_d([g({type:Array,attribute:!1})],Sr.prototype,"data");var $d=Object.defineProperty,wd=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&$d(t,i,o),o};const kr=class extends T{constructor(){super(...arguments),this.data={data:{}},this.childrenHidden=!0,this.table=this.closest("bim-table")}connectedCallback(){super.connectedCallback(),this.table&&this.table.expanded?this.childrenHidden=!1:this.childrenHidden=!0}toggleChildren(e,t=!1){this._children&&(this.childrenHidden=typeof e>"u"?!this.childrenHidden:!e,t&&this._children.toggleGroups(e,t))}render(){if(!this.table)throw new Error("TableGroup: parent table wasn't found!");const e=this.table.getGroupIndentation(this.data)??0,t=m`
  ...
  `;let Tr=kr;wd([g({type:Boolean,attribute:"children-hidden",reflect:!0})],Tr.prototype,"childrenHidden");var xd=Object.defineProperty,we=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&xd(t,i,o),o};const Or=class extends T{constructor(){super(...arguments),this.selected=!1,this.columns=[],this.hiddenColumns=[],this.data={},this.isHeader=!1,this.table=this.closest("bim-table"),this.onTableColumnsChange=()=>{this.table&&(this.columns=this.table.columns)},this.onTableColumnsHidden=()=>{this.table&&(this.hiddenColumns=this.table.hiddenColumns)},this._observer=new IntersectionObserver(e=>{this._intersecting=e[0].isIntersecting},{rootMargin:"36px"})}get _columnNames(){return this.columns.filter(e=>!this.hiddenColumns.includes(e.name)).map(e=>e.name)}get _columnWidths(){return this.columns.filter(e=>!this.hiddenColumns.includes(e.name)).map(e=>e.width)}get _isSelected(){var e;return(e=this.table)==null?void 0:e.selection.has(this.data)}onSelectionChange(e){if(!this.table)return;const t=e.target;this.selected=t.value,t.value?(this.table.selection.add(this.data),this.table.dispatchEvent(new CustomEvent("rowselected",{detail:{data:this.data}}))):(this.table.selection.delete(this.data),this.table.dispatchEvent(new CustomEvent("rowdeselected",{detail:{data:this.data}})))}connectedCallback(){super.connectedCallback(),this._observer.observe(this),this.table&&(this.columns=this.table.columns,this.hiddenColumns=this.table.hiddenColumns,this.table.addEventListener("columnschange",this.onTableColumnsChange),this.table.addEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",this._isSelected))}disconnectedCallback(){super.disconnectedCallback(),this._observer.unobserve(this),this.table&&(this.columns=[],this.hiddenColumns=[],this.table.removeEventListener("columnschange",this.onTableColumnsChange),this.table.removeEventListener("columnshidden",this.onTableColumnsHidden),this.toggleAttribute("selected",!1))}compute(){if(!this.table)throw new Error("TableRow: parent table wasn't found!");const e=this.table.getRowIndentation(this.data)??0,t=this.isHeader?this.data:this.table.applyDataTransform(this.data)??this.data,i=[];for(const n in t){if(this.hiddenColumns.includes(n))continue;const o=t[n];let s;if(typeof o=="string"||typeof o=="boolean"||typeof o=="number"?(s=document.createElement("bim-label"),s.textContent=String(o)):o instanceof HTMLElement?s=o:(s=document.createDocumentFragment(),ce(o,s)),!s)continue;const r=document.createElement("bim-table-cell");r.append(s),r.column=n,this._columnNames.indexOf(n)===0&&(r.style.marginLeft=`${this.table.noIndentation?0:e+.75}rem`);const l=this._columnNames.indexOf(n);r.setAttribute("data-column-index",String(l)),r.toggleAttribute("data-no-indentation",l===0&&this.table.noIndentation),r.toggleAttribute("data-cell-header",this.isHeader),r.rowData=this.data,this.table.dispatchEvent(new CustomEvent("cellcreated",{detail:{cell:r}})),i.push(r)}return this.style.gridTemplateAreas=`"${this.table.selectableRows?"Selection":""} ${this._columnNames.join(" ")}"`,this.style.gridTemplateColumns=`${this.table.selectableRows?"1.6rem":""} ${this._columnWidths.join(" ")}`,m`
 ...
 */const Vo=e=>e??R;var Od=Object.defineProperty,Id=Object.getOwnPropertyDescriptor,yt=(e,t,i,n)=>{for(var o=n>1?void 0:n?Id(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Od(t,i,o),o};const Mr=class extends T{constructor(){super(...arguments),this._inputTypes=["date","datetime-local","email","month","password","search","tel","text","time","url","week","area"],this.value="",this.vertical=!1,this._type="text",this.onValueChange=new Event("input")}set type(e){this._inputTypes.includes(e)&&(this._type=e)}get type(){return this._type}get query(){return Cn(this.value)}onInputChange(e){e.stopPropagation();const t=e.target;clearTimeout(this._debounceTimeoutID),this._debounceTimeoutID=setTimeout(()=>{this.value=t.value,this.dispatchEvent(this.onValueChange)},this.debounce)}focus(){setTimeout(()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()})}render(){return m`
  ...
  `;let Ce=jr;Qi([g({type:String,reflect:!0})],Ce.prototype,"label",2);Qi([g({type:String,reflect:!0})],Ce.prototype,"icon",2);Qi([g({type:Boolean,reflect:!0})],Ce.prototype,"vertical",1);Qi([g({type:Boolean,attribute:"label-hidden",reflect:!0})],Ce.prototype,"labelHidden",1);var Ld=Object.defineProperty,jd=Object.getOwnPropertyDescriptor,qn=(e,t,i,n)=>{for(var o=n>1?void 0:n?jd(t,i):t,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=(n?r(t,i,o):r(o))||o);return n&&o&&Ld(t,i,o),o};const zr=class extends T{constructor(){super(...arguments),this.labelsHidden=!1,this._vertical=!1,this._hidden=!1}set vertical(e){this._vertical=e,this.updateSections()}get vertical(){return this._vertical}set hidden(e){this._hidden=e,this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}updateSections(){const e=this.children;for(const t of e)t instanceof Ce&&(t.labelHidden=this.vertical&&!Q.config.sectionLabelOnVerticalToolbar,t.vertical=this.vertical)}render(){return m`
      <div class="parent">
 ...
 */const Hr="important",Fd=" !"+Hr,Ft=Ds(class extends Fs{constructor(e){var t;if(super(e),e.type!==zs.ATTRIBUTE||e.name!=="style"||((t=e.strings)==null?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const n=e[i];return n==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(const n of this.ft)t[n]==null&&(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(const n in t){const o=t[n];if(o!=null){this.ft.add(n);const s=typeof o=="string"&&o.endsWith(Fd);n.includes("-")||s?i.setProperty(n,s?o.slice(0,-11):o,s?Hr:""):i[n]=o}}return Vt}}),Hd=e=>{const{components:t}=e,i=t.get(rs);return m`
    ...
    ></bim-button>
  `},Bd=e=>U.create(Hd,e),Ud=Object.freeze(Object.defineProperty({__proto__:null,loadIfc:Bd},Symbol.toStringTag,{value:"Module"}));({...Ud});const Vd=e=>{const{components:t,actions:i,tags:n}=e,o=(i==null?void 0:i.dispose)??!0,s=(i==null?void 0:i.download)??!0,r=(i==null?void 0:i.visibility)??!0,l=(n==null?void 0:n.schema)??!0,a=(n==null?void 0:n.viewDefinition)??!0,d=t.get(qt),u=({detail:c})=>{const{cell:h}=c;h.style.padding="0.25rem 0"};return m`
    <bim-table ${q(c=>{if(!c)return;const h=c;h.hiddenColumns=["modelID"];const p=[];for(const[,f]of d.groups){if(!f)continue;const $={data:{Name:f.name||f.uuid,modelID:f.uuid}};p.push($)}h.dataTransform={Name:(f,$)=>{const{modelID:v}=$;if(typeof v!="string")return f;const b=d.groups.get(v);if(!b)return v;const y={};for(const S of b.items)y[S.id]=S.ids;let _;const{schema:w}=b.ifcMetadata;l&&w&&(_=m`
          ...
          `}let C;o&&(C=m`<bim-button @click=${()=>d.disposeGroup(b)} icon="mdi:delete"></bim-button>`);let O;r&&(O=m`<bim-button @click=${S=>{const E=t.get(as),H=S.target;E.set(H.hasAttribute("data-model-hidden"),y),H.toggleAttribute("data-model-hidden"),H.icon=H.hasAttribute("data-model-hidden")?"mdi:eye-off":"mdi:eye"}} icon="mdi:eye"></bim-button>`);let P;return s&&(P=m`<bim-button @click=${()=>{const S=document.createElement("input");S.type="file",S.accept=".ifc",S.multiple=!1,S.addEventListener("change",async()=>{if(!(S.files&&S.files.length===1))return;const E=S.files[0],H=await E.arrayBuffer(),G=await t.get(va).saveToIfc(b,new Uint8Array(H)),W=new File([G],E.name),x=document.createElement("a");x.href=URL.createObjectURL(W),x.download=W.name,x.click(),URL.revokeObjectURL(x.href)}),S.click()}} icon="flowbite:download-solid"></bim-button>`),m`
  ...
  `},pu=e=>U.create(hu,e),mu=Object.freeze(Object.defineProperty({__proto__:null,elementProperties:pu},Symbol.toStringTag,{value:"Module"})),Sn=async(e,t,i,n)=>{var o;const s=[],r=e.get(mt),l=await t.getProperties(i);if(!l)return s;const{type:a}=l,d={data:{Entity:wi[a],Name:(o=l.Name)==null?void 0:o.value,modelID:t.uuid,expressID:i}};for(const u of n){const c=r.getEntityRelations(t,i,u);if(!c)continue;d.children||(d.children=[]),d.data.relations=JSON.stringify(c);const h={};for(const p of c){const f=await Sn(e,t,p,n);for(const $ of f)if($.data.relations)d.children.push($);else{const v=t.data.get(p);if(!v){d.children.push($);continue}const b=v[1][1],y=wi[b];y in h||(h[y]=[]),$.data.Entity=$.data.Name,delete $.data.Name,h[y].push($)}}for(const p in h){const f=h[p],$=f.map(b=>b.data.expressID),v={data:{Entity:p,modelID:t.uuid,relations:JSON.stringify($)},children:f};d.children.push(v)}}return s.push(d),s},bu=async(e,t,i,n)=>{const o=e.get(mt),s=[];for(const r of t){let l;if(n)l={data:{Entity:r.name!==""?r.name:r.uuid},children:await Sn(e,r,n,i)};else{const a=o.relationMaps[r.uuid],d=await r.getAllPropertiesOfType(Ea);if(!(a&&d))continue;const{expressID:u}=Object.values(d)[0];l={data:{Entity:r.name!==""?r.name:r.uuid},children:await Sn(e,r,u,i)}}s.push(l)}return s};let bt;const fu=(e,t)=>{const i=e.get(qt),{modelID:n,expressID:o,relations:s}=t;if(!n)return null;const r=i.groups.get(n);return r?r.getFragmentMap([o,...JSON.parse(s??"[]")]):null},gu=e=>{const{components:t,models:i,expressID:n}=e,o=e.selectHighlighterName??"select",s=e.hoverHighlighterName??"hover";bt||(bt=document.createElement("bim-table"),bt.hiddenColumns=["modelID","expressID","relations"],bt.columns=["Entity","Name"],bt.headersHidden=!0,bt.addEventListener("cellcreated",({detail:l})=>{const{cell:a}=l;a.column==="Entity"&&!("Name"in a.rowData)&&(a.style.gridColumn="1 / -1")})),bt.addEventListener("rowcreated",l=>{l.stopImmediatePropagation();const{row:a}=l.detail,d=t.get(_a),u=fu(t,a.data);u&&Object.keys(u).length!==0&&(a.onmouseover=()=>{s&&(a.style.backgroundColor="var(--bim-ui_bg-contrast-20)",d.highlightByID(s,u,!0,!1,d.selection[o]??{}))},a.onmouseout=()=>{a.style.backgroundColor="",d.clear(s)},a.onclick=()=>{o&&d.highlightByID(o,u,!0,!0)})});const r=e.inverseAttributes??["IsDecomposedBy","ContainsElements"];return bu(t,i,r,n).then(l=>bt.data=l),m`${bt}`},vu=(e,t=!0)=>{const i=U.create(gu,e);if(t){const[,n]=i,{components:o}=e,s=o.get(qt),r=o.get(mt),l=()=>n({models:s.groups.values()});r.onRelationsIndexed.add(l),s.onFragmentsDisposed.add(l)}return i},yu=Object.freeze(Object.defineProperty({__proto__:null,relationsTree:vu},Symbol.toStringTag,{value:"Module"})),Oe=(e,t)=>[...e.get(In).list.values()].find(i=>i.world===t),_u=(e,t)=>m`
  ...
  `},wu=(e,t)=>{const{color:i,opacity:n}=JSON.parse(t),{postproduction:o}=e,{customEffects:s}=o;return m`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ni=globalThis,Pi=Ni.trustedTypes,Wo=Pi?Pi.createPolicy("lit-html",{createHTML:e=>e}):void 0,qr="$lit$",Ct=`lit$${Math.random().toFixed(9).slice(2)}$`,Gr="?"+Ct,Ou=`<${Gr}>`,Wt=document,qe=()=>Wt.createComment(""),Ge=e=>e===null||typeof e!="object"&&typeof e!="function",Gn=Array.isArray,Iu=e=>Gn(e)||typeof(e==null?void 0:e[Symbol.iterator])=="function",dn=`[ 	
\f\r]`,Ie=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qo=/-->/g,Go=/>/g,Lt=RegExp(`>|${dn}(?:([^\\s"'>=/]+)(${dn}*=${dn}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Yo=/'/g,Xo=/"/g,Yr=/^(?:script|style|textarea|title)$/i,Nu=e=>(t,...i)=>({_$litType$:e,strings:t,values:i}),Yn=Nu(1),he=Symbol.for("lit-noChange"),j=Symbol.for("lit-nothing"),Jo=new WeakMap,zt=Wt.createTreeWalker(Wt,129);function Xr(e,t){if(!Gn(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Wo!==void 0?Wo.createHTML(t):t}const Pu=(e,t)=>{const i=e.length-1,n=[];let o,s=t===2?"<svg>":t===3?"<math>":"",r=Ie;for(let l=0;l<i;l++){const a=e[l];let d,u,c=-1,h=0;for(;h<a.length&&(r.lastIndex=h,u=r.exec(a),u!==null);)h=r.lastIndex,r===Ie?u[1]==="!--"?r=qo:u[1]!==void 0?r=Go:u[2]!==void 0?(Yr.test(u[2])&&(o=RegExp("</"+u[2],"g")),r=Lt):u[3]!==void 0&&(r=Lt):r===Lt?u[0]===">"?(r=o??Ie,c=-1):u[1]===void 0?c=-2:(c=r.lastIndex-u[2].length,d=u[1],r=u[3]===void 0?Lt:u[3]==='"'?Xo:Yo):r===Xo||r===Yo?r=Lt:r===qo||r===Go?r=Ie:(r=Lt,o=void 0);const p=r===Lt&&e[l+1].startsWith("/>")?" ":"";s+=r===Ie?a+Ou:c>=0?(n.push(d),a.slice(0,c)+qr+a.slice(c)+Ct+p):a+Ct+(c===-2?l:p)}return[Xr(e,s+(e[i]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),n]};class Ye{constructor({strings:t,_$litType$:i},n){let o;this.parts=[];let s=0,r=0;const l=t.length-1,a=this.parts,[d,u]=Pu(t,i);if(this.el=Ye.createElement(d,n),zt.currentNode=this.el.content,i===2||i===3){const c=this.el.content.firstChild;c.replaceWith(...c.childNodes)}for(;(o=zt.nextNode())!==null&&a.length<l;){if(o.nodeType===1){if(o.hasAttributes())for(const c of o.getAttributeNames())if(c.endsWith(qr)){const h=u[r++],p=o.getAttribute(c).split(Ct),f=/([.?@])?(.*)/.exec(h);a.push({type:1,index:s,name:f[2],strings:p,ctor:f[1]==="."?Ru:f[1]==="?"?Lu:f[1]==="@"?ju:Ki}),o.removeAttribute(c)}else c.startsWith(Ct)&&(a.push({type:6,index:s}),o.removeAttribute(c));if(Yr.test(o.tagName)){const c=o.textContent.split(Ct),h=c.length-1;if(h>0){o.textContent=Pi?Pi.emptyScript:"";for(let p=0;p<h;p++)o.append(c[p],qe()),zt.nextNode(),a.push({type:2,index:++s});o.append(c[h],qe())}}}else if(o.nodeType===8)if(o.data===Gr)a.push({type:2,index:s});else{let c=-1;for(;(c=o.data.indexOf(Ct,c+1))!==-1;)a.push({type:7,index:s}),c+=Ct.length-1}s++}}static createElement(t,i){const n=Wt.createElement("template");return n.innerHTML=t,n}}function pe(e,t,i=e,n){var o,s;if(t===he)return t;let r=n!==void 0?(o=i._$Co)==null?void 0:o[n]:i._$Cl;const l=Ge(t)?void 0:t._$litDirective$;return(r==null?void 0:r.constructor)!==l&&((s=r==null?void 0:r._$AO)==null||s.call(r,!1),l===void 0?r=void 0:(r=new l(e),r._$AT(e,i,n)),n!==void 0?(i._$Co??(i._$Co=[]))[n]=r:i._$Cl=r),r!==void 0&&(t=pe(e,r._$AS(e,t.values),r,n)),t}class Mu{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:n}=this._$AD,o=((t==null?void 0:t.creationScope)??Wt).importNode(i,!0);zt.currentNode=o;let s=zt.nextNode(),r=0,l=0,a=n[0];for(;a!==void 0;){if(r===a.index){let d;a.type===2?d=new ci(s,s.nextSibling,this,t):a.type===1?d=new a.ctor(s,a.name,a.strings,this,t):a.type===6&&(d=new zu(s,this,t)),this._$AV.push(d),a=n[++l]}r!==(a==null?void 0:a.index)&&(s=zt.nextNode(),r++)}return zt.currentNode=Wt,o}p(t){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(t,n,i),i+=n.strings.length-2):n._$AI(t[i])),i++}}class ci{get _$AU(){var t;return((t=this._$AM)==null?void 0:t._$AU)??this._$Cv}constructor(t,i,n,o){this.type=2,this._$AH=j,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=n,this.options=o,this._$Cv=(o==null?void 0:o.isConnected)??!0}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(t==null?void 0:t.nodeType)===11&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=pe(this,t,i),Ge(t)?t===j||t==null||t===""?(this._$AH!==j&&this._$AR(),this._$AH=j):t!==this._$AH&&t!==he&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Iu(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==j&&Ge(this._$AH)?this._$AA.nextSibling.data=t:this.T(Wt.createTextNode(t)),this._$AH=t}$(t){var i;const{values:n,_$litType$:o}=t,s=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Ye.createElement(Xr(o.h,o.h[0]),this.options)),o);if(((i=this._$AH)==null?void 0:i._$AD)===s)this._$AH.p(n);else{const r=new Mu(s,this),l=r.u(this.options);r.p(n),this.T(l),this._$AH=r}}_$AC(t){let i=Jo.get(t.strings);return i===void 0&&Jo.set(t.strings,i=new Ye(t)),i}k(t){Gn(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,o=0;for(const s of t)o===i.length?i.push(n=new ci(this.O(qe()),this.O(qe()),this,this.options)):n=i[o],n._$AI(s),o++;o<i.length&&(this._$AR(n&&n._$AB.nextSibling,o),i.length=o)}_$AR(t=this._$AA.nextSibling,i){var n;for((n=this._$AP)==null?void 0:n.call(this,!1,!0,i);t&&t!==this._$AB;){const o=t.nextSibling;t.remove(),t=o}}setConnected(t){var i;this._$AM===void 0&&(this._$Cv=t,(i=this._$AP)==null||i.call(this,t))}}class Ki{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,n,o,s){this.type=1,this._$AH=j,this._$AN=void 0,this.element=t,this.name=i,this._$AM=o,this.options=s,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=j}_$AI(t,i=this,n,o){const s=this.strings;let r=!1;if(s===void 0)t=pe(this,t,i,0),r=!Ge(t)||t!==this._$AH&&t!==he,r&&(this._$AH=t);else{const l=t;let a,d;for(t=s[0],a=0;a<s.length-1;a++)d=pe(this,l[n+a],i,a),d===he&&(d=this._$AH[a]),r||(r=!Ge(d)||d!==this._$AH[a]),d===j?t=j:t!==j&&(t+=(d??"")+s[a+1]),this._$AH[a]=d}r&&!o&&this.j(t)}j(t){t===j?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ru extends Ki{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===j?void 0:t}}class Lu extends Ki{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==j)}}class ju extends Ki{constructor(t,i,n,o,s){super(t,i,n,o,s),this.type=5}_$AI(t,i=this){if((t=pe(this,t,i,0)??j)===he)return;const n=this._$AH,o=t===j&&n!==j||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,s=t!==j&&(n===j||o);o&&this.element.removeEventListener(this.name,this,n),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,t):this._$AH.handleEvent(t)}}class zu{constructor(t,i,n){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(t){pe(this,t)}}const Qo=Ni.litHtmlPolyfillSupport;Qo==null||Qo(Ye,ci),(Ni.litHtmlVersions??(Ni.litHtmlVersions=[])).push("3.2.1");const Du=(e,t,i)=>{const n=(i==null?void 0:i.renderBefore)??t;let o=n._$litPart$;if(o===void 0){const s=(i==null?void 0:i.renderBefore)??null;n._$litPart$=o=new ci(t.insertBefore(qe(),s),s,void 0,i??{})}return o._$AI(e),o};/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */const kn=()=>new Yu;let Yu=class{};const un=new WeakMap,Xu=Bu(class extends Gu{render(e){return j}update(e,[t]){var i;const n=t!==this.Y;return n&&this.Y!==void 0&&this.rt(void 0),(n||this.lt!==this.ct)&&(this.Y=t,this.ht=(i=e.options)==null?void 0:i.host,this.rt(this.ct=e.element)),j}rt(e){if(this.isConnected||(e=void 0),typeof this.Y=="function"){const t=this.ht??globalThis;let i=un.get(t);i===void 0&&(i=new WeakMap,un.set(t,i)),i.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),i.set(this.Y,e),e!==void 0&&this.Y.call(this.ht,e)}else this.Y.value=e}get lt(){var e,t;return typeof this.Y=="function"?(e=un.get(this.ht??globalThis))==null?void 0:e.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),Ju={dueDate:e=>{if(typeof e=="string"&&e.trim()!=="")return new Date(e)},status:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},type:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},priority:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},stage:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},assignedTo:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},labels:e=>{if(Array.isArray(e))return new Set(e)}},Qr=e=>{const{components:t,topic:i,value:n,onCancel:o,onSubmit:s,styles:r}=e,l=s??(()=>{}),a=t.get(Je),d=(n==null?void 0:n.title)??(i==null?void 0:i.title)??_t.default.title,u=(n==null?void 0:n.status)??(i==null?void 0:i.status)??_t.default.status,c=(n==null?void 0:n.type)??(i==null?void 0:i.type)??_t.default.type,h=(n==null?void 0:n.priority)??(i==null?void 0:i.priority)??_t.default.priority,p=(n==null?void 0:n.assignedTo)??(i==null?void 0:i.assignedTo)??_t.default.assignedTo,f=(n==null?void 0:n.labels)??(i==null?void 0:i.labels)??_t.default.labels,$=(n==null?void 0:n.stage)??(i==null?void 0:i.stage)??_t.default.stage,v=(n==null?void 0:n.description)??(i==null?void 0:i.description)??_t.default.description,b=i!=null&&i.dueDate?i.dueDate.toISOString().split("T")[0]:null,y=new Set([...a.config.statuses]);u&&y.add(u);const _=new Set([...a.config.types]);c&&_.add(c);const w=new Set([...a.config.priorities]);h&&w.add(h);const A=new Set([...a.config.users]);p&&A.add(p);const C=new Set([...a.config.labels]);if(f)for(const x of f)C.add(x);const O=new Set([...a.config.stages]);$&&O.add($);const P=kn(),S=async()=>{const{value:x}=P;if(!x)return;const L=We(x,Ju);if(i)i.set(L),await l(i);else{const V=a.create(L);await l(V)}},E=kn(),H=x=>{const{value:L}=E;if(!L)return;const V=x.target;L.disabled=V.value.trim()===""},G=`btn-${Q.newRandomId()}`,W=`btn-${Q.newRandomId()}`;return m`
    <div ${q(P)} style="display: flex; flex-direction: column; gap: 0.75rem;">
      ...
      <div style="justify-content: right; display: flex; gap: 0.375rem">
        ...
        <bim-button id=${G} style="flex: 0" @click=${S} ${q(E)} label=${i?"Update Topic":"Add Topic"} icon=${i?"tabler:refresh":"mi:add"}></bim-button>
      </div>
    </div>
  `},Qu=e=>{const{components:t,dataStyles:i,onTopicEnter:n}=e,o=t.get(Je),s=e.topics??o.list.values();return m`
    <bim-table no-indentation ${q(r=>{if(!r)return;const l=r;l.hiddenColumns.length===0&&(l.hiddenColumns=["Guid"]),l.columns=["Title"],l.dataTransform={Title:(a,d)=>{const{Guid:u}=d;if(typeof u!="string")return a;const c=o.list.get(u);if(!c)return a;const h=`btn-${Q.newRandomId()}`;return m`
  ...
  `},Zr=(e,t=!0)=>{const i=U.create(Qu,e);if(t){const{components:n,topics:o}=e,[,s]=i,r=n.get(Je);if(r.list.onItemUpdated.add(()=>s()),r.list.onItemDeleted.add(()=>s()),o)for(const l of o)l.relatedTopics.onItemAdded.add(()=>s()),l.relatedTopics.onItemDeleted.add(()=>s()),l.relatedTopics.onCleared.add(()=>s());else r.list.onItemSet.add(()=>s())}return i},Zu=Object.freeze(Object.defineProperty({__proto__:null,topicsList:Zr},Symbol.toStringTag,{value:"Module"})),Ku=e=>{const{topic:t,styles:i,viewpoint:n}=e,o={delete:!0,...e.actions};return m`
    <bim-table no-indentation ${q(s=>{if(!s)return;const r=s;r.headersHidden=!0,r.hiddenColumns=["guid","author"],r.dataTransform={Comment:(a,d)=>{const{guid:u}=d;if(typeof u!="string")return a;const c=t.comments.get(u);if(!c)return a;const h=()=>{t.comments.delete(u)},p=`btn-${Q.newRandomId()}`;return m`
  ...
  `},ch=e=>U.create(lh,e),dh=Object.freeze(Object.defineProperty({__proto__:null,topicInformation:ch},Symbol.toStringTag,{value:"Module"})),uh=(e,t)=>{const{showInput:i,topic:n,styles:o}=e,s={add:!0,delete:!0,...e.actions},r=`input-${Q.newRandomId()}`,l=`btn-${Q.newRandomId()}`,a=`btn-${Q.newRandomId()}`,d=()=>document.getElementById(l),u=()=>document.getElementById(r),c=()=>{const _=u();return _?_.value.trim().length>0:!1},h=()=>{t({showInput:!0})},p=()=>{const _=u(),w=c();_&&w&&(n.createComment(_.value),t({showInput:!1}))},f=()=>{t({showInput:!1})},$=()=>{const _=d();if(_){if(!u()){_.disabled=!0;return}_.disabled=!c()}},v=m`
 ...
 */function Ih(e){return Y({...e,state:!0,attribute:!1})}class Nh extends Ca{constructor(t=document.createElement("div")){super(),this.isCSS2DObject=!0,this.element=t,this.element.style.position="absolute",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.center=new Aa(.5,.5),this.addEventListener("removed",function(){this.traverse(function(i){i.element instanceof Element&&i.element.parentNode!==null&&i.element.parentNode.removeChild(i.element)})})}copy(t,i){return super.copy(t,i),this.element=t.element.cloneNode(!0),this.center=t.center,this}}new Tn;new zi;new zi;new Tn;new Tn;class Ph{constructor(t,i){this._group=new io,this._frustum=new ma,this._frustumMat=new zi,this._regenerateDelay=200,this._regenerateCounter=0,this.material=new ba({color:"#2e3338"}),this.numbers=new io,this.maxRegenerateRetrys=4,this.gridsFactor=5,this._scaleX=1,this._scaleY=1,this._offsetX=0,this._offsetY=0,this._camera=t,this._container=i;const n=this.newGrid(-1),o=this.newGrid(-2);this.grids={main:n,secondary:o},this._group.add(o,n,this.numbers)}set scaleX(t){this._scaleX=t,this.regenerate()}get scaleX(){return this._scaleX}set scaleY(t){this._scaleY=t,this.regenerate()}get scaleY(){return this._scaleY}set offsetX(t){this._offsetX=t,this.regenerate()}get offsetX(){return this._offsetX}set offsetY(t){this._offsetY=t,this.regenerate()}get offsetY(){return this._offsetY}get(){return this._group}dispose(){const{main:t,secondary:i}=this.grids;t.removeFromParent(),i.removeFromParent(),t.geometry.dispose(),t.material.dispose(),i.geometry.dispose(),i.material.dispose()}regenerate(){if(!this.isGridReady()){if(this._regenerateCounter++,this._regenerateCounter>this.maxRegenerateRetrys)throw new Error("Grid could not be regenerated");setTimeout(()=>this.regenerate,this._regenerateDelay);return}this._regenerateCounter=0,this._camera.updateMatrix(),this._camera.updateMatrixWorld();const t=this._frustumMat.multiplyMatrices(this._camera.projectionMatrix,this._camera.matrixWorldInverse);this._frustum.setFromProjectionMatrix(t);const{planes:i}=this._frustum,n=i[0].constant*-i[0].normal.x,o=i[1].constant*-i[1].normal.x,s=i[2].constant*-i[2].normal.y,r=i[3].constant*-i[3].normal.y,l=Math.abs(n-o),a=Math.abs(r-s),{clientWidth:d,clientHeight:u}=this._container,c=Math.max(d,u),h=Math.max(l,a)/c,p=Math.ceil(Math.log10(l/this.scaleX)),f=Math.ceil(Math.log10(a/this.scaleY)),$=10**(p-2)*this.scaleX,v=10**(f-2)*this.scaleY,b=$*this.gridsFactor,y=v*this.gridsFactor,_=Math.ceil(a/y),w=Math.ceil(l/b),A=Math.ceil(a/v),C=Math.ceil(l/$),O=$*Math.ceil(o/$),P=v*Math.ceil(s/v),S=b*Math.ceil(o/b),E=y*Math.ceil(s/y),H=[...this.numbers.children];for(const B of H)B.removeFromParent();this.numbers.children=[];const G=[],W=9*h,x=1e4,L=S+this._offsetX,V=Math.round(Math.abs(L/this.scaleX)*x)/x,K=(w-1)*b,tt=Math.round(Math.abs((L+K)/this.scaleX)*x)/x,dt=Math.max(V,tt).toString().length*W;let Ae=Math.ceil(dt/b)*b;for(let B=0;B<w;B++){let z=S+B*b;G.push(z,r,0,z,s,0),z=Math.round(z*x)/x,Ae=Math.round(Ae*x)/x;const Ee=z%Ae;if(!(b<1||y<1)&&Math.abs(Ee)>.01)continue;const hi=this.newNumber((z+this._offsetX)/this.scaleX),nn=12*h;hi.position.set(z,s+nn,0)}for(let B=0;B<_;B++){const z=E+B*y;G.push(o,z,0,n,z,0);const Ee=this.newNumber(z/this.scaleY);let hi=12;Ee.element.textContent&&(hi+=4*Ee.element.textContent.length);const nn=hi*h;Ee.position.set(o+nn,z,0)}const en=[];for(let B=0;B<C;B++){const z=O+B*$;en.push(z,r,0,z,s,0)}for(let B=0;B<A;B++){const z=P+B*v;en.push(o,z,0,n,z,0)}const ca=new no(new Float32Array(G),3),da=new no(new Float32Array(en),3),{main:ua,secondary:ha}=this.grids;ua.geometry.setAttribute("position",ca),ha.geometry.setAttribute("position",da)}newNumber(t){const i=document.createElement("bim-label");i.textContent=String(Math.round(t*100)/100);const n=new Nh(i);return this.numbers.add(n),n}newGrid(t){const i=new fa,n=new ga(i,this.material);return n.frustumCulled=!1,n.renderOrder=t,n}isGridReady(){const t=this._camera.projectionMatrix.elements;for(let i=0;i<t.length;i++){const n=t[i];if(Number.isNaN(n))return!1}return!0}}var Mh=Object.defineProperty,Rh=Object.getOwnPropertyDescriptor,di=(e,t,i,n)=>{for(var o=Rh(t,i),s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&Mh(t,i,o),o};const ia=class extends Ht{constructor(){super(...arguments),this._grid=null,this._world=null,this.resize=()=>{this._world&&this._grid&&this._grid.regenerate()}}set gridColor(t){if(this._gridColor=t,!(t&&this._grid))return;const i=Number(t.replace("#","0x"));Number.isNaN(i)||this._grid.material.color.setHex(i)}get gridColor(){return this._gridColor}set gridScaleX(t){this._gridScaleX=t,t&&this._grid&&(this._grid.scaleX=t)}get gridScaleX(){return this._gridScaleX}set gridScaleY(t){this._gridScaleY=t,t&&this._grid&&(this._grid.scaleY=t)}get gridScaleY(){return this._gridScaleY}get gridOffsetX(){var t;return((t=this._grid)==null?void 0:t.offsetX)||0}set gridOffsetX(t){this._grid&&(this._grid.offsetX=t)}get gridOffsetY(){var t;return((t=this._grid)==null?void 0:t.offsetY)||0}set gridOffsetY(t){this._grid&&(this._grid.offsetY=t)}set components(t){this.dispose();const i=t.get(Xe).create();this._world=i,i.scene=new On(t),i.scene.setup(),i.renderer=new pa(t,this);const n=new ss(t);i.camera=n;const o=new Ph(n.threeOrtho,this);this._grid=o,i.scene.three.add(o.get()),n.controls.addEventListener("update",()=>o.regenerate()),setTimeout(async()=>{i.camera.updateAspect(),n.set("Plan"),await n.controls.setLookAt(0,0,100,0,0,0),await n.projection.set("Orthographic"),n.controls.dollySpeed=3,n.controls.draggingSmoothTime=.085,n.controls.maxZoom=1e3,n.controls.zoom(4)})}get world(){return this._world}dispose(){var t;(t=this.world)==null||t.dispose(),this._world=null,this._grid=null}connectedCallback(){super.connectedCallback(),new ResizeObserver(this.resize).observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.dispose()}render(){return Yn`<slot></slot>`}};ia.styles=Qn`
  ...
  `;let ui=ia;di([Y({type:String,attribute:"grid-color",reflect:!0})],ui.prototype,"gridColor");di([Y({type:Number,attribute:"grid-scale-x",reflect:!0})],ui.prototype,"gridScaleX");di([Y({type:Number,attribute:"grid-scale-y",reflect:!0})],ui.prototype,"gridScaleY");di([Y({type:Number,attribute:"grid-offset-x",reflect:!0})],ui.prototype,"gridOffsetX");di([Y({type:Number,attribute:"grid-offset-y",reflect:!0})],ui.prototype,"gridOffsetY");var Lh=Object.defineProperty,Nt=(e,t,i,n)=>{for(var o=void 0,s=e.length-1,r;s>=0;s--)(r=e[s])&&(o=r(t,i,o)||o);return o&&Lh(t,i,o),o};const na=class extends Ht{constructor(){super(...arguments),this._defaults={size:60},this._cssMatrix3D="",this._matrix=new zi,this._onRightClick=new Event("rightclick"),this._onLeftClick=new Event("leftclick"),this._onTopClick=new Event("topclick"),this._onBottomClick=new Event("bottomclick"),this._onFrontClick=new Event("frontclick"),this._onBackClick=new Event("backclick"),this._camera=null,this._epsilon=t=>Math.abs(t)<1e-10?0:t}set camera(t){this._camera=t,this.updateOrientation()}get camera(){return this._camera}updateOrientation(){if(!this.camera)return;this._matrix.extractRotation(this.camera.matrixWorldInverse);const{elements:t}=this._matrix;this._cssMatrix3D=`matrix3d(
      ${this._epsilon(t[0])},
      ${this._epsilon(-t[1])},
      ${this._epsilon(t[2])},
      ${this._epsilon(t[3])},
