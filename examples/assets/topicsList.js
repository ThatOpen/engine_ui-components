import"./lit-html-BUQgm8fs.js";import{B as U,T as C,u as S,J as X,f as o,z as be,V as I,N as z,c as Z,d as ee,C as ue,W as fe,S as ye,a as ge,b as $e,G as we,F as ve,I as he}from"./index-DAd_Xb3m.js";import"./index-CG13lMFw.js";import{c as Te,d as D,a as M,b as V,t as ke,v as xe,e as Se}from"./index-BnaeDa9G.js";import{e as Y}from"./ref-CLKbrLVk.js";const Ie={dueDate:e=>{if(typeof e=="string"&&e.trim()!=="")return new Date(e)},status:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},type:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},priority:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},stage:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},assignedTo:e=>{if(Array.isArray(e)&&e.length!==0)return e[0]},labels:e=>{if(Array.isArray(e))return new Set(e)}},te=e=>{const{components:l,topic:t,value:i,onCancel:n,onSubmit:s,styles:r}=e,m=s??(()=>{}),d=l.get(U),v=(i==null?void 0:i.title)??(t==null?void 0:t.title)??C.default.title,p=(i==null?void 0:i.status)??(t==null?void 0:t.status)??C.default.status,b=(i==null?void 0:i.type)??(t==null?void 0:t.type)??C.default.type,a=(i==null?void 0:i.priority)??(t==null?void 0:t.priority)??C.default.priority,y=(i==null?void 0:i.assignedTo)??(t==null?void 0:t.assignedTo)??C.default.assignedTo,u=(i==null?void 0:i.labels)??(t==null?void 0:t.labels)??C.default.labels,g=(i==null?void 0:i.stage)??(t==null?void 0:t.stage)??C.default.stage,k=(i==null?void 0:i.description)??(t==null?void 0:t.description)??C.default.description,$=t!=null&&t.dueDate?t.dueDate.toISOString().split("T")[0]:null,f=new Set([...d.config.statuses]);p&&f.add(p);const h=new Set([...d.config.types]);b&&h.add(b);const w=new Set([...d.config.priorities]);a&&w.add(a);const j=new Set([...d.config.users]);y&&j.add(y);const N=new Set([...d.config.labels]);if(u)for(const c of u)N.add(c);const G=new Set([...d.config.stages]);g&&G.add(g);const J=Y(),me=async()=>{const{value:c}=J;if(!c)return;const x=be(c,Ie);if(t)t.set(x),await m(t);else{const B=d.create(x);await m(B)}},H=Y(),de=c=>{const{value:x}=H;if(!x)return;const B=c.target;x.disabled=B.value.trim()===""},Q=`btn-${S.newRandomId()}`,O=`btn-${S.newRandomId()}`;return o`
    <div ${X(J)} style="display: flex; flex-direction: column; gap: 0.75rem;">
      ...
      <div style="display: flex; gap: 0.375rem">
        <bim-dropdown vertical label="Labels" name="labels" multiple>
          ${[...N].map(c=>o`<bim-option label=${c} .checked=${u?[...u].includes(c):!1}></bim-option>`)}
        </bim-dropdown>
  ...
  `},Ae=e=>I.create(ne,e),Ce=Object.freeze(Object.defineProperty({__proto__:null,topicComments:Ae,topicCommentsSectionTemplate:ne},Symbol.toStringTag,{value:"Module"})),ie=(e,l)=>{const{components:t,editing:i,topic:n,styles:s}=e,r={update:!0,...e.actions},m=(s==null?void 0:s.priorities)??D.priorities,d=(s==null?void 0:s.statuses)??D.statuses,v=(s==null?void 0:s.types)??D.types;let p;n!=null&&n.priority&&(p=m[n.priority]);let b;n!=null&&n.type&&(b=v[n.type]);let a;n!=null&&n.type&&(a=d[n.status]);let y,u;return i?y=te({components:t,topic:n,styles:s,onSubmit:()=>{l({editing:!1})},onCancel:()=>{l({editing:!1})}}):u=o`
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-label .icon=${a==null?void 0:a.icon} style=${z({...V,...a==null?void 0:a.style})}
        >${n.status}
        </bim-label>
      </div>
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        <bim-label .icon=${b==null?void 0:b.icon} style=${z({...V,...b==null?void 0:b.style})}
        >${n.type}
        </bim-label>
      </div>
      ...
      ${n.priority?o`
            <div style="display: flex; gap: 0.375rem">
              ...
              <bim-label .icon=${p==null?void 0:p.icon} style=${z({...V,...p==null?void 0:p.style})}
              >${n.priority}
              </bim-label>
            </div>`:null}
      ...
      <div style="display: flex; gap: 0.375rem">
        ...
        ${M(n.creationAuthor,(s==null?void 0:s.users)??D.users)}
      </div>

      ${n.assignedTo?o`
          <div style="display: flex; gap: 0.375rem">
            <bim-label>Assignee</bim-label>
            ${M(n.assignedTo,(s==null?void 0:s.users)??D.users)}
          </div>`:null}
      ...
      ${n.modifiedAuthor?o`
          <div style="display: flex; gap: 0.375rem">
            ...
            ${M(n.modifiedAuthor,(s==null?void 0:s.users)??D.users)}
          </div>`:null}
  ...
  `},De=e=>I.create(ie,e),_e=Object.freeze(Object.defineProperty({__proto__:null,topicInformation:De,topicInformationSectionTemplate:ie},Symbol.toStringTag,{value:"Module"})),oe=(e,l)=>{const{components:t,topic:i,linking:n}=e,s=t.get(U),r={link:!0,...e.actions},[m,d]=ke({components:t,topics:[...i.relatedTopics].map(a=>s.list.get(a)).map(a=>a)});m.headersHidden=!0,m.hiddenColumns=["Guid","Status","Description","Author","Assignee","Date","DueDate","Type","Priority"];const v=()=>o`
  ...
  `),K=document.createElement("bim-grid");K.layouts={main:{template:`
    ...
    /24rem 1fr
    `,elements:{bcfPanel:Qe,viewport:q,customTopicPanel:Je}}};K.layout="main";document.body.append(K);
