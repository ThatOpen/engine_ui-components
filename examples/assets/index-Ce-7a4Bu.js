...
`,vt={scrollbar:Mr,globalStyles:Dr};var Fr=Object.defineProperty,Nr=Object.getOwnPropertyDescriptor,Hr=(i,t,e,s)=>{for(var n=Nr(t,e),r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Fr(t,e,n),n};const ri=class ri extends E{constructor(){super(...arguments),this._visible=!1,this._middleware={name:"middleware",async fn(t){const{right:e,top:s}=await Qe(t);return t.x-=Math.sign(e)===1?e+5:0,t.y-=Math.sign(s)===1?s+5:0,t}}}get visible(){return this._visible}set visible(t){this._visible=t,t&&this.updatePosition()}async updatePosition(t){const e=t||this.parentNode;if(!e){this.visible=!1,console.warn("No target element found for context-menu.");return}const s=await gn(e,this,{placement:"right",middleware:[sn(10),bn(),mn(),pn({padding:5}),this._middleware]}),{x:n,y:r}=s;this.style.left=`${n}px`,this.style.top=`${r}px`}render(){return m` <slot></slot> `}};ri.styles=[vt.scrollbar,C`
  ...
  `;let A=oi;dt([h({type:String,reflect:!0})],A.prototype,"img",2);dt([h({type:String,reflect:!0})],A.prototype,"label",2);dt([h({type:String,reflect:!0})],A.prototype,"icon",2);dt([h({type:Boolean,reflect:!0})],A.prototype,"checked",2);dt([h({type:Boolean,reflect:!0})],A.prototype,"checkbox",2);dt([h({type:Boolean,attribute:"no-mark",reflect:!0})],A.prototype,"noMark",2);dt([h({converter:{fromAttribute(i){return i&&Ce(i)}}})],A.prototype,"value",1);dt([h({type:Boolean,reflect:!0})],A.prototype,"vertical",2);var Qr=Object.defineProperty,Yr=Object.getOwnPropertyDescriptor,ft=(i,t,e,s)=>{for(var n=s>1?void 0:s?Yr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Qr(t,e,n),n};const li=class li extends Vr{constructor(){super(),this.multiple=!1,this.required=!1,this.vertical=!1,this._visible=!1,this._value=new Set,this.onValueChange=new Event("change"),this.onWindowMouseUp=t=>{this.visible&&(this.contains(t.target)||(this.visible=!1))},this.onOptionClick=t=>{const e=t.target,s=this._value.has(e);if(!this.multiple&&!this.required&&!s)this._value=new Set([e]);else if(!this.multiple&&!this.required&&s)this._value=new Set([]);else if(!this.multiple&&this.required&&!s)this._value=new Set([e]);else if(this.multiple&&!this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&!this.required&&s){const n=[...this._value].filter(r=>r!==e);this._value=new Set(n)}else if(this.multiple&&this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&this.required&&s){const n=[...this._value].filter(o=>o!==e),r=new Set(n);r.size!==0&&(this._value=r)}this.updateOptionsState(),this.dispatchEvent(this.onValueChange)},this.useObserver=!0}set visible(t){this._visible=t,t||this.resetVisibleElements()}get visible(){return this._visible}set value(t){if(this.required&&Object.keys(t).length===0)return;const e=new Set;for(const s of t){const n=this.findOption(s);if(n&&(e.add(n),!this.multiple&&Object.keys(t).length===1))break}this._value=e,this.updateOptionsState(),this.dispatchEvent(this.onValueChange)}get value(){return[...this._value].filter(e=>e instanceof A&&e.checked).map(e=>e.value)}get _options(){const t=new Set([...this.elements]);for(const e of this.children)e instanceof A&&t.add(e);return[...t]}onSlotChange(t){const e=t.target.assignedElements();this.observe(e);const s=new Set;for(const n of this.elements){if(!(n instanceof A)){n.remove();continue}n.checked&&s.add(n),n.removeEventListener("click",this.onOptionClick),n.addEventListener("click",this.onOptionClick)}this._value=s}updateOptionsState(){for(const t of this._options)t instanceof A&&(t.checked=this._value.has(t))}findOption(t){return this._options.find(s=>s instanceof A?s.label===t||s.value===t:!1)}connectedCallback(){super.connectedCallback(),window.addEventListener("mouseup",this.onWindowMouseUp)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mouseup",this.onWindowMouseUp)}render(){let t,e,s;if(this._value.size===0)t="Select an option...";else if(this._value.size===1){const n=[...this._value][0];t=(n==null?void 0:n.label)||(n==null?void 0:n.value),e=n==null?void 0:n.img,s=n==null?void 0:n.icon}else t=`Multiple (${this._value.size})`;return m`
    ...
    `];let M=li;ft([h({type:String,reflect:!0})],M.prototype,"name",2);ft([h({type:String,reflect:!0})],M.prototype,"icon",2);ft([h({type:String,reflect:!0})],M.prototype,"label",2);ft([h({type:Boolean,reflect:!0})],M.prototype,"multiple",2);ft([h({type:Boolean,reflect:!0})],M.prototype,"required",2);ft([h({type:Boolean,reflect:!0})],M.prototype,"vertical",2);ft([h({type:Boolean,reflect:!0})],M.prototype,"visible",1);ft([Wt()],M.prototype,"_value",2);var Gr=Object.defineProperty,Nn=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Gr(t,e,n),n};const ai=class ai extends E{constructor(){super(...arguments),this.floating=!1,this.layouts={}}getUniqueAreasFromTemplate(t){const n=t.split(`
`).map(o=>o.trim()).map(o=>o.split('"')[1]).filter(o=>o!==void 0).flatMap(o=>o.split(/\s+/));return[...new Set(n)].filter(o=>o!=="")}firstUpdated(){this._onLayoutChange=new Event("layoutchange")}render(){if(this.layout){if(this.layouts[this.layout]){this.innerHTML="";const t=this.layouts[this.layout],s=this.getUniqueAreasFromTemplate(t.template).map(n=>{const r=t.elements[n];return r&&(r.style.gridArea=n),r}).filter(n=>!!n);this.style.gridTemplate=t.template,this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange),this.append(...s)}}else this.innerHTML="",this.style.gridTemplate="",this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange);return m`<slot></slot>`}};ai.styles=C`
  ...
  `;let gt=ci;$e([h({type:String,reflect:!0})],gt.prototype,"name");$e([h({type:String,reflect:!0})],gt.prototype,"label");$e([h({type:String,reflect:!0})],gt.prototype,"icon");$e([h({type:Boolean,reflect:!0})],gt.prototype,"vertical");var Jr=Object.defineProperty,Jt=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Jr(t,e,n),n};const ui=class ui extends E{constructor(){super(...arguments),this.labelHidden=!1,this.iconHidden=!1,this.vertical=!1}get value(){return this.textContent?Ce(this.textContent):this.textContent}render(){return m`
  ...
  `;let at=pi;te([h({type:String,reflect:!0})],at.prototype,"name");te([h({type:String,reflect:!0})],at.prototype,"icon");te([h({type:String,reflect:!0})],at.prototype,"label");te([h({type:Boolean,reflect:!0})],at.prototype,"vertical");te([Wt()],at.prototype,"_value");var so=Object.defineProperty,ro=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&so(t,e,n),n};const mi=class mi extends E{constructor(){super(...arguments),this.column="",this.columnIndex=0,this.rowData={}}get data(){return this.column?this.rowData[this.column]:null}render(){return m`
      <style>
        :host {
 ...
 */const vo=i=>i??Le;var yo=Object.defineProperty,_o=Object.getOwnPropertyDescriptor,pt=(i,t,e,s)=>{for(var n=s>1?void 0:s?_o(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&yo(t,e,n),n};const wi=class wi extends E{constructor(){super(...arguments),this._inputTypes=["date","datetime-local","email","month","password","search","tel","text","time","url","week"],this.value="",this.vertical=!1,this._type="text",this.onValueChange=new Event("input")}set type(t){this._inputTypes.includes(t)&&(this._type=t)}get type(){return this._type}get query(){return qe(this.value)}onInputChange(t){t.stopPropagation();const e=t.target;clearTimeout(this._debounceTimeoutID),this._debounceTimeoutID=setTimeout(()=>{this.value=e.value,this.dispatchEvent(this.onValueChange)},this.debounce)}focus(){setTimeout(()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()})}render(){return m`
  ...
  `;let be=Si;Oo([h({type:String,reflect:!0})],be.prototype,"name");export{Vr as C,Ue as M,Es as e,Ss as i,$t as n,$s as t};
