import{N as F,e as u,j as _,n as x,F as $,m as S,i as U,q as H,f as B,p as V}from"./index-DNriEO-H.js";import"./lit-html-CgQwCkHV.js";const M=(n,s)=>{const o=s[n],e=(o==null?void 0:o.name)??n,i=e.trim().split(/\s+/);let t,l;return i[0]&&i[0][0]&&(t=i[0][0].toUpperCase(),i[0][1]&&(l=i[0][1].toUpperCase())),i[1]&&i[1][0]&&(l=i[1][0].toUpperCase()),u`
  ...
  `},ae=(n,s)=>{const{components:o,topic:e}=n;s.noIndentation=!0,s.headersHidden=!0,s.hiddenColumns=["Guid"],s.columns=["Title",{name:"Actions",width:"auto"}];const i={selectComponents:!0,colorizeComponent:!0,resetColors:!0,updateCamera:!0,delete:!0,unlink:!!e,...n.actions},t=o.get(U);s.dataTransform={Actions:(l,c)=>{const{Guid:r}=c;if(!(r&&typeof r=="string"))return l;const a=t.list.get(r);if(!a)return l;const d=async({target:C})=>{C.loading=!0,await a.go(),C.loading=!1};let m;i.selectComponents&&(m=u`
        ...
        `);let w;i.delete&&(w=u`
          <bim-button label="Delete" @click=${()=>{t.list.delete(a.guid),H.removeMenus()}}></bim-button>
  ...
  `},ce=(n,s)=>{const{dataStyles:o}=n;s.hiddenColumns.length===0&&(s.hiddenColumns=["Guid","Actions"]),s.columns=["Title"],s.dataTransform={Priority:e=>{if(typeof e!="string")return e;const t=((o==null?void 0:o.priorities)??k.priorities)[e];return u`
            <bim-label
              ...
              style=${F({...N,...t==null?void 0:t.style})}
            >${e}
            </bim-label>
          ...
          `},Author:e=>typeof e!="string"?e:M(e,(o==null?void 0:o.users)??k.users),Assignee:e=>typeof e!="string"?e:M(e,(o==null?void 0:o.users)??k.users)}},de=(n,s=!0)=>{const o=S.create(P,n),[e,i]=o;if(ce(n,e),s){const{components:t,topics:l}=n,c=t.get(B),r=()=>i();if(c.list.onItemUpdated.add(r),c.list.onItemDeleted.add(r),l)for(const a of l)a.relatedTopics.onItemAdded.add(r),a.relatedTopics.onItemDeleted.add(r),a.relatedTopics.onCleared.add(r);else c.list.onItemSet.add(r)}return o},me=Object.freeze(Object.defineProperty({__proto__:null,topicsList:de,topicsListTemplate:P},Symbol.toStringTag,{value:"Module"})),G=n=>{const{topic:s,styles:o,viewpoint:e}=n,i=n.missingDataMessage??"The topic has no comments";return u`
