var Un=Object.defineProperty;var Qn=(i,t,e)=>t in i?Un(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var st=(i,t,e)=>(Qn(i,typeof t!="symbol"?t+"":t,e),e);import{D as Le,h as E,i as C,k as p,n as u,Q as Nt,r as Lt}from"./state-QpXUsnxS.js";const St=Math.min,Y=Math.max,oe=Math.round,rt=i=>({x:i,y:i}),Yn={left:"right",right:"left",bottom:"top",top:"bottom"},Gn={start:"end",end:"start"};function Si(i,t,e){return Y(i,St(t,e))}function Yt(i,t){return typeof i=="function"?i(t):i}function G(i){return i.split("-")[0]}function ve(i){return i.split("-")[1]}function Ji(i){return i==="x"?"y":"x"}function Zi(i){return i==="y"?"height":"width"}function _t(i){return["top","bottom"].includes(G(i))?"y":"x"}function tn(i){return Ji(_t(i))}function Xn(i,t,e){e===void 0&&(e=!1);const s=ve(i),n=tn(i),r=Zi(n);let o=n==="x"?s===(e?"end":"start")?"right":"left":s==="start"?"bottom":"top";return t.reference[r]>t.floating[r]&&(o=le(o)),[o,le(o)]}function Kn(i){const t=le(i);return[Ie(i),t,Ie(t)]}function Ie(i){return i.replace(/start|end/g,t=>Gn[t])}function Jn(i,t,e){const s=["left","right"],n=["right","left"],r=["top","bottom"],o=["bottom","top"];switch(i){case"top":case"bottom":return e?t?n:s:t?s:n;case"left":case"right":return t?r:o;default:return[]}}function Zn(i,t,e,s){const n=ve(i);let r=Jn(G(i),e==="start",s);return n&&(r=r.map(o=>o+"-"+n),t&&(r=r.concat(r.map(Ie)))),r}function le(i){return i.replace(/left|right|bottom|top/g,t=>Yn[t])}function ts(i){return{top:0,right:0,bottom:0,left:0,...i}}function en(i){return typeof i!="number"?ts(i):{top:i,right:i,bottom:i,left:i}}function kt(i){const{x:t,y:e,width:s,height:n}=i;return{width:s,height:n,top:e,left:t,right:t+s,bottom:e+n,x:t,y:e}}function ki(i,t,e){let{reference:s,floating:n}=i;const r=_t(t),o=tn(t),l=Zi(o),a=G(t),c=r==="y",d=s.x+s.width/2-n.width/2,h=s.y+s.height/2-n.height/2,f=s[l]/2-n[l]/2;let m;switch(a){case"top":m={x:d,y:s.y-n.height};break;case"bottom":m={x:d,y:s.y+s.height};break;case"right":m={x:s.x+s.width,y:h};break;case"left":m={x:s.x-n.width,y:h};break;default:m={x:s.x,y:s.y}}switch(ve(t)){case"start":m[o]-=f*(e&&c?-1:1);break;case"end":m[o]+=f*(e&&c?-1:1);break}return m}const es=async(i,t,e)=>{const{placement:s="bottom",strategy:n="absolute",middleware:r=[],platform:o}=e,l=r.filter(Boolean),a=await(o.isRTL==null?void 0:o.isRTL(t));let c=await o.getElementRects({reference:i,floating:t,strategy:n}),{x:d,y:h}=ki(c,s,a),f=s,m={},b=0;for(let v=0;v<l.length;v++){const{name:g,fn:S}=l[v],{x:$,y:x,data:w,reset:O}=await S({x:d,y:h,initialPlacement:s,placement:f,strategy:n,middlewareData:m,rects:c,platform:o,elements:{reference:i,floating:t}});d=$??d,h=x??h,m={...m,[g]:{...m[g],...w}},O&&b<=50&&(b++,typeof O=="object"&&(O.placement&&(f=O.placement),O.rects&&(c=O.rects===!0?await o.getElementRects({reference:i,floating:t,strategy:n}):O.rects),{x:d,y:h}=ki(c,f,a)),v=-1)}return{x:d,y:h,placement:f,strategy:n,middlewareData:m}};async function nn(i,t){var e;t===void 0&&(t={});const{x:s,y:n,platform:r,rects:o,elements:l,strategy:a}=i,{boundary:c="clippingAncestors",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:f=!1,padding:m=0}=Yt(t,i),b=en(m),g=l[f?h==="floating"?"reference":"floating":h],S=kt(await r.getClippingRect({element:(e=await(r.isElement==null?void 0:r.isElement(g)))==null||e?g:g.contextElement||await(r.getDocumentElement==null?void 0:r.getDocumentElement(l.floating)),boundary:c,rootBoundary:d,strategy:a})),$=h==="floating"?{x:s,y:n,width:o.floating.width,height:o.floating.height}:o.reference,x=await(r.getOffsetParent==null?void 0:r.getOffsetParent(l.floating)),w=await(r.isElement==null?void 0:r.isElement(x))?await(r.getScale==null?void 0:r.getScale(x))||{x:1,y:1}:{x:1,y:1},O=kt(r.convertOffsetParentRelativeRectToViewportRelativeRect?await r.convertOffsetParentRelativeRectToViewportRelativeRect({elements:l,rect:$,offsetParent:x,strategy:a}):$);return{top:(S.top-O.top+b.top)/w.y,bottom:(O.bottom-S.bottom+b.bottom)/w.y,left:(S.left-O.left+b.left)/w.x,right:(O.right-S.right+b.right)/w.x}}const is=function(i){return i===void 0&&(i={}),{name:"flip",options:i,async fn(t){var e,s;const{placement:n,middlewareData:r,rects:o,initialPlacement:l,platform:a,elements:c}=t,{mainAxis:d=!0,crossAxis:h=!0,fallbackPlacements:f,fallbackStrategy:m="bestFit",fallbackAxisSideDirection:b="none",flipAlignment:v=!0,...g}=Yt(i,t);if((e=r.arrow)!=null&&e.alignmentOffset)return{};const S=G(n),$=_t(l),x=G(l)===l,w=await(a.isRTL==null?void 0:a.isRTL(c.floating)),O=f||(x||!v?[le(l)]:Kn(l)),_=b!=="none";!f&&_&&O.push(...Zn(l,v,b,w));const T=[l,...O],D=await nn(t,g),F=[];let k=((s=r.flip)==null?void 0:s.overflows)||[];if(d&&F.push(D[S]),h){const q=Xn(n,o,w);F.push(D[q[0]],D[q[1]])}if(k=[...k,{placement:n,overflows:F}],!F.every(q=>q<=0)){var wt,jt;const q=(((wt=r.flip)==null?void 0:wt.index)||0)+1,$t=T[q];if($t)return{data:{index:q,overflows:k},reset:{placement:$t}};let et=(jt=k.filter(it=>it.overflows[0]<=0).sort((it,W)=>it.overflows[1]-W.overflows[1])[0])==null?void 0:jt.placement;if(!et)switch(m){case"bestFit":{var Ct;const it=(Ct=k.filter(W=>{if(_){const nt=_t(W.placement);return nt===$||nt==="y"}return!0}).map(W=>[W.placement,W.overflows.filter(nt=>nt>0).reduce((nt,Wn)=>nt+Wn,0)]).sort((W,nt)=>W[1]-nt[1])[0])==null?void 0:Ct[0];it&&(et=it);break}case"initialPlacement":et=l;break}if(n!==et)return{reset:{placement:et}}}return{}}}};function sn(i){const t=St(...i.map(r=>r.left)),e=St(...i.map(r=>r.top)),s=Y(...i.map(r=>r.right)),n=Y(...i.map(r=>r.bottom));return{x:t,y:e,width:s-t,height:n-e}}function ns(i){const t=i.slice().sort((n,r)=>n.y-r.y),e=[];let s=null;for(let n=0;n<t.length;n++){const r=t[n];!s||r.y-s.y>s.height/2?e.push([r]):e[e.length-1].push(r),s=r}return e.map(n=>kt(sn(n)))}const ss=function(i){return i===void 0&&(i={}),{name:"inline",options:i,async fn(t){const{placement:e,elements:s,rects:n,platform:r,strategy:o}=t,{padding:l=2,x:a,y:c}=Yt(i,t),d=Array.from(await(r.getClientRects==null?void 0:r.getClientRects(s.reference))||[]),h=ns(d),f=kt(sn(d)),m=en(l);function b(){if(h.length===2&&h[0].left>h[1].right&&a!=null&&c!=null)return h.find(g=>a>g.left-m.left&&a<g.right+m.right&&c>g.top-m.top&&c<g.bottom+m.bottom)||f;if(h.length>=2){if(_t(e)==="y"){const k=h[0],wt=h[h.length-1],jt=G(e)==="top",Ct=k.top,q=wt.bottom,$t=jt?k.left:wt.left,et=jt?k.right:wt.right,it=et-$t,W=q-Ct;return{top:Ct,bottom:q,left:$t,right:et,width:it,height:W,x:$t,y:Ct}}const g=G(e)==="left",S=Y(...h.map(k=>k.right)),$=St(...h.map(k=>k.left)),x=h.filter(k=>g?k.left===$:k.right===S),w=x[0].top,O=x[x.length-1].bottom,_=$,T=S,D=T-_,F=O-w;return{top:w,bottom:O,left:_,right:T,width:D,height:F,x:_,y:w}}return f}const v=await r.getElementRects({reference:{getBoundingClientRect:b},floating:s.floating,strategy:o});return n.reference.x!==v.reference.x||n.reference.y!==v.reference.y||n.reference.width!==v.reference.width||n.reference.height!==v.reference.height?{reset:{rects:v}}:{}}}};async function rs(i,t){const{placement:e,platform:s,elements:n}=i,r=await(s.isRTL==null?void 0:s.isRTL(n.floating)),o=G(e),l=ve(e),a=_t(e)==="y",c=["left","top"].includes(o)?-1:1,d=r&&a?-1:1,h=Yt(t,i);let{mainAxis:f,crossAxis:m,alignmentAxis:b}=typeof h=="number"?{mainAxis:h,crossAxis:0,alignmentAxis:null}:{mainAxis:0,crossAxis:0,alignmentAxis:null,...h};return l&&typeof b=="number"&&(m=l==="end"?b*-1:b),a?{x:m*d,y:f*c}:{x:f*c,y:m*d}}const rn=function(i){return{name:"offset",options:i,async fn(t){var e,s;const{x:n,y:r,placement:o,middlewareData:l}=t,a=await rs(t,i);return o===((e=l.offset)==null?void 0:e.placement)&&(s=l.arrow)!=null&&s.alignmentOffset?{}:{x:n+a.x,y:r+a.y,data:{...a,placement:o}}}}},os=function(i){return i===void 0&&(i={}),{name:"shift",options:i,async fn(t){const{x:e,y:s,placement:n}=t,{mainAxis:r=!0,crossAxis:o=!1,limiter:l={fn:g=>{let{x:S,y:$}=g;return{x:S,y:$}}},...a}=Yt(i,t),c={x:e,y:s},d=await nn(t,a),h=_t(G(n)),f=Ji(h);let m=c[f],b=c[h];if(r){const g=f==="y"?"top":"left",S=f==="y"?"bottom":"right",$=m+d[g],x=m-d[S];m=Si($,m,x)}if(o){const g=h==="y"?"top":"left",S=h==="y"?"bottom":"right",$=b+d[g],x=b-d[S];b=Si($,b,x)}const v=l.fn({...t,[f]:m,[h]:b});return{...v,data:{x:v.x-e,y:v.y-s}}}}};function ot(i){return on(i)?(i.nodeName||"").toLowerCase():"#document"}function z(i){var t;return(i==null||(t=i.ownerDocument)==null?void 0:t.defaultView)||window}function ft(i){var t;return(t=(on(i)?i.ownerDocument:i.document)||window.document)==null?void 0:t.documentElement}function on(i){return i instanceof Node||i instanceof z(i).Node}function U(i){return i instanceof Element||i instanceof z(i).Element}function Q(i){return i instanceof HTMLElement||i instanceof z(i).HTMLElement}function Oi(i){return typeof ShadowRoot>"u"?!1:i instanceof ShadowRoot||i instanceof z(i).ShadowRoot}function Gt(i){const{overflow:t,overflowX:e,overflowY:s,display:n}=B(i);return/auto|scroll|overlay|hidden|clip/.test(t+s+e)&&!["inline","contents"].includes(n)}function ls(i){return["table","td","th"].includes(ot(i))}function as(i){return[":popover-open",":modal"].some(t=>{try{return i.matches(t)}catch{return!1}})}function Qe(i){const t=Ye(),e=U(i)?B(i):i;return e.transform!=="none"||e.perspective!=="none"||(e.containerType?e.containerType!=="normal":!1)||!t&&(e.backdropFilter?e.backdropFilter!=="none":!1)||!t&&(e.filter?e.filter!=="none":!1)||["transform","perspective","filter"].some(s=>(e.willChange||"").includes(s))||["paint","layout","strict","content"].some(s=>(e.contain||"").includes(s))}function cs(i){let t=Ot(i);for(;Q(t)&&!ye(t);){if(Qe(t))return t;if(as(t))return null;t=Ot(t)}return null}function Ye(){return typeof CSS>"u"||!CSS.supports?!1:CSS.supports("-webkit-backdrop-filter","none")}function ye(i){return["html","body","#document"].includes(ot(i))}function B(i){return z(i).getComputedStyle(i)}function _e(i){return U(i)?{scrollLeft:i.scrollLeft,scrollTop:i.scrollTop}:{scrollLeft:i.scrollX,scrollTop:i.scrollY}}function Ot(i){if(ot(i)==="html")return i;const t=i.assignedSlot||i.parentNode||Oi(i)&&i.host||ft(i);return Oi(t)?t.host:t}function ln(i){const t=Ot(i);return ye(t)?i.ownerDocument?i.ownerDocument.body:i.body:Q(t)&&Gt(t)?t:ln(t)}function ze(i,t,e){var s;t===void 0&&(t=[]),e===void 0&&(e=!0);const n=ln(i),r=n===((s=i.ownerDocument)==null?void 0:s.body),o=z(n);if(r){const l=us(o);return t.concat(o,o.visualViewport||[],Gt(n)?n:[],l&&e?ze(l):[])}return t.concat(n,ze(n,[],e))}function us(i){return i.parent&&Object.getPrototypeOf(i.parent)?i.frameElement:null}function an(i){const t=B(i);let e=parseFloat(t.width)||0,s=parseFloat(t.height)||0;const n=Q(i),r=n?i.offsetWidth:e,o=n?i.offsetHeight:s,l=oe(e)!==r||oe(s)!==o;return l&&(e=r,s=o),{width:e,height:s,$:l}}function cn(i){return U(i)?i:i.contextElement}function Et(i){const t=cn(i);if(!Q(t))return rt(1);const e=t.getBoundingClientRect(),{width:s,height:n,$:r}=an(t);let o=(r?oe(e.width):e.width)/s,l=(r?oe(e.height):e.height)/n;return(!o||!Number.isFinite(o))&&(o=1),(!l||!Number.isFinite(l))&&(l=1),{x:o,y:l}}const ds=rt(0);function un(i){const t=z(i);return!Ye()||!t.visualViewport?ds:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function hs(i,t,e){return t===void 0&&(t=!1),!e||t&&e!==z(i)?!1:t}function Ht(i,t,e,s){t===void 0&&(t=!1),e===void 0&&(e=!1);const n=i.getBoundingClientRect(),r=cn(i);let o=rt(1);t&&(s?U(s)&&(o=Et(s)):o=Et(i));const l=hs(r,e,s)?un(r):rt(0);let a=(n.left+l.x)/o.x,c=(n.top+l.y)/o.y,d=n.width/o.x,h=n.height/o.y;if(r){const f=z(r),m=s&&U(s)?z(s):s;let b=f,v=b.frameElement;for(;v&&s&&m!==b;){const g=Et(v),S=v.getBoundingClientRect(),$=B(v),x=S.left+(v.clientLeft+parseFloat($.paddingLeft))*g.x,w=S.top+(v.clientTop+parseFloat($.paddingTop))*g.y;a*=g.x,c*=g.y,d*=g.x,h*=g.y,a+=x,c+=w,b=z(v),v=b.frameElement}}return kt({width:d,height:h,x:a,y:c})}const fs=[":popover-open",":modal"];function dn(i){return fs.some(t=>{try{return i.matches(t)}catch{return!1}})}function ps(i){let{elements:t,rect:e,offsetParent:s,strategy:n}=i;const r=n==="fixed",o=ft(s),l=t?dn(t.floating):!1;if(s===o||l&&r)return e;let a={scrollLeft:0,scrollTop:0},c=rt(1);const d=rt(0),h=Q(s);if((h||!h&&!r)&&((ot(s)!=="body"||Gt(o))&&(a=_e(s)),Q(s))){const f=Ht(s);c=Et(s),d.x=f.x+s.clientLeft,d.y=f.y+s.clientTop}return{width:e.width*c.x,height:e.height*c.y,x:e.x*c.x-a.scrollLeft*c.x+d.x,y:e.y*c.y-a.scrollTop*c.y+d.y}}function ms(i){return Array.from(i.getClientRects())}function hn(i){return Ht(ft(i)).left+_e(i).scrollLeft}function bs(i){const t=ft(i),e=_e(i),s=i.ownerDocument.body,n=Y(t.scrollWidth,t.clientWidth,s.scrollWidth,s.clientWidth),r=Y(t.scrollHeight,t.clientHeight,s.scrollHeight,s.clientHeight);let o=-e.scrollLeft+hn(i);const l=-e.scrollTop;return B(s).direction==="rtl"&&(o+=Y(t.clientWidth,s.clientWidth)-n),{width:n,height:r,x:o,y:l}}function gs(i,t){const e=z(i),s=ft(i),n=e.visualViewport;let r=s.clientWidth,o=s.clientHeight,l=0,a=0;if(n){r=n.width,o=n.height;const c=Ye();(!c||c&&t==="fixed")&&(l=n.offsetLeft,a=n.offsetTop)}return{width:r,height:o,x:l,y:a}}function vs(i,t){const e=Ht(i,!0,t==="fixed"),s=e.top+i.clientTop,n=e.left+i.clientLeft,r=Q(i)?Et(i):rt(1),o=i.clientWidth*r.x,l=i.clientHeight*r.y,a=n*r.x,c=s*r.y;return{width:o,height:l,x:a,y:c}}function Ai(i,t,e){let s;if(t==="viewport")s=gs(i,e);else if(t==="document")s=bs(ft(i));else if(U(t))s=vs(t,e);else{const n=un(i);s={...t,x:t.x-n.x,y:t.y-n.y}}return kt(s)}function fn(i,t){const e=Ot(i);return e===t||!U(e)||ye(e)?!1:B(e).position==="fixed"||fn(e,t)}function ys(i,t){const e=t.get(i);if(e)return e;let s=ze(i,[],!1).filter(l=>U(l)&&ot(l)!=="body"),n=null;const r=B(i).position==="fixed";let o=r?Ot(i):i;for(;U(o)&&!ye(o);){const l=B(o),a=Qe(o);!a&&l.position==="fixed"&&(n=null),(r?!a&&!n:!a&&l.position==="static"&&!!n&&["absolute","fixed"].includes(n.position)||Gt(o)&&!a&&fn(i,o))?s=s.filter(d=>d!==o):n=l,o=Ot(o)}return t.set(i,s),s}function _s(i){let{element:t,boundary:e,rootBoundary:s,strategy:n}=i;const o=[...e==="clippingAncestors"?ys(t,this._c):[].concat(e),s],l=o[0],a=o.reduce((c,d)=>{const h=Ai(t,d,n);return c.top=Y(h.top,c.top),c.right=St(h.right,c.right),c.bottom=St(h.bottom,c.bottom),c.left=Y(h.left,c.left),c},Ai(t,l,n));return{width:a.right-a.left,height:a.bottom-a.top,x:a.left,y:a.top}}function xs(i){const{width:t,height:e}=an(i);return{width:t,height:e}}function ws(i,t,e){const s=Q(t),n=ft(t),r=e==="fixed",o=Ht(i,!0,r,t);let l={scrollLeft:0,scrollTop:0};const a=rt(0);if(s||!s&&!r)if((ot(t)!=="body"||Gt(n))&&(l=_e(t)),s){const h=Ht(t,!0,r,t);a.x=h.x+t.clientLeft,a.y=h.y+t.clientTop}else n&&(a.x=hn(n));const c=o.left+l.scrollLeft-a.x,d=o.top+l.scrollTop-a.y;return{x:c,y:d,width:o.width,height:o.height}}function Ti(i,t){return!Q(i)||B(i).position==="fixed"?null:t?t(i):i.offsetParent}function pn(i,t){const e=z(i);if(!Q(i)||dn(i))return e;let s=Ti(i,t);for(;s&&ls(s)&&B(s).position==="static";)s=Ti(s,t);return s&&(ot(s)==="html"||ot(s)==="body"&&B(s).position==="static"&&!Qe(s))?e:s||cs(i)||e}const Cs=async function(i){const t=this.getOffsetParent||pn,e=this.getDimensions;return{reference:ws(i.reference,await t(i.floating),i.strategy),floating:{x:0,y:0,...await e(i.floating)}}};function $s(i){return B(i).direction==="rtl"}const Es={convertOffsetParentRelativeRectToViewportRelativeRect:ps,getDocumentElement:ft,getClippingRect:_s,getOffsetParent:pn,getElementRects:Cs,getClientRects:ms,getDimensions:xs,getScale:Et,isElement:U,isRTL:$s},mn=os,bn=is,gn=ss,vn=(i,t,e)=>{const s=new Map,n={platform:Es,...e},r={...n.platform,_c:s};return es(i,t,{...n,platform:r})};/**
 * @license
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mt=(i,t)=>{var s;const e=i._$AN;if(e===void 0)return!1;for(const n of e)(s=n._$AO)==null||s.call(n,t,!1),Mt(n,t);return!0},ae=i=>{let t,e;do{if((t=i._$AM)===void 0)break;e=t._$AN,e.delete(i),i=t}while((e==null?void 0:e.size)===0)},yn=i=>{for(let t;t=i._$AM;i=t){let e=t._$AN;if(e===void 0)t._$AN=e=new Set;else if(e.has(i))break;e.add(i),Ls(t)}};function Ts(i){this._$AN!==void 0?(ae(this),this._$AM=i,yn(this)):this._$AM=i}function Ps(i,t=!1,e=0){const s=this._$AH,n=this._$AN;if(n!==void 0&&n.size!==0)if(t)if(Array.isArray(s))for(let r=e;r<s.length;r++)Mt(s[r],!1),ae(s[r]);else s!=null&&(Mt(s,!1),ae(s));else Mt(this,i)}const Ls=i=>{i.type==ks.CHILD&&(i._$AP??(i._$AP=Ps),i._$AQ??(i._$AQ=Ts))};class Is extends As{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,e,s){super._$AT(t,e,s),yn(this),this.isConnected=t._$AU}_$AO(t,e=!0){var s,n;t!==this.isConnected&&(this.isConnected=t,t?(s=this.reconnected)==null||s.call(this):(n=this.disconnected)==null||n.call(this)),e&&(Mt(this,t),ae(this))}setValue(t){if(Ss(this.t))this.t._$AI(t,this);else{const e=[...this.t._$AH];e[this.i]=t,this.t._$AI(e,this,0)}}disconnected(){}reconnected(){}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const gt=()=>new zs;class zs{}const ke=new WeakMap,vt=Os(class extends Is{render(i){return Le}update(i,[t]){var s;const e=t!==this.Y;return e&&this.Y!==void 0&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.Y=t,this.ht=(s=i.options)==null?void 0:s.host,this.rt(this.ct=i.element)),Le}rt(i){if(this.isConnected||(i=void 0),typeof this.Y=="function"){const t=this.ht??globalThis;let e=ke.get(t);e===void 0&&(e=new WeakMap,ke.set(t,e)),e.get(this.Y)!==void 0&&this.Y.call(this.ht,void 0),e.set(this.Y,i),i!==void 0&&this.Y.call(this.ht,i)}else this.Y.value=i}get lt(){var i,t;return typeof this.Y=="function"?(i=ke.get(this.ht??globalThis))==null?void 0:i.get(this.Y):(t=this.Y)==null?void 0:t.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});/**
* (c) Iconify
*
...
* @license MIT
* @version 2.0.0
*/const _n=Object.freeze({left:0,top:0,width:16,height:16}),ce=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),Xt=Object.freeze({..._n,...ce}),Be=Object.freeze({...Xt,body:"",hidden:!1}),Bs=Object.freeze({width:null,height:null}),xn=Object.freeze({...Bs,...ce});function js(i,t=0){const e=i.replace(/^-?[0-9.]*/,"");function s(n){for(;n<0;)n+=4;return n%4}if(e===""){const n=parseInt(i);return isNaN(n)?0:s(n)}else if(e!==i){let n=0;switch(e){case"%":n=25;break;case"deg":n=90}if(n){let r=parseFloat(i.slice(0,i.length-e.length));return isNaN(r)?0:(r=r/n,r%1===0?s(r):0)}}return t}const Rs=/[\s,]+/;function Ms(i,t){t.split(Rs).forEach(e=>{switch(e.trim()){case"horizontal":i.hFlip=!0;break;case"vertical":i.vFlip=!0;break}})}const wn={...xn,preserveAspectRatio:""};function Pi(i){const t={...wn},e=(s,n)=>i.getAttribute(s)||n;return t.width=e("width",null),t.height=e("height",null),t.rotate=js(e("rotate","")),Ms(t,e("flip","")),t.preserveAspectRatio=e("preserveAspectRatio",e("preserveaspectratio","")),t}function Ds(i,t){for(const e in wn)if(i[e]!==t[e])return!0;return!1}const Dt=/^[a-z0-9]+(-[a-z0-9]+)*$/,Kt=(i,t,e,s="")=>{const n=i.split(":");if(i.slice(0,1)==="@"){if(n.length<2||n.length>3)return null;s=n.shift().slice(1)}if(n.length>3||!n.length)return null;if(n.length>1){const l=n.pop(),a=n.pop(),c={provider:n.length>0?n[0]:s,prefix:a,name:l};return t&&!se(c)?null:c}const r=n[0],o=r.split("-");if(o.length>1){const l={provider:s,prefix:o.shift(),name:o.join("-")};return t&&!se(l)?null:l}if(e&&s===""){const l={provider:s,prefix:"",name:r};return t&&!se(l,e)?null:l}return null},se=(i,t)=>i?!!((i.provider===""||i.provider.match(Dt))&&(t&&i.prefix===""||i.prefix.match(Dt))&&i.name.match(Dt)):!1;function Fs(i,t){const e={};!i.hFlip!=!t.hFlip&&(e.hFlip=!0),!i.vFlip!=!t.vFlip&&(e.vFlip=!0);const s=((i.rotate||0)+(t.rotate||0))%4;return s&&(e.rotate=s),e}function Li(i,t){const e=Fs(i,t);for(const s in Be)s in ce?s in i&&!(s in e)&&(e[s]=ce[s]):s in t?e[s]=t[s]:s in i&&(e[s]=i[s]);return e}function Ns(i,t){const e=i.icons,s=i.aliases||Object.create(null),n=Object.create(null);function r(o){if(e[o])return n[o]=[];if(!(o in n)){n[o]=null;const l=s[o]&&s[o].parent,a=l&&r(l);a&&(n[o]=[l].concat(a))}return n[o]}return Object.keys(e).concat(Object.keys(s)).forEach(r),n}function Hs(i,t,e){const s=i.icons,n=i.aliases||Object.create(null);let r={};function o(l){r=Li(s[l]||n[l],r)}return o(t),e.forEach(o),Li(i,r)}function Cn(i,t){const e=[];if(typeof i!="object"||typeof i.icons!="object")return e;i.not_found instanceof Array&&i.not_found.forEach(n=>{t(n,null),e.push(n)});const s=Ns(i);for(const n in s){const r=s[n];r&&(t(n,Hs(i,n,r)),e.push(n))}return e}const Vs={provider:"",aliases:{},not_found:{},..._n};function Oe(i,t){for(const e in t)if(e in i&&typeof i[e]!=typeof t[e])return!1;return!0}function $n(i){if(typeof i!="object"||i===null)return null;const t=i;if(typeof t.prefix!="string"||!i.icons||typeof i.icons!="object"||!Oe(i,Vs))return null;const e=t.icons;for(const n in e){const r=e[n];if(!n.match(Dt)||typeof r.body!="string"||!Oe(r,Be))return null}const s=t.aliases||Object.create(null);for(const n in s){const r=s[n],o=r.parent;if(!n.match(Dt)||typeof o!="string"||!e[o]&&!s[o]||!Oe(r,Be))return null}return t}const ue=Object.create(null);function qs(i,t){return{provider:i,prefix:t,icons:Object.create(null),missing:new Set}}function lt(i,t){const e=ue[i]||(ue[i]=Object.create(null));return e[t]||(e[t]=qs(i,t))}function Ge(i,t){return $n(t)?Cn(t,(e,s)=>{s?i.icons[e]=s:i.missing.add(e)}):[]}function Ws(i,t,e){try{if(typeof e.body=="string")return i.icons[t]={...e},!0}catch{}return!1}function Us(i,t){let e=[];return(typeof i=="string"?[i]:Object.keys(ue)).forEach(n=>{(typeof n=="string"&&typeof t=="string"?[t]:Object.keys(ue[n]||{})).forEach(o=>{const l=lt(n,o);e=e.concat(Object.keys(l.icons).map(a=>(n!==""?"@"+n+":":"")+o+":"+a))})}),e}let Vt=!1;function En(i){return typeof i=="boolean"&&(Vt=i),Vt}function qt(i){const t=typeof i=="string"?Kt(i,!0,Vt):i;if(t){const e=lt(t.provider,t.prefix),s=t.name;return e.icons[s]||(e.missing.has(s)?null:void 0)}}function Sn(i,t){const e=Kt(i,!0,Vt);if(!e)return!1;const s=lt(e.provider,e.prefix);return Ws(s,e.name,t)}function Ii(i,t){if(typeof i!="object")return!1;if(typeof t!="string"&&(t=i.provider||""),Vt&&!t&&!i.prefix){let n=!1;return $n(i)&&(i.prefix="",Cn(i,(r,o)=>{o&&Sn(r,o)&&(n=!0)})),n}const e=i.prefix;if(!se({provider:t,prefix:e,name:"a"}))return!1;const s=lt(t,e);return!!Ge(s,i)}function zi(i){return!!qt(i)}function Qs(i){const t=qt(i);return t?{...Xt,...t}:null}function Ys(i){const t={loaded:[],missing:[],pending:[]},e=Object.create(null);i.sort((n,r)=>n.provider!==r.provider?n.provider.localeCompare(r.provider):n.prefix!==r.prefix?n.prefix.localeCompare(r.prefix):n.name.localeCompare(r.name));let s={provider:"",prefix:"",name:""};return i.forEach(n=>{if(s.name===n.name&&s.prefix===n.prefix&&s.provider===n.provider)return;s=n;const r=n.provider,o=n.prefix,l=n.name,a=e[r]||(e[r]=Object.create(null)),c=a[o]||(a[o]=lt(r,o));let d;l in c.icons?d=t.loaded:o===""||c.missing.has(l)?d=t.missing:d=t.pending;const h={provider:r,prefix:o,name:l};d.push(h)}),t}function kn(i,t){i.forEach(e=>{const s=e.loaderCallbacks;s&&(e.loaderCallbacks=s.filter(n=>n.id!==t))})}function Gs(i){i.pendingCallbacksFlag||(i.pendingCallbacksFlag=!0,setTimeout(()=>{i.pendingCallbacksFlag=!1;const t=i.loaderCallbacks?i.loaderCallbacks.slice(0):[];if(!t.length)return;let e=!1;const s=i.provider,n=i.prefix;t.forEach(r=>{const o=r.icons,l=o.pending.length;o.pending=o.pending.filter(a=>{if(a.prefix!==n)return!0;const c=a.name;if(i.icons[c])o.loaded.push({provider:s,prefix:n,name:c});else if(i.missing.has(c))o.missing.push({provider:s,prefix:n,name:c});else return e=!0,!0;return!1}),o.pending.length!==l&&(e||kn([i],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let Xs=0;function Ks(i,t,e){const s=Xs++,n=kn.bind(null,e,s);if(!t.pending.length)return n;const r={id:s,icons:t,callback:i,abort:n};return e.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),n}const je=Object.create(null);function Bi(i,t){je[i]=t}function Re(i){return je[i]||je[""]}function Js(i,t=!0,e=!1){const s=[];return i.forEach(n=>{const r=typeof n=="string"?Kt(n,t,e):n;r&&s.push(r)}),s}var Zs={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function tr(i,t,e,s){const n=i.resources.length,r=i.random?Math.floor(Math.random()*n):i.index;let o;if(i.random){let _=i.resources.slice(0);for(o=[];_.length>1;){const T=Math.floor(Math.random()*_.length);o.push(_[T]),_=_.slice(0,T).concat(_.slice(T+1))}o=o.concat(_)}else o=i.resources.slice(r).concat(i.resources.slice(0,r));const l=Date.now();let a="pending",c=0,d,h=null,f=[],m=[];typeof s=="function"&&m.push(s);function b(){h&&(clearTimeout(h),h=null)}function v(){a==="pending"&&(a="aborted"),b(),f.forEach(_=>{_.status==="pending"&&(_.status="aborted")}),f=[]}function g(_,T){T&&(m=[]),typeof _=="function"&&m.push(_)}function S(){return{startTime:l,payload:t,status:a,queriesSent:c,queriesPending:f.length,subscribe:g,abort:v}}function $(){a="failed",m.forEach(_=>{_(void 0,d)})}function x(){f.forEach(_=>{_.status==="pending"&&(_.status="aborted")}),f=[]}function w(_,T,D){const F=T!=="success";switch(f=f.filter(k=>k!==_),a){case"pending":break;case"failed":if(F||!i.dataAfterTimeout)return;break;default:return}if(T==="abort"){d=D,$();return}if(F){d=D,f.length||(o.length?O():$());return}if(b(),x(),!i.random){const k=i.resources.indexOf(_.resource);k!==-1&&k!==i.index&&(i.index=k)}a="completed",m.forEach(k=>{k(D)})}function O(){if(a!=="pending")return;b();const _=o.shift();if(_===void 0){if(f.length){h=setTimeout(()=>{b(),a==="pending"&&(x(),$())},i.timeout);return}$();return}const T={status:"pending",resource:_,callback:(D,F)=>{w(T,D,F)}};f.push(T),c++,h=setTimeout(O,i.rotate),e(_,t,T.callback)}return setTimeout(O),S}function On(i){const t={...Zs,...i};let e=[];function s(){e=e.filter(l=>l().status==="pending")}function n(l,a,c){const d=tr(t,l,a,(h,f)=>{s(),c&&c(h,f)});return e.push(d),d}function r(l){return e.find(a=>l(a))||null}return{query:n,find:r,setIndex:l=>{t.index=l},getIndex:()=>t.index,cleanup:s}}function Xe(i){let t;if(typeof i.resources=="string")t=[i.resources];else if(t=i.resources,!(t instanceof Array)||!t.length)return null;return{resources:t,path:i.path||"/",maxURL:i.maxURL||500,rotate:i.rotate||750,timeout:i.timeout||5e3,random:i.random===!0,index:i.index||0,dataAfterTimeout:i.dataAfterTimeout!==!1}}const xe=Object.create(null),Rt=["https://api.simplesvg.com","https://api.unisvg.com"],re=[];for(;Rt.length>0;)Rt.length===1||Math.random()>.5?re.push(Rt.shift()):re.push(Rt.pop());xe[""]=Xe({resources:["https://api.iconify.design"].concat(re)});function ji(i,t){const e=Xe(t);return e===null?!1:(xe[i]=e,!0)}function we(i){return xe[i]}function er(){return Object.keys(xe)}function Ri(){}const Ae=Object.create(null);function ir(i){if(!Ae[i]){const t=we(i);if(!t)return;const e=On(t),s={config:t,redundancy:e};Ae[i]=s}return Ae[i]}function An(i,t,e){let s,n;if(typeof i=="string"){const r=Re(i);if(!r)return e(void 0,424),Ri;n=r.send;const o=ir(i);o&&(s=o.redundancy)}else{const r=Xe(i);if(r){s=On(r);const o=i.resources?i.resources[0]:"",l=Re(o);l&&(n=l.send)}}return!s||!n?(e(void 0,424),Ri):s.query(t,n,e)().abort}const Mi="iconify2",Wt="iconify",Tn=Wt+"-count",Di=Wt+"-version",Pn=36e5,nr=168,sr=50;function Me(i,t){try{return i.getItem(t)}catch{}}function Ke(i,t,e){try{return i.setItem(t,e),!0}catch{}}function Fi(i,t){try{i.removeItem(t)}catch{}}function De(i,t){return Ke(i,Tn,t.toString())}function Fe(i){return parseInt(Me(i,Tn))||0}const yt={local:!0,session:!0},Ln={local:new Set,session:new Set};let Je=!1;function rr(i){Je=i}let ne=typeof window>"u"?{}:window;function In(i){const t=i+"Storage";try{if(ne&&ne[t]&&typeof ne[t].length=="number")return ne[t]}catch{}yt[i]=!1}function zn(i,t){const e=In(i);if(!e)return;const s=Me(e,Di);if(s!==Mi){if(s){const l=Fe(e);for(let a=0;a<l;a++)Fi(e,Wt+a.toString())}Ke(e,Di,Mi),De(e,0);return}const n=Math.floor(Date.now()/Pn)-nr,r=l=>{const a=Wt+l.toString(),c=Me(e,a);if(typeof c=="string"){try{const d=JSON.parse(c);if(typeof d=="object"&&typeof d.cached=="number"&&d.cached>n&&typeof d.provider=="string"&&typeof d.data=="object"&&typeof d.data.prefix=="string"&&t(d,l))return!0}catch{}Fi(e,a)}};let o=Fe(e);for(let l=o-1;l>=0;l--)r(l)||(l===o-1?(o--,De(e,o)):Ln[i].add(l))}function Bn(){if(!Je){rr(!0);for(const i in yt)zn(i,t=>{const e=t.data,s=t.provider,n=e.prefix,r=lt(s,n);if(!Ge(r,e).length)return!1;const o=e.lastModified||-1;return r.lastModifiedCached=r.lastModifiedCached?Math.min(r.lastModifiedCached,o):o,!0})}}function or(i,t){const e=i.lastModifiedCached;if(e&&e>=t)return e===t;if(i.lastModifiedCached=t,e)for(const s in yt)zn(s,n=>{const r=n.data;return n.provider!==i.provider||r.prefix!==i.prefix||r.lastModified===t});return!0}function lr(i,t){Je||Bn();function e(s){let n;if(!yt[s]||!(n=In(s)))return;const r=Ln[s];let o;if(r.size)r.delete(o=Array.from(r).shift());else if(o=Fe(n),o>=sr||!De(n,o+1))return;const l={cached:Math.floor(Date.now()/Pn),provider:i.provider,data:t};return Ke(n,Wt+o.toString(),JSON.stringify(l))}t.lastModified&&!or(i,t.lastModified)||Object.keys(t.icons).length&&(t.not_found&&(t=Object.assign({},t),delete t.not_found),e("local")||e("session"))}function Ni(){}function ar(i){i.iconsLoaderFlag||(i.iconsLoaderFlag=!0,setTimeout(()=>{i.iconsLoaderFlag=!1,Gs(i)}))}function cr(i,t){i.iconsToLoad?i.iconsToLoad=i.iconsToLoad.concat(t).sort():i.iconsToLoad=t,i.iconsQueueFlag||(i.iconsQueueFlag=!0,setTimeout(()=>{i.iconsQueueFlag=!1;const{provider:e,prefix:s}=i,n=i.iconsToLoad;delete i.iconsToLoad;let r;if(!n||!(r=Re(e)))return;r.prepare(e,s,n).forEach(l=>{An(e,l,a=>{if(typeof a!="object")l.icons.forEach(c=>{i.missing.add(c)});else try{const c=Ge(i,a);if(!c.length)return;const d=i.pendingIcons;d&&c.forEach(h=>{d.delete(h)}),lr(i,a)}catch(c){console.error(c)}ar(i)})})}))}const Ze=(i,t)=>{const e=Js(i,!0,En()),s=Ys(e);if(!s.pending.length){let a=!0;return t&&setTimeout(()=>{a&&t(s.loaded,s.missing,s.pending,Ni)}),()=>{a=!1}}const n=Object.create(null),r=[];let o,l;return s.pending.forEach(a=>{const{provider:c,prefix:d}=a;if(d===l&&c===o)return;o=c,l=d,r.push(lt(c,d));const h=n[c]||(n[c]=Object.create(null));h[d]||(h[d]=[])}),s.pending.forEach(a=>{const{provider:c,prefix:d,name:h}=a,f=lt(c,d),m=f.pendingIcons||(f.pendingIcons=new Set);m.has(h)||(m.add(h),n[c][d].push(h))}),r.forEach(a=>{const{provider:c,prefix:d}=a;n[c][d].length&&cr(a,n[c][d])}),t?Ks(t,s,r):Ni},ur=i=>new Promise((t,e)=>{const s=typeof i=="string"?Kt(i,!0):i;if(!s){e(i);return}Ze([s||i],n=>{if(n.length&&s){const r=qt(s);if(r){t({...Xt,...r});return}}e(i)})});function dr(i){try{const t=typeof i=="string"?JSON.parse(i):i;if(typeof t.body=="string")return{...t}}catch{}}function hr(i,t){const e=typeof i=="string"?Kt(i,!0,!0):null;if(!e){const r=dr(i);return{value:i,data:r}}const s=qt(e);if(s!==void 0||!e.prefix)return{value:i,name:e,data:s};const n=Ze([e],()=>t(i,e,qt(e)));return{value:i,name:e,loading:n}}function Te(i){return i.hasAttribute("inline")}let jn=!1;try{jn=navigator.vendor.indexOf("Apple")===0}catch{}function fr(i,t){switch(t){case"svg":case"bg":case"mask":return t}return t!=="style"&&(jn||i.indexOf("<a")===-1)?"svg":i.indexOf("currentColor")===-1?"bg":"mask"}const pr=/(-?[0-9.]*[0-9]+[0-9.]*)/g,mr=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Ne(i,t,e){if(t===1)return i;if(e=e||100,typeof i=="number")return Math.ceil(i*t*e)/e;if(typeof i!="string")return i;const s=i.split(pr);if(s===null||!s.length)return i;const n=[];let r=s.shift(),o=mr.test(r);for(;;){if(o){const l=parseFloat(r);isNaN(l)?n.push(r):n.push(Math.ceil(l*t*e)/e)}else n.push(r);if(r=s.shift(),r===void 0)return n.join("");o=!o}}function br(i,t="defs"){let e="";const s=i.indexOf("<"+t);for(;s>=0;){const n=i.indexOf(">",s),r=i.indexOf("</"+t);if(n===-1||r===-1)break;const o=i.indexOf(">",r);if(o===-1)break;e+=i.slice(n+1,r).trim(),i=i.slice(0,s).trim()+i.slice(o+1)}return{defs:e,content:i}}function gr(i,t){return i?"<defs>"+i+"</defs>"+t:t}function vr(i,t,e){const s=br(i);return gr(s.defs,t+s.content+e)}const yr=i=>i==="unset"||i==="undefined"||i==="none";function Rn(i,t){const e={...Xt,...i},s={...xn,...t},n={left:e.left,top:e.top,width:e.width,height:e.height};let r=e.body;[e,s].forEach(v=>{const g=[],S=v.hFlip,$=v.vFlip;let x=v.rotate;S?$?x+=2:(g.push("translate("+(n.width+n.left).toString()+" "+(0-n.top).toString()+")"),g.push("scale(-1 1)"),n.top=n.left=0):$&&(g.push("translate("+(0-n.left).toString()+" "+(n.height+n.top).toString()+")"),g.push("scale(1 -1)"),n.top=n.left=0);let w;switch(x<0&&(x-=Math.floor(x/4)*4),x=x%4,x){case 1:w=n.height/2+n.top,g.unshift("rotate(90 "+w.toString()+" "+w.toString()+")");break;case 2:g.unshift("rotate(180 "+(n.width/2+n.left).toString()+" "+(n.height/2+n.top).toString()+")");break;case 3:w=n.width/2+n.left,g.unshift("rotate(-90 "+w.toString()+" "+w.toString()+")");break}x%2===1&&(n.left!==n.top&&(w=n.left,n.left=n.top,n.top=w),n.width!==n.height&&(w=n.width,n.width=n.height,n.height=w)),g.length&&(r=vr(r,'<g transform="'+g.join(" ")+'">',"</g>"))});const o=s.width,l=s.height,a=n.width,c=n.height;let d,h;o===null?(h=l===null?"1em":l==="auto"?c:l,d=Ne(h,a/c)):(d=o==="auto"?a:o,h=l===null?Ne(d,c/a):l==="auto"?c:l);const f={},m=(v,g)=>{yr(g)||(f[v]=g.toString())};m("width",d),m("height",h);const b=[n.left,n.top,a,c];return f.viewBox=b.join(" "),{attributes:f,viewBox:b,body:r}}function ti(i,t){let e=i.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in t)e+=" "+s+'="'+t[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+e+">"+i+"</svg>"}function _r(i){return i.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function xr(i){return"data:image/svg+xml,"+_r(i)}function Mn(i){return'url("'+xr(i)+'")'}const wr=()=>{let i;try{if(i=fetch,typeof i=="function")return i}catch{}};let de=wr();function Cr(i){de=i}function $r(){return de}function Er(i,t){const e=we(i);if(!e)return 0;let s;if(!e.maxURL)s=0;else{let n=0;e.resources.forEach(o=>{n=Math.max(n,o.length)});const r=t+".json?icons=";s=e.maxURL-n-e.path.length-r.length}return s}function Sr(i){return i===404}const kr=(i,t,e)=>{const s=[],n=Er(i,t),r="icons";let o={type:r,provider:i,prefix:t,icons:[]},l=0;return e.forEach((a,c)=>{l+=a.length+1,l>=n&&c>0&&(s.push(o),o={type:r,provider:i,prefix:t,icons:[]},l=a.length),o.icons.push(a)}),s.push(o),s};function Or(i){if(typeof i=="string"){const t=we(i);if(t)return t.path}return"/"}const Ar=(i,t,e)=>{if(!de){e("abort",424);return}let s=Or(t.provider);switch(t.type){case"icons":{const r=t.prefix,l=t.icons.join(","),a=new URLSearchParams({icons:l});s+=r+".json?"+a.toString();break}case"custom":{const r=t.uri;s+=r.slice(0,1)==="/"?r.slice(1):r;break}default:e("abort",400);return}let n=503;de(i+s).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{e(Sr(o)?"abort":"next",o)});return}return n=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?e("abort",r):e("next",n)});return}setTimeout(()=>{e("success",r)})}).catch(()=>{e("next",n)})},Tr={prepare:kr,send:Ar};function Hi(i,t){switch(i){case"local":case"session":yt[i]=t;break;case"all":for(const e in yt)yt[e]=t;break}}const Pe="data-style";let Dn="";function Pr(i){Dn=i}function Vi(i,t){let e=Array.from(i.childNodes).find(s=>s.hasAttribute&&s.hasAttribute(Pe));e||(e=document.createElement("style"),e.setAttribute(Pe,Pe),i.appendChild(e)),e.textContent=":host{display:inline-block;vertical-align:"+(t?"-0.125em":"0")+"}span,svg{display:block}"+Dn}function Fn(){Bi("",Tr),En(!0);let i;try{i=window}catch{}if(i){if(Bn(),i.IconifyPreload!==void 0){const e=i.IconifyPreload,s="Invalid IconifyPreload syntax.";typeof e=="object"&&e!==null&&(e instanceof Array?e:[e]).forEach(n=>{try{(typeof n!="object"||n===null||n instanceof Array||typeof n.icons!="object"||typeof n.prefix!="string"||!Ii(n))&&console.error(s)}catch{console.error(s)}})}if(i.IconifyProviders!==void 0){const e=i.IconifyProviders;if(typeof e=="object"&&e!==null)for(const s in e){const n="IconifyProviders["+s+"] is invalid.";try{const r=e[s];if(typeof r!="object"||!r||r.resources===void 0)continue;ji(s,r)||console.error(n)}catch{console.error(n)}}}}return{enableCache:e=>Hi(e,!0),disableCache:e=>Hi(e,!1),iconLoaded:zi,iconExists:zi,getIcon:Qs,listIcons:Us,addIcon:Sn,addCollection:Ii,calculateSize:Ne,buildIcon:Rn,iconToHTML:ti,svgToURL:Mn,loadIcons:Ze,loadIcon:ur,addAPIProvider:ji,appendCustomStyle:Pr,_api:{getAPIConfig:we,setAPIModule:Bi,sendAPIQuery:An,setFetch:Cr,getFetch:$r,listAPIProviders:er}}}const He={"background-color":"currentColor"},Nn={"background-color":"transparent"},qi={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},Wi={"-webkit-mask":He,mask:He,background:Nn};for(const i in Wi){const t=Wi[i];for(const e in qi)t[i+"-"+e]=qi[e]}function Ui(i){return i?i+(i.match(/^[-0-9.]+$/)?"px":""):"inherit"}function Lr(i,t,e){const s=document.createElement("span");let n=i.body;n.indexOf("<a")!==-1&&(n+="<!-- "+Date.now()+" -->");const r=i.attributes,o=ti(n,{...r,width:t.width+"",height:t.height+""}),l=Mn(o),a=s.style,c={"--svg":l,width:Ui(r.width),height:Ui(r.height),...e?He:Nn};for(const d in c)a.setProperty(d,c[d]);return s}let Ft;function Ir(){try{Ft=window.trustedTypes.createPolicy("iconify",{createHTML:i=>i})}catch{Ft=null}}function zr(i){return Ft===void 0&&Ir(),Ft?Ft.createHTML(i):i}function Br(i){const t=document.createElement("span"),e=i.attributes;let s="";e.width||(s="width: inherit;"),e.height||(s+="height: inherit;"),s&&(e.style=s);const n=ti(i.body,e);return t.innerHTML=zr(n),t.firstChild}function Ve(i){return Array.from(i.childNodes).find(t=>{const e=t.tagName&&t.tagName.toUpperCase();return e==="SPAN"||e==="SVG"})}function Qi(i,t){const e=t.icon.data,s=t.customisations,n=Rn(e,s);s.preserveAspectRatio&&(n.attributes.preserveAspectRatio=s.preserveAspectRatio);const r=t.renderedMode;let o;switch(r){case"svg":o=Br(n);break;default:o=Lr(n,{...Xt,...e},r==="mask")}const l=Ve(i);l?o.tagName==="SPAN"&&l.tagName===o.tagName?l.setAttribute("style",o.getAttribute("style")):i.replaceChild(o,l):i.appendChild(o)}function Yi(i,t,e){const s=e&&(e.rendered?e:e.lastRender);return{rendered:!1,inline:t,icon:i,lastRender:s}}function jr(i="iconify-icon"){let t,e;try{t=window.customElements,e=window.HTMLElement}catch{return}if(!t||!e)return;const s=t.get(i);if(s)return s;const n=["icon","mode","inline","observe","width","height","rotate","flip"],r=class extends e{constructor(){super();st(this,"_shadowRoot");st(this,"_initialised",!1);st(this,"_state");st(this,"_checkQueued",!1);st(this,"_connected",!1);st(this,"_observer",null);st(this,"_visible",!0);const a=this._shadowRoot=this.attachShadow({mode:"open"}),c=Te(this);Vi(a,c),this._state=Yi({value:""},c),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return n.slice(0)}attributeChangedCallback(a){switch(a){case"inline":{const c=Te(this),d=this._state;c!==d.inline&&(d.inline=c,Vi(this._shadowRoot,c));break}case"observer":{this.observer?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const a=this.getAttribute("icon");if(a&&a.slice(0,1)==="{")try{return JSON.parse(a)}catch{}return a}set icon(a){typeof a=="object"&&(a=JSON.stringify(a)),this.setAttribute("icon",a)}get inline(){return Te(this)}set inline(a){a?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(a){a?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const a=this._state;if(a.rendered){const c=this._shadowRoot;if(a.renderedMode==="svg")try{c.lastChild.setCurrentTime(0);return}catch{}Qi(c,a)}}get status(){const a=this._state;return a.rendered?"rendered":a.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const a=this._state,c=this.getAttribute("icon");if(c!==a.icon.value){this._iconChanged(c);return}if(!a.rendered||!this._visible)return;const d=this.getAttribute("mode"),h=Pi(this);(a.attrMode!==d||Ds(a.customisations,h)||!Ve(this._shadowRoot))&&this._renderIcon(a.icon,h,d)}_iconChanged(a){const c=hr(a,(d,h,f)=>{const m=this._state;if(m.rendered||this.getAttribute("icon")!==d)return;const b={value:d,name:h,data:f};b.data?this._gotIconData(b):m.icon=b});c.data?this._gotIconData(c):this._state=Yi(c,this._state.inline,this._state)}_forceRender(){if(!this._visible){const a=Ve(this._shadowRoot);a&&this._shadowRoot.removeChild(a);return}this._queueCheck()}_gotIconData(a){this._checkQueued=!1,this._renderIcon(a,Pi(this),this.getAttribute("mode"))}_renderIcon(a,c,d){const h=fr(a.data.body,d),f=this._state.inline;Qi(this._shadowRoot,this._state={rendered:!0,icon:a,inline:f,customisations:c,attrMode:d,renderedMode:h})}startObserver(){if(!this._observer)try{this._observer=new IntersectionObserver(a=>{const c=a.some(d=>d.isIntersecting);c!==this._visible&&(this._visible=c,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};n.forEach(l=>{l in r.prototype||Object.defineProperty(r.prototype,l,{get:function(){return this.getAttribute(l)},set:function(a){a!==null?this.setAttribute(l,a):this.removeAttribute(l)}})});const o=Fn();for(const l in o)r[l]=r.prototype[l]=o[l];return t.define(i,r),r}jr()||Fn();var Rr=Object.defineProperty,Mr=Object.getOwnPropertyDescriptor,H=(i,t,e,s)=>{for(var n=s>1?void 0:s?Mr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Rr(t,e,n),n},Pt;const R=(Pt=class extends E{constructor(){super(),this.labelHidden=!1,this.active=!1,this.disabled=!1,this.vertical=!1,this.tooltipVisible=!1,this._stateBeforeLoading={disabled:!1,icon:""},this._loading=!1,this._parent=gt(),this._tooltip=gt(),this._contextMenu=gt(),this._mouseLeave=!1,this.onWindowMouseUp=t=>{const{value:e}=this._contextMenu;!this.contains(t.target)&&e&&(e.visible=!1)},this.onClick=t=>{t.stopPropagation(),this.disabled||this.dispatchEvent(new Event("click"))},this.mouseLeave=!0}set loading(t){if(this._loading=t,t)this._stateBeforeLoading={disabled:this.disabled,icon:this.icon},this.disabled=t,this.icon="eos-icons:loading";else{const{disabled:e,icon:s}=this._stateBeforeLoading;this.disabled=e,this.icon=s}}get loading(){return this._loading}set mouseLeave(t){this._mouseLeave=t,t&&(this.tooltipVisible=!1,clearTimeout(this.timeoutID))}get mouseLeave(){return this._mouseLeave}computeTooltipPosition(){const{value:t}=this._parent,{value:e}=this._tooltip;t&&e&&vn(t,e,{placement:"bottom",middleware:[rn(10),gn(),bn(),mn({padding:5})]}).then(s=>{const{x:n,y:r}=s;Object.assign(e.style,{left:`${n}px`,top:`${r}px`})})}onMouseEnter(){if(!(this.tooltipTitle||this.tooltipText))return;this.mouseLeave=!1;const t=this.tooltipTime??700;this.timeoutID=setTimeout(()=>{this.mouseLeave||(this.computeTooltipPosition(),this.tooltipVisible=!0)},t)}onChildrenClick(t){t.stopPropagation();const{value:e}=this._contextMenu;e&&(e.visible=!e.visible)}onSlotChange(t){const{value:e}=this._contextMenu,s=t.target.assignedElements();for(const n of s){if(!(n instanceof Pt)){n.remove(),console.warn("Only bim-button is allowed inside bim-button. Child has been removed.");continue}n.addEventListener("click",()=>e==null?void 0:e.updatePosition())}this.requestUpdate()}click(){this.disabled||super.click()}connectedCallback(){super.connectedCallback(),window.addEventListener("mouseup",this.onWindowMouseUp)}disconnectedCallback(){super.disconnectedCallback(),window.removeEventListener("mouseup",this.onWindowMouseUp)}render(){const t=p`
  ...
  `,Pt);H([u({type:String,reflect:!0})],R.prototype,"label",2);H([u({type:Boolean,attribute:"label-hidden",reflect:!0})],R.prototype,"labelHidden",2);H([u({type:Boolean,reflect:!0})],R.prototype,"active",2);H([u({type:Boolean,reflect:!0,attribute:"disabled"})],R.prototype,"disabled",2);H([u({type:String,reflect:!0})],R.prototype,"icon",2);H([u({type:Boolean,reflect:!0})],R.prototype,"vertical",2);H([u({type:Number,attribute:"tooltip-time",reflect:!0})],R.prototype,"tooltipTime",2);H([u({type:Boolean,attribute:"tooltip-visible",reflect:!0})],R.prototype,"tooltipVisible",2);H([u({type:String,attribute:"tooltip-title",reflect:!0})],R.prototype,"tooltipTitle",2);H([u({type:String,attribute:"tooltip-text",reflect:!0})],R.prototype,"tooltipText",2);H([u({type:Boolean,reflect:!0})],R.prototype,"loading",1);let Dr=R;var Fr=Object.defineProperty,Jt=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Fr(t,e,n),n};const ii=class ii extends E{constructor(){super(...arguments),this.checked=!1,this.inverted=!1,this.onValueChange=new Event("change")}get value(){return this.checked}onChange(t){t.stopPropagation(),this.checked=t.target.checked,this.dispatchEvent(this.onValueChange)}render(){return p`
      <div class="parent">
  ...
  `;let X=ni;It([u({type:String,reflect:!0})],X.prototype,"name");It([u({type:String,reflect:!0})],X.prototype,"label");It([u({type:String,reflect:!0})],X.prototype,"icon");It([u({type:Boolean,reflect:!0})],X.prototype,"vertical");It([u({type:Number,reflect:!0})],X.prototype,"opacity");It([u({type:String,reflect:!0})],X.prototype,"color");const Hr=C`
  ::-webkit-scrollbar {
    width: 0.4rem;
    height: 0.4rem;
    overflow: hidden;
...
`,pt={scrollbar:Hr,globalStyles:Vr};var qr=Object.defineProperty,Wr=Object.getOwnPropertyDescriptor,Hn=(i,t,e,s)=>{for(var n=Wr(t,e),r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&qr(t,e,n),n};const si=class si extends E{constructor(){super(),this._previousContainer=null,this._visible=!1,this._dialog=document.createElement("dialog"),this._dialog.toggleAttribute("data-context-dialog"),this._dialog.style.width="0",this._dialog.style.height="0",this._dialog.style.position="relative",this._dialog.style.padding="0",this._dialog.style.border="none",this._dialog.style.outline="none",this._dialog.style.margin="none",this._dialog.style.overflow="visible",this._dialog.style.backgroundColor="transparent",this._dialog.addEventListener("cancel",t=>{t.preventDefault()}),this._dialog.addEventListener("click",t=>{t.target===this._dialog&&(this.visible=!1)})}get placement(){return this._placement}set placement(t){this._placement=t,this.updatePosition()}get visible(){return this._visible}set visible(t){var e;this._visible=t,t?(this._previousContainer=this.parentElement,this._dialog.style.top=`${window.scrollY||document.documentElement.scrollTop}px`,document.body.append(this._dialog),this._dialog.showModal(),this.updatePosition(),this._dialog.append(this),this.dispatchEvent(new Event("visible"))):((e=this._previousContainer)==null||e.append(this),this._previousContainer=null,this._dialog.close(),this._dialog.remove(),this.dispatchEvent(new Event("hidden")))}async updatePosition(){if(!(this.visible&&this._previousContainer))return;const t=this.placement??"right",e=await vn(this._previousContainer,this,{placement:t,middleware:[rn(10),gn(),bn(),mn({padding:5})]}),{x:s,y:n}=e;this.style.left=`${s}px`,this.style.top=`${n}px`}render(){return p` <slot></slot> `}};si.styles=[pt.scrollbar,C`
  ...
  `;let A=ri;mt([u({type:String,reflect:!0})],A.prototype,"img",2);mt([u({type:String,reflect:!0})],A.prototype,"label",2);mt([u({type:String,reflect:!0})],A.prototype,"icon",2);mt([u({type:Boolean,reflect:!0})],A.prototype,"checked",2);mt([u({type:Boolean,reflect:!0})],A.prototype,"checkbox",2);mt([u({type:Boolean,attribute:"no-mark",reflect:!0})],A.prototype,"noMark",2);mt([u({converter:{fromAttribute(i){return i&&Ce(i)}}})],A.prototype,"value",1);mt([u({type:Boolean,reflect:!0})],A.prototype,"vertical",2);var Xr=Object.defineProperty,Kr=Object.getOwnPropertyDescriptor,bt=(i,t,e,s)=>{for(var n=s>1?void 0:s?Kr(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Xr(t,e,n),n};const oi=class oi extends Ur{constructor(){super(),this.multiple=!1,this.required=!1,this.vertical=!1,this._visible=!1,this._value=new Set,this.onValueChange=new Event("change"),this._contextMenu=gt(),this.onOptionClick=t=>{const e=t.target,s=this._value.has(e);if(!this.multiple&&!this.required&&!s)this._value=new Set([e]);else if(!this.multiple&&!this.required&&s)this._value=new Set([]);else if(!this.multiple&&this.required&&!s)this._value=new Set([e]);else if(this.multiple&&!this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&!this.required&&s){const n=[...this._value].filter(r=>r!==e);this._value=new Set(n)}else if(this.multiple&&this.required&&!s)this._value=new Set([...this._value,e]);else if(this.multiple&&this.required&&s){const n=[...this._value].filter(o=>o!==e),r=new Set(n);r.size!==0&&(this._value=r)}this.updateOptionsState(),this.dispatchEvent(this.onValueChange)},this.useObserver=!0}set visible(t){if(t){const{value:e}=this._contextMenu;if(!e)return;for(const s of this.elements)e.append(s);this._visible=!0}else{for(const e of this.elements)this.append(e);this._visible=!1,this.resetVisibleElements()}}get visible(){return this._visible}set value(t){if(this.required&&Object.keys(t).length===0)return;const e=new Set;for(const s of t){const n=this.findOption(s);if(n&&(e.add(n),!this.multiple&&Object.keys(t).length===1))break}this._value=e,this.updateOptionsState(),this.dispatchEvent(this.onValueChange)}get value(){return[...this._value].filter(e=>e instanceof A&&e.checked).map(e=>e.value)}get _options(){const t=new Set([...this.elements]);for(const e of this.children)e instanceof A&&t.add(e);return[...t]}onSlotChange(t){const e=t.target.assignedElements();this.observe(e);const s=new Set;for(const n of this.elements){if(!(n instanceof A)){n.remove();continue}n.checked&&s.add(n),n.removeEventListener("click",this.onOptionClick),n.addEventListener("click",this.onOptionClick)}this._value=s}updateOptionsState(){for(const t of this._options)t instanceof A&&(t.checked=this._value.has(t))}findOption(t){return this._options.find(s=>s instanceof A?s.label===t||s.value===t:!1)}render(){let t,e,s;if(this._value.size===0)t="Select an option...";else if(this._value.size===1){const n=[...this._value][0];t=(n==null?void 0:n.label)||(n==null?void 0:n.value),e=n==null?void 0:n.img,s=n==null?void 0:n.icon}else t=`Multiple (${this._value.size})`;return p`
    ...
    `];let N=oi;bt([u({type:String,reflect:!0})],N.prototype,"name",2);bt([u({type:String,reflect:!0})],N.prototype,"icon",2);bt([u({type:String,reflect:!0})],N.prototype,"label",2);bt([u({type:Boolean,reflect:!0})],N.prototype,"multiple",2);bt([u({type:Boolean,reflect:!0})],N.prototype,"required",2);bt([u({type:Boolean,reflect:!0})],N.prototype,"vertical",2);bt([u({type:Boolean,reflect:!0})],N.prototype,"visible",1);bt([Lt()],N.prototype,"_value",2);var Jr=Object.defineProperty,Vn=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Jr(t,e,n),n};const li=class li extends E{constructor(){super(...arguments),this.floating=!1,this.layouts={}}getUniqueAreasFromTemplate(t){const n=t.split(`
`).map(o=>o.trim()).map(o=>o.split('"')[1]).filter(o=>o!==void 0).flatMap(o=>o.split(/\s+/));return[...new Set(n)].filter(o=>o!=="")}firstUpdated(){this._onLayoutChange=new Event("layoutchange")}render(){if(this.layout){if(this.layouts[this.layout]){this.innerHTML="";const t=this.layouts[this.layout],s=this.getUniqueAreasFromTemplate(t.template).map(n=>{const r=t.elements[n];return r&&(r.style.gridArea=n),r}).filter(n=>!!n);this.style.gridTemplate=t.template,this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange),this.append(...s)}}else this.innerHTML="",this.style.gridTemplate="",this._onLayoutChange&&this.dispatchEvent(this._onLayoutChange);return p`<slot></slot>`}};li.styles=C`
  ...
  `;let Qt=li;Vn([u({type:Boolean,reflect:!0})],Qt.prototype,"floating");Vn([u({type:String,reflect:!0})],Qt.prototype,"layout");const ge=class ge extends E{render(){return p`
  ...
  `;let xt=ai;$e([u({type:String,reflect:!0})],xt.prototype,"name");$e([u({type:String,reflect:!0})],xt.prototype,"label");$e([u({type:String,reflect:!0})],xt.prototype,"icon");$e([u({type:Boolean,reflect:!0})],xt.prototype,"vertical");var to=Object.defineProperty,Zt=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&to(t,e,n),n};const ci=class ci extends E{constructor(){super(...arguments),this.labelHidden=!1,this.iconHidden=!1,this.vertical=!1}get value(){return this.textContent?Ce(this.textContent):this.textContent}render(){return p`
  ...
  `;let P=ui;M([u({type:String,reflect:!0})],P.prototype,"name",2);M([u({type:String,reflect:!0})],P.prototype,"icon",2);M([u({type:String,reflect:!0})],P.prototype,"label",2);M([u({type:String,reflect:!0})],P.prototype,"pref",2);M([u({type:Number,reflect:!0})],P.prototype,"min",2);M([u({type:Number,reflect:!0})],P.prototype,"value",1);M([u({type:Number,reflect:!0})],P.prototype,"step",2);M([u({type:Number,reflect:!0})],P.prototype,"sensitivity",2);M([u({type:Number,reflect:!0})],P.prototype,"max",2);M([u({type:String,reflect:!0})],P.prototype,"suffix",2);M([u({type:Boolean,reflect:!0})],P.prototype,"vertical",2);M([u({type:Boolean,reflect:!0})],P.prototype,"slider",2);var no=Object.defineProperty,so=Object.getOwnPropertyDescriptor,te=(i,t,e,s)=>{for(var n=s>1?void 0:s?so(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&no(t,e,n),n};const di=class di extends E{constructor(){super(...arguments),this.onValueChange=new Event("change"),this._hidden=!1,this.headerHidden=!1,this.valueTransform={},this.activationButton=document.createElement("bim-button")}set hidden(t){this._hidden=t,this.activationButton.active=!t,this.dispatchEvent(new Event("hiddenchange"))}get hidden(){return this._hidden}get value(){return he(this,this.valueTransform)}set value(t){const e=[...this.children];for(const s in t){const n=e.find(o=>{const l=o;return l.name===s||l.label===s});if(!n)continue;const r=n;r.value=t[s]}}connectedCallback(){super.connectedCallback(),this.activationButton.active=!this.hidden,this.activationButton.onclick=()=>this.hidden=!this.hidden}disconnectedCallback(){super.disconnectedCallback(),this.activationButton.remove()}collapseSections(){const t=this.querySelectorAll("bim-panel-section");for(const e of t)e.collapsed=!0}expandSections(){const t=this.querySelectorAll("bim-panel-section");for(const e of t)e.collapsed=!1}render(){return this.activationButton.icon=this.icon,this.activationButton.label=this.label||this.name,this.activationButton.tooltipTitle=this.label||this.name,p`
      <div class="parent">
  ...
  `;let dt=fi;ie([u({type:String,reflect:!0})],dt.prototype,"name");ie([u({type:String,reflect:!0})],dt.prototype,"icon");ie([u({type:String,reflect:!0})],dt.prototype,"label");ie([u({type:Boolean,reflect:!0})],dt.prototype,"vertical");ie([Lt()],dt.prototype,"_value");const lo=()=>p`
    <style>
      div {
        display: flex;
        gap: 0.375rem;
...
`;o+=b,h&&(o+=this.generateText(t,c.children,`${s}${a+1}.`,!1))}return o}get csv(){return this.generateText("comma")}get tsv(){return this.generateText("tab")}applyDataTransform(t){const e={};for(const s of Object.keys(this.dataTransform)){const n=this.columns.find(r=>r.name===s);n&&n.forceDataTransform&&(s in t||(t[s]=""))}for(const s in t){const n=this.dataTransform[s];n?e[s]=n(t[s],t):e[s]=t[s]}return e}downloadData(t="BIM Table Data",e="json"){let s=null;if(e==="json"&&(s=new File([JSON.stringify(this.value,void 0,2)],`${t}.json`)),e==="csv"&&(s=new File([this.csv],`${t}.csv`)),e==="tsv"&&(s=new File([this.tsv],`${t}.tsv`)),!s)return;const n=document.createElement("a");n.href=URL.createObjectURL(s),n.download=s.name,n.click(),URL.revokeObjectURL(n.href)}getRowIndentation(t,e=this.value,s=0){for(const n of e){if(n.data===t)return s;if(n.children){const r=this.getRowIndentation(t,n.children,s+1);if(r!==null)return r}}return null}getGroupIndentation(t,e=this.value,s=0){for(const n of e){if(n===t)return s;if(n.children){const r=this.getGroupIndentation(t,n.children,s+1);if(r!==null)return r}}return null}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new Event("connected"))}disconnectedCallback(){super.disconnectedCallback(),this.dispatchEvent(new Event("disconnected"))}async loadData(t=!1){if(this._filteredData.length!==0&&!t||!this.loadFunction)return!1;this.loading=!0;try{const e=await this.loadFunction();return this.data=e,this.loading=!1,this._errorLoading=!1,!0}catch(e){return this.loading=!1,this._filteredData.length!==0||(e instanceof Error&&this.loadingErrorElement&&e.message.trim()!==""&&(this.loadingErrorElement.textContent=e.message),this._errorLoading=!0),!1}}filter(t,e=this.filterFunction??this._stringFilterFunction,s=this.data){const n=[];for(const r of s)if(e(t,r)){if(this.preserveStructureOnFilter){const l={data:r.data};if(r.children){const a=this.filter(t,e,r.children);a.length&&(l.children=a)}n.push(l)}else if(n.push({data:r.data}),r.children){const l=this.filter(t,e,r.children);n.push(...l)}}else if(r.children){const l=this.filter(t,e,r.children);this.preserveStructureOnFilter&&l.length?n.push({data:r.data,children:l}):n.push(...l)}return n}get _missingDataElement(){return this.querySelector("[slot='missing-data']")}render(){if(this.loading)return lo();if(this._errorLoading)return p`<slot name="error-loading"></slot>`;if(this._filteredData.length===0&&this._missingDataElement)return p`<slot name="missing-data"></slot>`;const t=document.createElement("bim-table-row");t.table=this,t.isHeader=!0,t.data=this._headerRowData,t.style.gridArea="Header",t.style.position="sticky",t.style.top="0",t.style.zIndex="5";const e=document.createElement("bim-table-children");return e.table=this,e.data=this.value,e.style.gridArea="Body",e.style.backgroundColor="transparent",p`
  ...
  `;let L=yi;Ee([u({type:String,reflect:!0})],L.prototype,"name",2);Ee([u({type:String,reflect:!0})],L.prototype,"label",2);Ee([u({type:String,reflect:!0})],L.prototype,"icon",2);Ee([u({type:Boolean,reflect:!0})],L.prototype,"hidden",1);var xo=Object.defineProperty,wo=Object.getOwnPropertyDescriptor,Bt=(i,t,e,s)=>{for(var n=s>1?void 0:s?wo(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&xo(t,e,n),n};const _i=class _i extends E{constructor(){super(...arguments),this._switchers=[],this.bottom=!1,this.switchersHidden=!1,this.floating=!1,this.switchersFull=!1,this.onTabHiddenChange=t=>{const e=t.target;e instanceof L&&!e.hidden&&(e.removeEventListener("hiddenchange",this.onTabHiddenChange),this.tab=e.name,e.addEventListener("hiddenchange",this.onTabHiddenChange))}}set tab(t){this._tab=t;const e=[...this.children],s=e.find(n=>n instanceof L&&n.name===t);for(const n of e){if(!(n instanceof L))continue;n.hidden=s!==n;const r=this.getTabSwitcher(n.name);r&&r.toggleAttribute("data-active",!n.hidden)}}get tab(){return this._tab}getTabSwitcher(t){return this._switchers.find(s=>s.getAttribute("data-name")===t)}createSwitchers(){this._switchers=[];for(const t of this.children){if(!(t instanceof L))continue;const e=document.createElement("div");e.addEventListener("click",()=>{this.tab===t.name?this.toggleAttribute("tab",!1):this.tab=t.name}),e.setAttribute("data-name",t.name),e.className="switcher";const s=document.createElement("bim-label");s.textContent=t.label??"",s.icon=t.icon,e.append(s),this._switchers.push(e)}}onSlotChange(t){this.createSwitchers();const e=t.target.assignedElements(),s=e.find(n=>n instanceof L?this.tab?n.name===this.tab:!n.hidden:!1);s&&s instanceof L&&(this.tab=s.name);for(const n of e){if(!(n instanceof L)){n.remove();continue}n.removeEventListener("hiddenchange",this.onTabHiddenChange),s!==n&&(n.hidden=!0),n.addEventListener("hiddenchange",this.onTabHiddenChange)}}render(){return p`
    ...
    `];let Z=_i;Bt([Lt()],Z.prototype,"_switchers",2);Bt([u({type:Boolean,reflect:!0})],Z.prototype,"bottom",2);Bt([u({type:Boolean,attribute:"switchers-hidden",reflect:!0})],Z.prototype,"switchersHidden",2);Bt([u({type:Boolean,reflect:!0})],Z.prototype,"floating",2);Bt([u({type:String,reflect:!0})],Z.prototype,"tab",1);Bt([u({type:Boolean,attribute:"switchers-full",reflect:!0})],Z.prototype,"switchersFull",2);/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ki=i=>i??Le;var Co=Object.defineProperty,$o=Object.getOwnPropertyDescriptor,tt=(i,t,e,s)=>{for(var n=s>1?void 0:s?$o(t,e):t,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=(s?o(t,e,n):o(n))||n);return s&&n&&Co(t,e,n),n};const xi=class xi extends E{constructor(){super(...arguments),this._inputTypes=["date","datetime-local","email","month","password","search","tel","text","time","url","week","area"],this.value="",this.vertical=!1,this._type="text",this.onValueChange=new Event("input")}set type(t){this._inputTypes.includes(t)&&(this._type=t)}get type(){return this._type}get query(){return qe(this.value)}onInputChange(t){t.stopPropagation();const e=t.target;clearTimeout(this._debounceTimeoutID),this._debounceTimeoutID=setTimeout(()=>{this.value=e.value,this.dispatchEvent(this.onValueChange)},this.debounce)}focus(){setTimeout(()=>{var e;const t=(e=this.shadowRoot)==null?void 0:e.querySelector("input");t==null||t.focus()})}render(){return p`
      <bim-input
        .name=${this.name}
        .icon=${this.icon}
        .label=${this.label}
  ...
  `;let Tt=$i;ei([u({type:String,reflect:!0})],Tt.prototype,"icon",2);ei([u({type:Boolean,attribute:"labels-hidden",reflect:!0})],Tt.prototype,"labelsHidden",2);ei([u({type:Boolean,reflect:!0})],Tt.prototype,"vertical",1);var Po=Object.defineProperty,Lo=(i,t,e,s)=>{for(var n=void 0,r=i.length-1,o;r>=0;r--)(o=i[r])&&(n=o(t,e,n)||n);return n&&Po(t,e,n),n};const Ei=class Ei extends E{constructor(){super(),this._onResize=new Event("resize"),new ResizeObserver(()=>{setTimeout(()=>{this.dispatchEvent(this._onResize)})}).observe(this)}render(){return p`
      <div class="parent">
        <slot></slot>
      </div>
    `}};Ei.styles=C`
  ...
  `;let be=Ei;Lo([u({type:String,reflect:!0})],be.prototype,"name");export{Ur as C,vt as K,Ue as M,Os as e,As as i,ks as t};
