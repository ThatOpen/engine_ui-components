import{m as u,e as _,J as A,F as T,R as S,V as x,h as J,d as j,Q as F,a as V}from"./index-BgQRAdOj.js";import"./lit-html-Cs86_c16.js";const N=async(o,i)=>{const{localId:t,category:e,children:s}=i;if(e&&s){const n={data:{Name:e,modelId:o.modelId,children:JSON.stringify(s.map(r=>r.localId))}};for(const r of s){const l=await N(o,r);l&&(n.children||(n.children=[]),n.children.push(l))}return n}if(t!==null){const r=await o.getItem(t).getAttributes();if(!r)return null;const l={data:{Name:String(r.getValue("Name")),modelId:o.modelId,localId:t}};for(const a of s??[]){const c=await N(o,a);c&&(l.children||(l.children=[]),l.children.push(c))}return l}return null},E=async o=>{const i=[];for(const t of o){const e=await t.getSpatialStructure(),s=await N(t,e);if(!s)continue;const n={data:{Name:t.modelId,modelId:t.modelId},children:[s]};i.push(n)}return i},O=o=>{const{components:i,models:t}=o,e=o.selectHighlighterName??"select";return u`
  ...
  `},q=(o,i=!0)=>{const t=S.create(O,o),[e,s]=t;if(e.hiddenColumns=["modelId","localId","children"],e.columns=["Name"],e.headersHidden=!0,i){const{components:n}=o,r=n.get(T);r.list.onItemSet.add(()=>s({models:r.list.values()})),r.list.onItemDeleted.add(()=>s())}return t},K=Object.freeze(Object.defineProperty({__proto__:null,spatialTree:q,spatialTreeTemplate:O},Symbol.toStringTag,{value:"Module"}));let D={};const B={_category:"Category",_localId:"LocalId",_guid:"Guid"},Q=(o,i,t)=>{const e={data:{Name:i in B?B[i]:i,Value:t}};o.children||(o.children=[]),o.children.push(e)},L=(o,i,t)=>{var a;o in D||(D[o]=new Map);const e=D[o],s=i._localId.value;if(e.has(s))return e.get(s);const n=(a=i[t.defaultItemNameKey])==null?void 0:a.value,r=i._category.value,l={data:{Name:(n==null?void 0:n.toString().length)>0?n.toString():r??String(s)}};e.set(s,l);for(const c in i){const d=i[c];if(!Array.isArray(d))Q(l,c,d.value);else{const m={data:{Name:c}};l.children||(l.children=[]),l.children.push(m);for(const b of d){const y=L(o,b,t);m.children||(m.children=[]),m.children.push(y)}}}return l},W=async(o,i,t)=>{const e=o.get(T);Object.keys(i).length===0&&(D={});const s=[];for(const n in i){const r=e.list.get(n);if(!r)continue;n in D||(D[n]=new Map);const l=D[n],a=i[n];for(const c of a){let d=l.get(c);if(d){s.push(d);continue}const[m]=await r.getItemsData([c],t.itemsDataConfig);d=L(n,m,t),s.push(d)}}return s},z=o=>{const i={emptySelectionWarning:!0,defaultItemNameKey:"Name",itemsDataConfig:{attributesDefault:!0,relationsDefault:{attributes:!1,relations:!1},relations:{IsDefinedBy:{attributes:!0,relations:!0},DefinesOcurrence:{attributes:!1,relations:!1},ContainedInStructure:{attributes:!0,relations:!0},ContainsElements:{attributes:!1,relations:!1},Decomposes:{attributes:!1,relations:!1}}},...o},{components:t,modelIdMap:e,emptySelectionWarning:s}=o;return u`
    <bim-table @cellcreated=${({detail:l})=>{const{cell:a}=l;a.column==="Name"&&!("Value"in a.rowData)&&(a.style.gridColumn="1 / -1")}} ${_(async l=>{if(!l)return;const a=l;a.loadFunction=async()=>W(t,e,i),await a.loadData(!0)&&a.dispatchEvent(new Event("datacomputed"))})}>
      ${s?u`
            <bim-label slot="missing-data" style="--bim-icon--c: gold" icon="ic:round-warning">
