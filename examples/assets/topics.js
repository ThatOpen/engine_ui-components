...
`),n=document.createElement("bim-dropdown");n.label="Group by";const S=["type","status","priority","creationDate","creationAuthor","modifiedDate","modifiedAuthor","dueDate","assignedTo","stage"];for(const e of S){const t=document.createElement("bim-option");t.label=e,t.value=e,n.appendChild(t)}n.addEventListener("change",()=>{C({grouper:n.value[0]}),y({grouper:n.value[0]}),A.removeMenus()});const m=document.createElement("bim-button");m.label="Randomize";m.addEventListener("click",()=>{d.list.clear(),Array.from({length:20},(e,t)=>f(t)),C(),y(),H()});const _=i.create(()=>l`
