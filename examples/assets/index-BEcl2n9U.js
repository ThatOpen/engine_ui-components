import{D as x,F as $,h as S,V as U,j as V,f as B,r as H}from"./index-6HcFeNjn.js";import{o as F,b as u,n as _}from"./if-defined-DypSrBBK.js";const N=(n,s)=>{const o=s[n],e=(o==null?void 0:o.name)??n,i=e.trim().split(/\s+/);let t,l;return i[0]&&i[0][0]&&(t=i[0][0].toUpperCase(),i[0][1]&&(l=i[0][1].toUpperCase())),i[1]&&i[1][0]&&(l=i[1][0].toUpperCase()),u`
  ...
  `},ae=(n,s)=>{const{components:o,topic:e}=n;s.noIndentation=!0,s.headersHidden=!0,s.hiddenColumns=["Guid"],s.columns=["Title",{name:"Actions",width:"auto"}];const i={selectComponents:!0,colorizeComponent:!0,resetColors:!0,updateCamera:!0,delete:!0,unlink:!!e,...n.actions},t=o.get(U);s.dataTransform={Actions:(l,c)=>{const{Guid:r}=c;if(!(r&&typeof r=="string"))return l;const a=t.list.get(r);if(!a)return l;const d=async({target:C})=>{C.loading=!0,await a.go(),C.loading=!1};let m;i.selectComponents&&(m=u`
        ...
        `);let w;i.delete&&(w=u`
          <bim-button label="Delete" @click=${()=>{t.list.delete(a.guid),V.removeMenus()}}></bim-button>
  ...
  `},ue=(n,s)=>{const{topic:o,styles:e}=n,i={delete:!0,...n.actions};s.headersHidden=!0,s.hiddenColumns=["guid","author"],s.dataTransform={Comment:(t,l)=>{const{guid:c}=l;if(typeof c!="string")return t;const r=o.comments.get(c);if(!r)return t;const a=()=>{o.comments.delete(c)};let d;if(i.delete){const m=`btn-${H.newRandomId()}`;d=u`
      ...
      `}}},be=(n,s=!0)=>{const o=S.create(G,n),[e,i]=o;if(ue(n,e),s){const{topic:t}=n,l=()=>i();t.comments.onItemSet.add(l),t.comments.onItemUpdated.add(l),t.comments.onItemDeleted.add(l),t.comments.onCleared.add(l)}return o},ge=Object.freeze(Object.defineProperty({__proto__:null,commentsList:be,commentsListTemplate:G},Symbol.toStringTag,{value:"Module"})),ye={...K,...oe,...se,...re,...me,...ge};export{N as a,M as b,be as c,k as d,ye as e,de as t,le as v};
