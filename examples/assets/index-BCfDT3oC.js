import{v as F,d as u,c as _,i as x,F as $,e as S,V as U,H as G,B,l as V}from"./index-CIaHeOsI.js";import"./lit-html-CgQwCkHV.js";const N=(n,s)=>{const o=s[n],e=(o==null?void 0:o.name)??n,i=e.trim().split(/\s+/);let t,l;return i[0]&&i[0][0]&&(t=i[0][0].toUpperCase(),i[0][1]&&(l=i[0][1].toUpperCase())),i[1]&&i[1][0]&&(l=i[1][0].toUpperCase()),u`
