import{x as F,d as u,c as _,i as R,F as $,e as S,V as U,H as G,B,l as V}from"./index-J3q5tPBy.js";import"./lit-html-CgQwCkHV.js";const N=(n,s)=>{const o=s[n],e=(o==null?void 0:o.name)??n,i=e.trim().split(/\s+/);let t,l;return i[0]&&i[0][0]&&(t=i[0][0].toUpperCase(),i[0][1]&&(l=i[0][1].toUpperCase())),i[1]&&i[1][0]&&(l=i[1][0].toUpperCase()),u`
  ...
  `},ae=(n,s)=>{const{components:o,topic:e}=n;s.noIndentation=!0,s.headersHidden=!0,s.hiddenColumns=["Guid"],s.columns=["Title",{name:"Actions",width:"auto"}];const i={selectComponents:!0,colorizeComponent:!0,resetColors:!0,updateCamera:!0,delete:!0,unlink:!!e,...n.actions},t=o.get(U);s.dataTransform={Actions:(l,c)=>{const{Guid:r}=c;if(!(r&&typeof r=="string"))return l;const a=t.list.get(r);if(!a)return l;const d=async({target:C})=>{C.loading=!0,await a.go(),C.loading=!1};let m;i.selectComponents&&(m=u`
          <bim-button label="Select Components" @click=${async({target:p})=>{const y=o.get($),v=o.get(R);if(!v.isSetup)return;p.loading=!0;const I=await y.guidsToModelIdMap([...a.selectionComponents]);await v.highlightByID("select",I),p.loading=!1}}></bim-button>
