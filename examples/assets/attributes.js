...
`),Q=s.create(()=>l`
    ...
    </bim-panel>`),T=t.get(x);T.setup({world:a});const u=document.createElement("bim-grid");u.layouts={main:{template:`
    "chartPanel viewport 3fr"
    /25rem 1fr
    `,elements:{chartPanel:Q,viewport:p}}};u.layout="main";document.body.append(u);
