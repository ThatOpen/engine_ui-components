import{o as mt,p as pt,q as Y,s as y,t as F,v as gt,L as bt,y as A,A as _t,E as vt,W as j,S as H,r as xt,O as V,a as wt,G as yt,n as kt}from"./index-Dn97DhiK.js";import{i as z,a as P,n as c,r as Ct,e as Mt,b as $t}from"./ref-B0YVjWyu.js";import{b as T}from"./lit-html-CgQwCkHV.js";class St extends mt{constructor(t=document.createElement("div")){super(),this.isCSS2DObject=!0,this.element=t,this.element.style.position="absolute",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.center=new pt(.5,.5),this.addEventListener("removed",function(){this.traverse(function(e){e.element instanceof e.element.ownerDocument.defaultView.Element&&e.element.parentNode!==null&&e.element.remove()})})}copy(t,e){return super.copy(t,e),this.element=t.element.cloneNode(!0),this.center=t.center,this}}new Y;new y;new y;new Y;new Y;class Xt{constructor(t,e){this._group=new F,this._frustum=new gt,this._frustumMat=new y,this._regenerateDelay=200,this._regenerateCounter=0,this.material=new bt({color:"#2e3338"}),this.numbers=new F,this.maxRegenerateRetrys=4,this.gridsFactor=5,this._scaleX=1,this._scaleY=1,this._offsetX=0,this._offsetY=0,this._camera=t,this._container=e;const r=this.newGrid(-1),s=this.newGrid(-2);this.grids={main:r,secondary:s},this._group.add(s,r,this.numbers)}set scaleX(t){this._scaleX=t,this.regenerate()}get scaleX(){return this._scaleX}set scaleY(t){this._scaleY=t,this.regenerate()}get scaleY(){return this._scaleY}set offsetX(t){this._offsetX=t,this.regenerate()}get offsetX(){return this._offsetX}set offsetY(t){this._offsetY=t,this.regenerate()}get offsetY(){return this._offsetY}get(){return this._group}dispose(){const{main:t,secondary:e}=this.grids;t.removeFromParent(),e.removeFromParent(),t.geometry.dispose(),t.material.dispose(),e.geometry.dispose(),e.material.dispose()}regenerate(){if(!this.isGridReady()){if(this._regenerateCounter++,this._regenerateCounter>this.maxRegenerateRetrys)throw new Error("Grid could not be regenerated");setTimeout(()=>this.regenerate,this._regenerateDelay);return}this._regenerateCounter=0,this._camera.updateMatrix(),this._camera.updateMatrixWorld();const e=this._frustumMat.multiplyMatrices(this._camera.projectionMatrix,this._camera.matrixWorldInverse);this._frustum.setFromProjectionMatrix(e);const{planes:r}=this._frustum,s=r[0].constant*-r[0].normal.x,i=r[1].constant*-r[1].normal.x,a=r[2].constant*-r[2].normal.y,k=r[3].constant*-r[3].normal.y,x=Math.abs(s-i),w=Math.abs(k-a),{clientWidth:W,clientHeight:Z}=this._container,I=Math.max(W,Z),C=Math.max(x,w)/I,U=Math.ceil(Math.log10(x/this.scaleX)),q=Math.ceil(Math.log10(w/this.scaleY)),p=10**(U-2)*this.scaleX,g=10**(q-2)*this.scaleY,d=p*this.gridsFactor,b=g*this.gridsFactor,J=Math.ceil(w/b),G=Math.ceil(x/d),K=Math.ceil(w/g),Q=Math.ceil(x/p),tt=p*Math.ceil(i/p),et=g*Math.ceil(a/g),R=d*Math.ceil(i/d),st=b*Math.ceil(a/b),rt=[...this.numbers.children];for(const n of rt)n.removeFromParent();this.numbers.children=[];const M=[],it=9*C,u=1e4,B=R+this._offsetX,ot=Math.round(Math.abs(B/this.scaleX)*u)/u,nt=(G-1)*d,at=Math.round(Math.abs((B+nt)/this.scaleX)*u)/u,ct=Math.max(ot,at).toString().length*it;let $=Math.ceil(ct/d)*d;for(let n=0;n<G;n++){let o=R+n*d;M.push(o,k,0,o,a,0),o=Math.round(o*u)/u,$=Math.round($*u)/u;const _=o%$;if(!(d<1||b<1)&&Math.abs(_)>.01)continue;const O=this.newNumber((o+this._offsetX)/this.scaleX),ft=12*C;O.position.set(o,a+ft,0)}for(let n=0;n<J;n++){const o=st+n*b;M.push(i,o,0,s,o,0);const _=this.newNumber(o/this.scaleY);let X=12;_.element.textContent&&(X+=4*_.element.textContent.length);const O=X*C;_.position.set(i+O,o,0)}const S=[];for(let n=0;n<Q;n++){const o=tt+n*p;S.push(o,k,0,o,a,0)}for(let n=0;n<K;n++){const o=et+n*g;S.push(i,o,0,s,o,0)}const lt=new A(new Float32Array(M),3),ht=new A(new Float32Array(S),3),{main:dt,secondary:ut}=this.grids;dt.geometry.setAttribute("position",lt),ut.geometry.setAttribute("position",ht)}newNumber(t){const e=document.createElement("bim-label");e.textContent=String(Math.round(t*100)/100);const r=new St(e);return this.numbers.add(r),r}newGrid(t){const e=new _t,r=new vt(e,this.material);return r.frustumCulled=!1,r.renderOrder=t,r}isGridReady(){const t=this._camera.projectionMatrix.elements;for(let e=0;e<t.length;e++){const r=t[e];if(Number.isNaN(r))return!1}return!0}}var Ot=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,v=(l,t,e,r)=>{for(var s=Dt(t,e),i=l.length-1,a;i>=0;i--)(a=l[i])&&(s=a(t,e,s)||s);return s&&Ot(t,e,s),s};const E=class E extends z{constructor(){super(...arguments),this._grid=null,this._world=null,this.resize=()=>{this._world&&this._grid&&this._grid.regenerate()}}set gridColor(t){if(this._gridColor=t,!(t&&this._grid))return;const e=Number(t.replace("#","0x"));Number.isNaN(e)||this._grid.material.color.setHex(e)}get gridColor(){return this._gridColor}set gridScaleX(t){this._gridScaleX=t,t&&this._grid&&(this._grid.scaleX=t)}get gridScaleX(){return this._gridScaleX}set gridScaleY(t){this._gridScaleY=t,t&&this._grid&&(this._grid.scaleY=t)}get gridScaleY(){return this._gridScaleY}get gridOffsetX(){var t;return((t=this._grid)==null?void 0:t.offsetX)||0}set gridOffsetX(t){this._grid&&(this._grid.offsetX=t)}get gridOffsetY(){var t;return((t=this._grid)==null?void 0:t.offsetY)||0}set gridOffsetY(t){this._grid&&(this._grid.offsetY=t)}set components(t){this.dispose();const r=t.get(j).create();this._world=r,r.scene=new H(t),r.scene.setup(),r.renderer=new xt(t,this);const s=new V(t);r.camera=s;const i=new Xt(s.threeOrtho,this);this._grid=i,r.scene.three.add(i.get()),s.controls.addEventListener("update",()=>i.regenerate()),setTimeout(async()=>{r.camera.updateAspect(),s.set("Plan"),await s.controls.setLookAt(0,0,100,0,0,0),await s.projection.set("Orthographic"),s.controls.dollySpeed=3,s.controls.draggingSmoothTime=.085,s.controls.maxZoom=1e3,s.controls.zoom(4)})}get world(){return this._world}dispose(){var t;(t=this.world)==null||t.dispose(),this._world=null,this._grid=null}connectedCallback(){super.connectedCallback(),new ResizeObserver(this.resize).observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.dispose()}render(){return T`<slot></slot>`}};E.styles=P`
    :host {
      position: relative;
      display: flex;
      min-width: 0px;
  ...
  `;let m=E;v([c({type:String,attribute:"grid-color",reflect:!0})],m.prototype,"gridColor");v([c({type:Number,attribute:"grid-scale-x",reflect:!0})],m.prototype,"gridScaleX");v([c({type:Number,attribute:"grid-scale-y",reflect:!0})],m.prototype,"gridScaleY");v([c({type:Number,attribute:"grid-offset-x",reflect:!0})],m.prototype,"gridOffsetX");v([c({type:Number,attribute:"grid-offset-y",reflect:!0})],m.prototype,"gridOffsetY");var Yt=Object.defineProperty,f=(l,t,e,r)=>{for(var s=void 0,i=l.length-1,a;i>=0;i--)(a=l[i])&&(s=a(t,e,s)||s);return s&&Yt(t,e,s),s};const L=class L extends z{constructor(){super(...arguments),this._defaults={size:60},this._cssMatrix3D="",this._matrix=new y,this._onRightClick=new Event("rightclick"),this._onLeftClick=new Event("leftclick"),this._onTopClick=new Event("topclick"),this._onBottomClick=new Event("bottomclick"),this._onFrontClick=new Event("frontclick"),this._onBackClick=new Event("backclick"),this._camera=null,this._epsilon=t=>Math.abs(t)<1e-10?0:t}set camera(t){this._camera=t,this.updateOrientation()}get camera(){return this._camera}updateOrientation(){if(!this.camera)return;this._matrix.extractRotation(this.camera.matrixWorldInverse);const{elements:t}=this._matrix;this._cssMatrix3D=`matrix3d(
      ${this._epsilon(t[0])},
      ${this._epsilon(-t[1])},
      ${this._epsilon(t[2])},
      ${this._epsilon(t[3])},
