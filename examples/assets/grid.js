import"./modulepreload-polyfill-B5Qt9EMX.js";import{e as d,i as u,t as p,M as g,C as b,n as h}from"./index-laUBdS2o.js";import{w as f,x as r}from"./state-CdSmRkb4.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const c="important",y=" !"+c,s=d(class extends u{constructor(e){var i;if(super(e),e.type!==p.ATTRIBUTE||e.name!=="style"||((i=e.strings)==null?void 0:i.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((i,n)=>{const o=e[n];return o==null?i:i+`${n=n.includes("-")?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${o};`},"")}update(e,[i]){const{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(i)),this.render(i);for(const o of this.ft)i[o]==null&&(this.ft.delete(o),o.includes("-")?n.removeProperty(o):n[o]=null);for(const o in i){const t=i[o];if(t!=null){this.ft.add(o);const a=typeof t=="string"&&t.endsWith(y);o.includes("-")||a?n.setProperty(o,a?t.slice(0,-11):t,a?c:""):n[o]=t}}return f}});g.init();const k=b.create(()=>r`
  ...
  `),T=b.create(()=>r`
    <bim-panel>
      <bim-panel-section label="Assignments" fixed>
        <bim-table ${h(i=>{if(!i)return;const n=i,o={padding:"0.25rem 0.375rem",borderRadius:"0.25rem"};n.definition={Status:t=>{if(typeof t!="string")return t;if(t==="In Progress"){const a={...o,backgroundColor:"#3c59c3",color:"white"};return r`<bim-label label=${t} style=${s(a)}></bim-label>`}if(t==="Pending"){const a={...o,backgroundColor:"#5c5c5c",color:"white"};return r`<bim-label label=${t} style=${s(a)}></bim-label>`}if(t==="Completed"){const a={...o,backgroundColor:"#3a7829",color:"white"};return r`<bim-label label=${t} style=${s(a)}></bim-label>`}if(t==="Scheduled"){const a={...o,backgroundColor:"#9e2980",color:"white"};return r`<bim-label label=${t} style=${s(a)}></bim-label>`}return t},AssignedTo:(t,a)=>r`
          <div style="display: flex; gap: 0.5rem">
            <bim-label label=${t}></bim-label>
