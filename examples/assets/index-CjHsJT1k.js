import{q as st,s as wt,t as nt,e as xt,d as it,u as yt,B as St,L as Et,W as at,S as lt,U as Mt,O as ct,a as Ct,G as Pt,o as Rt,T as U,v as Tt,x as rt,y as $t}from"./index-6HcFeNjn.js";import{i as Y,a as B,b as N,c as b,r as kt,e as R,n as T}from"./if-defined-DypSrBBK.js";class zt{constructor(t,e){this._group=new st,this._frustum=new wt,this._frustumMat=new nt,this._regenerateDelay=200,this._regenerateCounter=0,this.material=new xt({color:"#2e3338"}),this.numbers=new st,this.maxRegenerateRetrys=4,this.gridsFactor=5,this._scaleX=1,this._scaleY=1,this._offsetX=0,this._offsetY=0,this._camera=t,this._container=e;const s=this.newGrid(-1),i=this.newGrid(-2);this.grids={main:s,secondary:i},this._group.add(i,s,this.numbers)}set scaleX(t){this._scaleX=t,this.regenerate()}get scaleX(){return this._scaleX}set scaleY(t){this._scaleY=t,this.regenerate()}get scaleY(){return this._scaleY}set offsetX(t){this._offsetX=t,this.regenerate()}get offsetX(){return this._offsetX}set offsetY(t){this._offsetY=t,this.regenerate()}get offsetY(){return this._offsetY}get(){return this._group}dispose(){const{main:t,secondary:e}=this.grids;t.removeFromParent(),e.removeFromParent(),t.geometry.dispose(),t.material.dispose(),e.geometry.dispose(),e.material.dispose()}regenerate(){if(!this.isGridReady()){if(this._regenerateCounter++,this._regenerateCounter>this.maxRegenerateRetrys)throw new Error("Grid could not be regenerated");setTimeout(()=>this.regenerate,this._regenerateDelay);return}this._regenerateCounter=0,this._camera.updateMatrix(),this._camera.updateMatrixWorld();const e=this._frustumMat.multiplyMatrices(this._camera.projectionMatrix,this._camera.matrixWorldInverse);this._frustum.setFromProjectionMatrix(e);const{planes:s}=this._frustum,i=s[0].constant*-s[0].normal.x,o=s[1].constant*-s[1].normal.x,r=s[2].constant*-s[2].normal.y,n=s[3].constant*-s[3].normal.y,a=Math.abs(i-o),l=Math.abs(n-r),{clientWidth:c,clientHeight:_}=this._container,v=Math.max(c,_),d=Math.max(a,l)/v,h=Math.ceil(Math.log10(a/this.scaleX)),x=Math.ceil(Math.log10(l/this.scaleY)),m=10**(h-2)*this.scaleX,g=10**(x-2)*this.scaleY,p=m*this.gridsFactor,y=g*this.gridsFactor,z=Math.ceil(l/y),P=Math.ceil(a/p),V=Math.ceil(l/g),A=Math.ceil(a/m),F=m*Math.ceil(o/m),G=g*Math.ceil(r/g),D=p*Math.ceil(o/p),I=y*Math.ceil(r/y),X=[...this.numbers.children];for(const f of X)f.removeFromParent();this.numbers.children=[];const k=[],ht=9*d,M=1e4,et=D+this._offsetX,dt=Math.round(Math.abs(et/this.scaleX)*M)/M,pt=(P-1)*p,ut=Math.round(Math.abs((et+pt)/this.scaleX)*M)/M,_t=Math.max(dt,ut).toString().length*ht;let W=Math.ceil(_t/p)*p;for(let f=0;f<P;f++){let u=D+f*p;k.push(u,n,0,u,r,0),u=Math.round(u*M)/M,W=Math.round(W*M)/M;const L=u%W;if(!(p<1||y<1)&&Math.abs(L)>.01)continue;const H=this.newNumber((u+this._offsetX)/this.scaleX),vt=12*d;H.position.set(u,r+vt,0)}for(let f=0;f<z;f++){const u=I+f*y;k.push(o,u,0,i,u,0);const L=this.newNumber(u/this.scaleY);let q=12;L.element.textContent&&(q+=4*L.element.textContent.length);const H=q*d;L.position.set(o+H,u,0)}const j=[];for(let f=0;f<A;f++){const u=F+f*m;j.push(u,n,0,u,r,0)}for(let f=0;f<V;f++){const u=G+f*g;j.push(o,u,0,i,u,0)}const ft=new it(new Float32Array(k),3),mt=new it(new Float32Array(j),3),{main:gt,secondary:bt}=this.grids;gt.geometry.setAttribute("position",ft),bt.geometry.setAttribute("position",mt)}newNumber(t){const e=document.createElement("bim-label");e.textContent=String(Math.round(t*100)/100);const s=new yt(e);return this.numbers.add(s),s}newGrid(t){const e=new St,s=new Et(e,this.material);return s.frustumCulled=!1,s.renderOrder=t,s}isGridReady(){const t=this._camera.projectionMatrix.elements;for(let e=0;e<t.length;e++){const s=t[e];if(Number.isNaN(s))return!1}return!0}}var Dt=Object.defineProperty,Lt=Object.getOwnPropertyDescriptor,O=(E,t,e,s)=>{for(var i=Lt(t,e),o=E.length-1,r;o>=0;o--)(r=E[o])&&(i=r(t,e,i)||i);return i&&Dt(t,e,i),i};const J=class J extends Y{constructor(){super(...arguments),this._grid=null,this._world=null,this.resize=()=>{this._world&&this._grid&&this._grid.regenerate()}}set gridColor(t){if(this._gridColor=t,!(t&&this._grid))return;const e=Number(t.replace("#","0x"));Number.isNaN(e)||this._grid.material.color.setHex(e)}get gridColor(){return this._gridColor}set gridScaleX(t){this._gridScaleX=t,t&&this._grid&&(this._grid.scaleX=t)}get gridScaleX(){return this._gridScaleX}set gridScaleY(t){this._gridScaleY=t,t&&this._grid&&(this._grid.scaleY=t)}get gridScaleY(){return this._gridScaleY}get gridOffsetX(){var t;return((t=this._grid)==null?void 0:t.offsetX)||0}set gridOffsetX(t){this._grid&&(this._grid.offsetX=t)}get gridOffsetY(){var t;return((t=this._grid)==null?void 0:t.offsetY)||0}set gridOffsetY(t){this._grid&&(this._grid.offsetY=t)}set components(t){this.dispose();const s=t.get(at).create();this._world=s,s.scene=new lt(t),s.scene.setup(),s.renderer=new Mt(t,this);const i=new ct(t);s.camera=i;const o=new zt(i.threeOrtho,this);this._grid=o,s.scene.three.add(o.get()),i.controls.addEventListener("update",()=>o.regenerate()),setTimeout(async()=>{s.camera.updateAspect(),i.set("Plan"),await i.controls.setLookAt(0,0,100,0,0,0),await i.projection.set("Orthographic"),i.controls.dollySpeed=3,i.controls.draggingSmoothTime=.085,i.controls.maxZoom=1e3,i.controls.zoom(4)})}get world(){return this._world}dispose(){var t;(t=this.world)==null||t.dispose(),this._world=null,this._grid=null}connectedCallback(){super.connectedCallback(),new ResizeObserver(this.resize).observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.dispose()}render(){return N`<slot></slot>`}};J.styles=B`
    :host {
      position: relative;
      display: flex;
      min-width: 0px;
  ...
  `;let $=J;O([b({type:String,attribute:"grid-color",reflect:!0})],$.prototype,"gridColor");O([b({type:Number,attribute:"grid-scale-x",reflect:!0})],$.prototype,"gridScaleX");O([b({type:Number,attribute:"grid-scale-y",reflect:!0})],$.prototype,"gridScaleY");O([b({type:Number,attribute:"grid-offset-x",reflect:!0})],$.prototype,"gridOffsetX");O([b({type:Number,attribute:"grid-offset-y",reflect:!0})],$.prototype,"gridOffsetY");var Ot=Object.defineProperty,C=(E,t,e,s)=>{for(var i=void 0,o=E.length-1,r;o>=0;o--)(r=E[o])&&(i=r(t,e,i)||i);return i&&Ot(t,e,i),i};const K=class K extends Y{constructor(){super(...arguments),this._defaults={size:60},this._cssMatrix3D="",this._matrix=new nt,this._onRightClick=new Event("rightclick"),this._onLeftClick=new Event("leftclick"),this._onTopClick=new Event("topclick"),this._onBottomClick=new Event("bottomclick"),this._onFrontClick=new Event("frontclick"),this._onBackClick=new Event("backclick"),this._camera=null,this._epsilon=t=>Math.abs(t)<1e-10?0:t}set camera(t){this._camera=t,this.updateOrientation()}get camera(){return this._camera}updateOrientation(){if(!this.camera)return;this._matrix.extractRotation(this.camera.matrixWorldInverse);const{elements:t}=this._matrix;this._cssMatrix3D=`matrix3d(
      ${this._epsilon(t[0])},
      ${this._epsilon(-t[1])},
      ${this._epsilon(t[2])},
      ${this._epsilon(t[3])},
      ...
      ${this._epsilon(t[14])},
      ${this._epsilon(t[15])})
    `}render(){const t=this.size??this._defaults.size;return N`
      <style>
        .face,
        .cube {
          width: ${t}px;
  ...
  `;let ot=tt;export{ot as S,S as V,$ as W,Z as a};
