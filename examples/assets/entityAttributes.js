import"./modulepreload-polyfill-B5Qt9EMX.js";import{T as k,C as v,a as I,e as A,m as P,x as $,y as E,i as L,k as N,t as H,z as O,j as p,$ as b,E as V,J as W}from"./index-b5UjG9AG.js";import{t as M}from"./index-CagUo1tF.js";import"./lit-html-paDGiEfB.js";k.init();const o=new v,R=o.get(I),a=R.create(),w=new A(o);w.setup();a.scene=w;const d=document.createElement("bim-viewport"),S=new P(o,d);a.renderer=S;const m=new $(o);a.camera=m;m.controls.setLookAt(10,5.5,5,-4,-1,-6.5);d.addEventListener("resize",()=>{S.resize(),m.updateAspect()});o.init();const B=o.get(E);B.create(a);const x=o.get(L);await x.setup();const D=await fetch("https://thatopen.github.io/engine_ui-components/resources/small.ifc"),F=await D.arrayBuffer(),J=new Uint8Array(F),C=await x.load(J);a.scene.three.add(C);const z=o.get(N);await z.process(C);const l={padding:"0.25rem",borderRadius:"0.25rem"},G={Entity:e=>{let t={};return e===V[W]&&(t={...l,backgroundColor:"purple",color:"white"}),String(e).includes("IFCWALL")&&(t={...l,backgroundColor:"green",color:"white"}),p`<bim-label style=${b(t)}>${e}</bim-label>`},PredefinedType:e=>{const t=["#1c8d83","#3c1c8d","#386c19","#837c24"],c=Math.floor(Math.random()*t.length),g=t[c],f={...l,backgroundColor:g,color:"white"};return p`<bim-label style=${b(f)}>${e}</bim-label>`},NominalValue:e=>{let t={};return typeof e=="boolean"&&e===!1&&(t={...l,backgroundColor:"#b13535",color:"white"}),typeof e=="boolean"&&e===!0&&(t={...l,backgroundColor:"#18882c",color:"white"}),p`<bim-label style=${b(t)}>${e}</bim-label>`}},[n,u]=M.entityAttributes({components:o,fragmentIdMap:{},tableDefinition:G,attributesToInclude:()=>["Name","ContainedInStructure","HasProperties","HasPropertySets",t=>t.includes("Value"),t=>t.startsWith("Material"),t=>t.startsWith("Relating"),t=>{const c=["IsGroupedBy","IsDecomposedBy"];return t.startsWith("Is")&&!c.includes(t)}]});n.expanded=!0;n.indentationInText=!0;n.preserveStructureOnFilter=!0;const h=o.get(H);h.setup({world:a});h.events.select.onHighlight.add(e=>{u({fragmentIdMap:e})});h.events.select.onClear.add(()=>u({fragmentIdMap:{}}));const j=O.create(()=>p`
    <bim-panel>
      <bim-panel-section label="Entity Attributes" fixed>
        <div style="display: flex; gap: 0.5rem; justify-content: space-between;">
          ...
          <div style="display: flex; gap: 0.5rem;">
            <bim-dropdown @change=${r=>{const s=r.target;u({attributesToInclude:()=>[...s.value,i=>i.includes("Value"),i=>i.startsWith("Material"),i=>i.startsWith("Relating"),i=>{const T=["IsGroupedBy","IsDecomposedBy"];return i.startsWith("Is")&&!T.includes(i)}]})}} multiple>
