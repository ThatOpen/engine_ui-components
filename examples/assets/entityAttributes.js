import"./lit-html-DcU_S_gY.js";import{T as v,o as T,a as k,L as A,M as P,N as E,l as $,E as L,J as N,r as M,z as H,m as p,Q as b,g as O,I as V}from"./template-BHX6Qr0d.js";import{t as W}from"./index-CqAUTGMA.js";v.init();const o=new T,J=o.get(k),a=J.create(),w=new A(o);w.setup();a.scene=w;const d=document.createElement("bim-viewport"),S=new P(o,d);a.renderer=S;const u=new E(o);a.camera=u;u.controls.setLookAt(10,5.5,5,-4,-1,-6.5);d.addEventListener("resize",()=>{S.resize(),u.updateAspect()});o.init();const R=o.get($);R.create(a);const x=o.get(L);await x.setup();const B=await fetch("https://thatopen.github.io/engine_ui-components/resources/small.ifc"),D=await B.arrayBuffer(),F=new Uint8Array(D),C=await x.load(F);a.scene.three.add(C);const z=o.get(N);await z.process(C);const l={padding:"0.25rem",borderRadius:"0.25rem"},Q={Entity:e=>{let t={};return e===O[V]&&(t={...l,backgroundColor:"purple",color:"white"}),String(e).includes("IFCWALL")&&(t={...l,backgroundColor:"green",color:"white"}),p`<bim-label style=${b(t)}>${e}</bim-label>`},PredefinedType:e=>{const t=["#1c8d83","#3c1c8d","#386c19","#837c24"],c=Math.floor(Math.random()*t.length),g=t[c],f={...l,backgroundColor:g,color:"white"};return p`<bim-label style=${b(f)}>${e}</bim-label>`},NominalValue:e=>{let t={};return typeof e=="boolean"&&e===!1&&(t={...l,backgroundColor:"#b13535",color:"white"}),typeof e=="boolean"&&e===!0&&(t={...l,backgroundColor:"#18882c",color:"white"}),p`<bim-label style=${b(t)}>${e}</bim-label>`}},[i,m]=W.entityAttributes({components:o,fragmentIdMap:{},tableDefinition:Q,attributesToInclude:()=>["Name","ContainedInStructure","HasProperties","HasPropertySets",t=>t.includes("Value"),t=>t.startsWith("Material"),t=>t.startsWith("Relating"),t=>{const c=["IsGroupedBy","IsDecomposedBy"];return t.startsWith("Is")&&!c.includes(t)}]});i.expanded=!0;i.indentationInText=!0;i.preserveStructureOnFilter=!0;const h=o.get(M);h.setup({world:a});h.events.select.onHighlight.add(e=>{m({fragmentIdMap:e})});h.events.select.onClear.add(()=>m({fragmentIdMap:{}}));const G=H.create(()=>p`
    <bim-panel>
